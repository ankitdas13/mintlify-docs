...
description: "The [Razorpay n8n Community Node](https://www.npmjs.com/package/@razorpay/n8n-nodes-razorpay) provides seamless integration between Razorpay payment APIs and [n8n workflow automation platform](https://n8n.io/). This node"
---
...
View [Complete Operations Reference](/razorpay-n8n-node/operations-reference).

<Info>

**Extended Operations Available**

Access **28 additional operations** via [Razorpay MCP Server](/mcp-server) integration.
...
View [Use Cases](/razorpay-n8n-node/use-cases).
...
### Razorpay Account
     ...
     - **API Keys**: Generate [API keys](/payments/dashboard/account-settings/api-keys) from the Razorpay Dashboard.
...
<Steps>
<Step title="Step 1">
**[Install the Node](/razorpay-n8n-node/installation)**: Add Razorpay node to your n8n instance.
</Step>
<Step title="Step 2">
**Configure Credentials**: Generate and add your API keys.
</Step>
<Step title="Step 3">
**[Explore Use Cases](/razorpay-n8n-node/use-cases)**: Learn from real-world examples.
</Step>
<Step title="Step 4">
**Build Your Workflow**: Start with a simple automation.
</Step>
<Step title="Step 5">
**[Troubleshoot Issues](/razorpay-n8n-node/troubleshooting-faqs)**: Resolve common problems.
</Step>
</Steps>

### Related Documentation

- [Razorpay API Reference](/api)
