...
Refer to the [list of banks that support cards](/payments/recurring-payments/cards/supported-banks).
...
Refer to the [Recurring Payments document](/payments/recurring-payments) for more information on payment methods.
...
Refer to the [Payment Link document](/payments/payment-links) for more information.
...
<Steps>
<Step title="Log in to the Dashboard and click the **Reports** from the left menu.">
Log in to the Dashboard and click the **Reports** from the left menu.
</Step>
<Step title="Select **Token Report** from the **Select Report Type** drop-down l...">
Select **Token Report** from the **Select Report Type** drop-down list.
</Step>
<Step title="Select the relevant **Period** from the **Select Period** drop-down...">
Select the relevant **Period** from the **Select Period** drop-down list.
</Step>
<Step title="Select the file format from the **Select Format** drop-down list. Y...">
Select the file format from the **Select Format** drop-down list. You can choose CSV, XLSX or XLS formats.
</Step>
<Step title="Click **Generate Report** to download or get it emailed to your reg...">
...
Refer to the [Recurring Payments API document](/api/payments/recurring-payments/cards/create-authorization-transaction#112-create-an-order) for more information on changes.
...
<Steps>
<Step title="Businesses initiate the debit for an amount less than ₹15,000.">
Businesses initiate the debit for an amount less than ₹15,000.
</Step>
<Step title="Bank will send a pre-debit notification SMS to the customer immedia...">
Bank will send a pre-debit notification SMS to the customer immediately.
</Step>
<Step title="The amount will be debited 36 hours after the notification.">
The amount will be debited 36 hours after the notification.
</Step>
</Steps>

To process subsequent debits above ₹15,000:
<Steps>
<Step title="Businesses initiate the debit for an amount greater than ₹15,000.">
Businesses initiate the debit for an amount greater than ₹15,000.
</Step>
<Step title="Bank will send a notification with a link for Additional Factor Aut...">
...
<Step title="The amount will be debited as soon as the customer provides AFA.">
...
Yes, businesses can cancel card tokens by deleting them. Tokens can be deleted either from the [dashboard](/payments/recurring-payments/create#delete-the-token) or using [APIs](/api/payments/recurring-payments/cards/tokens#23-delete-tokens).
