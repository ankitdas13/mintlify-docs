...
description: "According to NPCI guidelines, the UPI Collect flow (Pay with UPI id/VPA/Number) is being deprecated for new UPI Autopay registrations and will no longer be supported after 28 February 2026."
---
...
### Web
         ...
         **Change Needed**
         ...
         1. If you were previously using UPI Collect, you must remove `upi[vpa]` parameter from `razorpay.js`. 
                ...
                ```
         2. Integrate with UPI QR code. Refer to the [UPI QR code Redirect Flow documentation](/payments/payment-gateway/web-integration/custom/payment-methods#redirect-flow) to complete the integration.
...
### mWeb
         ...
         **Change Needed**
         ...
         1. If you were previously using UPI Collect, you must remove `upi[vpa]` parameter from `razorpay.js`.
                ...
                ```
         2. Integrate UPI Intent on mWeb. Refer to the [UPI Intent mWeb Integration Guide](/payments/payment-gateway/web-integration/custom/payment-methods/upi-intent-mweb).
...
### WebView
         ...
         **Change Needed**
         ...
         1. If you were previously using UPI Collect, you must remove `upi[vpa]` parameter from `razorpay.js`.
                ...
                ```
         2. Integrate UPI Intent by following the UPI Webview Integration guide for [Android](/payments/payment-gateway/web-integration/custom/features/webview/upi-intent-android) and [iOS](/payments/payment-gateway/web-integration/custom/features/webview/upi-intent-ios). Implement deep link handling in your Android/iOS app to launch UPI apps from WebView.
        

## Related Information

- [UPI Payment Method](/payments/payment-methods/upi)
- [Recurring Payments - UPI Autopay Custom Checkout Integration](/api/payments/recurring-payments/custom/upi/create-authorization-transaction)
