...
- If you are a new customer, use [UPI Intent](/payments/payment-gateway/s2s-integration/payment-methods/upi/intent). 
...
### Web (Desktop Web)
         ...
         **Supported API Endpoints:**
         ...
         Refer to the [UPI Intent documentation](/payments/payment-gateway/s2s-integration/payment-methods/upi/intent) for implementation details.
