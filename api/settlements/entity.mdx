...
description: "The Settlements entity has the following parameters:"
---
...
`status`
: `string` Indicates the [state of the settlement](/payments/settlements#settlement-states). Possible values:
  - `created`
  - `processed`
  - `failed`
