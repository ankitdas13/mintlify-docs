...
: `object` The business details of the sub-merchant's account.
    ...
    : `string` The business category of the sub-merchant. Possible values: [List of Business Categories](/partners/aggregators/onboarding-api/appendix#business-category).

    `subcategory` _mandatory_
    : `string` The business sub-category of the sub-merchant. Possible values: [List of Business Sub-Categories](/partners/aggregators/onboarding-api/appendix#business-sub-category).
