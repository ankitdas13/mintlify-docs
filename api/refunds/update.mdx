...
description: "**PATCH** `/v1/refunds/:id/`"
---
...
`notes` _mandatory_
: `json object` Additional information to be modified or added as part of `notes` field in key-pair format. Know more about [notes](/api/understand#notes).
