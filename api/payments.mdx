---
title: "Payments"
description: "Payments APIs are used to capture and fetch payments. You can also fetch payments based on orders and card details of payment."
---
...
You can use Payments API only to retrieve payment details or change the status from `authorized` to `captured` and **not** to collect payments. You can use our [products](/payments) to accept payments.

 

 Fork the Razorpay Postman Public Workspace and try the Payments APIs using your [Test API Keys](/payments/dashboard/account-settings/api-keys#generate-api-keys).
...
[Sample Payloads](/webhooks/payments)
