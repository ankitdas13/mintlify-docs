...
description: "The Razorpay Sandbox environment allows you to test your integration without using real money. It is a crucial step before going live with your Razorpay integration."
---
...
### 1. Generate API Keys
         ...
         Follow these [steps to generate API keys](/api/authentication#generate-api-keys).
...
### 3. Go live
         ...
         After testing is complete, generate [Live API keys](/payments/dashboard/account-settings/api-keys#live-mode-api-keys) from the dashboard. Ensure to replace the Test API keys in your integration with the Live API keys before going live. You can accept real money payments using the Live API Keys.
