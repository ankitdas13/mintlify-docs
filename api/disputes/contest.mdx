...
description: "**PATCH** `/v1/disputes/:id/contest`"
---
...
- Attaching an evidence document using [Documents API](/api/documents) with having a purpose set to `dispute_evidence`.
