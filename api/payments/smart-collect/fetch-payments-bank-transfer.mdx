...
description: "**GET** `/v1/payments/:id/bank_transfer`"
---
...
: `object` Details of the Customer Identifier.
    ...
    `customer_id`
    : `string` The unique identifier of the customer the Customer Identifier is linked with. Know more about [Customers API](/api/customers).
