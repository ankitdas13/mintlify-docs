...
description: "**GET** `/v1/payments?skip=0&count=25&va_transaction_id=:id&virtual_account=1`"
---
...
: `object` Details of the card used to make the payment.
  ...
  : `string` The sub-type of the customer's card. Possible values:
    - `customer` 
    - `business`. Know how to accept payments made by customers using [corporate cards](/payments/payment-methods/cards/corporate-cards).
