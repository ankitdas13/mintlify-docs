...
description: "Smart Collect 2.0, which is an upgraded version of [Smart Collect](/api/payments/smart-collect) , offers additional APIs which enables you to create Customer Identifiers with Bank Account and VPA Receiver, add VPA Receiver to existing Customer Identifier, and fetch payments made using UPI."
---

Open a Current account or an Escrow account to start using [Smart Collect 2.0](/payments/smart-collect).

Fork the Razorpay Postman Public Workspace and try the Smart Collect APIs using your [Test API Keys](/api/authentication#generate-api-keys).
...
- Use [Smart Collect TPV](/api/payments/smart-collect-tpv)  APIs to **Add an Allowed Payer** or **Delete an Allowed Payer**
...
[About Smart Collect 2.0](/payments/smart-collect)
[Set Up Webhooks](/webhooks/setup-edit-payments)
[Webhook Payloads](/webhooks/smart-collect)
