---
title: "Items Entity"
description: "The Items entity has the following parameters:"
---
...
: `string` The currency in which the amount should be charged. Check the list of [supported currencies](/payments/international-payments#supported-currencies).
