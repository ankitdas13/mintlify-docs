---
title: "Subscriptions"
description: "You can create, fetch, query or cancel plans, subscriptions and addons using the Subscriptions API. These operations can also be performed on the [Dashboard](/payments/subscript..."
---

You can create, fetch, query or cancel plans, subscriptions and addons using the Subscriptions API. These operations can also be performed on the [Dashboard](/payments/subscriptions).
...
**Read more**: [Razorpay Custom Checkout](/payments/payment-gateway/web-integration/custom).
