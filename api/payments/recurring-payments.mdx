...
description: "You can use Razorpay [Recurring Payments](/payments/recurring-payments) APIs to create subsequent payments for your customers at intervals you can define and control."
---
...
Know more about [uploading Paper Nach Form](/payments/recurring-payments/upload-paper-nach-form).
    - UPI.
...
<Step title="Navigate to **Account & Settings** → **API Keys** (under **Website...">
...
### UPI
      ...
      API | Description
      ---
      [Create Authorisation Transaction using Checkout](/api/payments/recurring-payments/upi/create-authorization-transaction#11-using-razorpay-standard-checkout) | API to create an authorisation transaction using Razorpay Checkout.
      ---
      [Create Authorisation Transaction using Registration Link](/api/payments/recurring-payments/upi/create-authorization-transaction#12-using-a-registration-link) | API to create an authorisation transaction using Registration Link.
      ---
      [Fetch Tokens using Payment id](/api/payments/recurring-payments/upi/tokens#21-fetch-token-by-payment-id) | API to fetch tokens using the Payment id.
      ---
      [Fetch Tokens using Customer id](/api/payments/recurring-payments/upi/tokens#22-fetch-tokens-by-customer-id) | API to fetch tokens using the Customer id.
      ---
      [Delete Tokens](/api/payments/recurring-payments/upi/tokens#24-delete-tokens) | API to delete tokens.
      ---
      [Create Subsequent Payments](/api/payments/recurring-payments/upi/create-subsequent-payments) | API to create subsequent payments.
...
### UPI OTM
      ...
      API | Description
      ---
      [Create Authorisation Transaction using Checkout](/api/payments/recurring-payments/upi-otm/authorization-transaction#11-using-razorpay-standard-checkout) | API to create an authorisation transaction using Razorpay Checkout.
      ---
      [Create Authorisation Transaction using Registration Link](/api/payments/recurring-payments/upi-otm/authorization-transaction#12-using-a-registration-link) | API to create an authorisation transaction using Registration Link.
      ---
      [Fetch Tokens using Payment id](/api/payments/recurring-payments/upi-otm/tokens#21-fetch-token-by-payment-id) | API to fetch tokens using the Payment id.
      ---
      [Fetch Tokens using Customer id](/api/payments/recurring-payments/upi-otm/tokens#22-fetch-tokens-by-customer-id) | API to fetch tokens using the Customer id.
      ---
      [Delete Tokens](/api/payments/recurring-payments/upi-otm/tokens#23-delete-tokens) | API to delete tokens.
      ---
      [One Time Payment](/api/payments/recurring-payments/upi-otm/one-time-payment) | API to create one time payment.
...
### UPI TPV
      ...
      API | Description
      ---
      [Create Authorisation Transaction using Checkout](/api/payments/recurring-payments/upi-tpv/create-authorization-transaction#11-using-razorpay-standard-checkout) | API to create an authorisation transaction using Razorpay Checkout.
      ---
      [Fetch Tokens using Payment id](/api/payments/recurring-payments/upi-tpv/tokens#21-fetch-token-by-payment-id) | API to fetch tokens using the Payment id.
      ---
      [Fetch Tokens using Customer id](/api/payments/recurring-payments/upi-tpv/tokens#22-fetch-tokens-by-customer-id) | API to fetch tokens using the Customer id.
      ---
      [Delete Tokens](/api/payments/recurring-payments/upi-tpv/tokens#23-delete-tokens) | API to delete tokens.
      ---
      [Subsequent Payment](/api/payments/recurring-payments/upi-tpv/create-subsequent-payments) | API to create subsequent payment.
