---
title: "Payment Links"
description: "[Payment Links](/payments/payment-links) are URLs that you can send to your customers through SMS and email to collect payments from them. Customers can click on the URL, which opens the payment request page, and complete the payment using any of the available payment methods. You can create, fetch, edit or cancel Payment Links using APIs or from the [Dashboard](/payments/refunds#dashboard-actions)."
---

Fork the Razorpay Postman Public Workspace and try the Payment Links APIs using your [Test API Keys](/api/authentication#generate-api-keys).
...
[About Payment Links](/payments/payment-links)
[Set Up Webhooks](/webhooks/setup-edit-payments)
[Webhook Payloads](/webhooks/payment-links)
