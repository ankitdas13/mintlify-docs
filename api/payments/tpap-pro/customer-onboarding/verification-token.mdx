...
description: "**POST** `/v1/upi/tpap/mobile/verification`"
---
...
: `string` The unique identifier the merchant has created for the customer. This should be passed as a header. Know more about [headers](/payments/tpap-pro/integration-guide#header-information).
