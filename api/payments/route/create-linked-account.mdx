...
: `string` The type of business operated by the Linked Account holder. List of possible values are available [here](/payments/route/integration-guide#business-type).
...
: `object` The business details of the Linked Account's account.
    ...
    : `string` The business category of the Linked Account. Possible values: [List of Business Categories](/payments/route/integration-guide#business-category).

    `subcategory` _mandatory_
    : `string` The business sub-category of the Linked Account. Possible values: [List of Business Sub-Categories](/payments/route/integration-guide#business-sub-category).
...
: `object` The legal details about the Linked Account's business. The mandatory [KYC requirement](/payments/route/integration-guide#kyc-requirements) parameters should be passed depending on the business requirements.
...
`business_type`
: `string` The type of business operated by the account holder. Possible values: [Business Types](/payments/route/integration-guide#business-type). 

`profile`
: `object` The account holder's business details.

    `category`
    : `string` The business category of the account holder. For example, `healthcare`. Possible values: [Business Category](/payments/route/integration-guide#business-category).

    `subcategory`
    : `string` The business sub-category of the account holder. For example, `clinic`. Possible values: [Business Sub-Category](/payments/route/integration-guide#business-sub-category).
...
`legal_info`
: `object` The legal details about the account holder's business. The mandatory [KYC requirement](/payments/route/integration-guide#kyc-requirements) parameters should be passed depending on the business requirements.
