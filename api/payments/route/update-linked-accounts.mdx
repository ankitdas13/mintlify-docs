...
description: "**PATCH** `/v2/accounts/:account_id`"
---
...
: `object` The business details of the Linked Account's account.
    ...
    : `string` The business category of the Linked Account. Possible values: [List of Business Categories](/api/payments/route).

    `subcategory` _mandatory_
    : `string` The business sub-category of the Linked Account. Possible values: [List of Business Sub-Categories](/api/payments/route).
...
: `object` The account holder's business details.
    ...
    `category`
    : `string` The business category of the account holder. For example, `healthcare`. Possible values: [Business Category](/api/payments/route).

    `subcategory`
    : `string` The business sub-category of the account holder. For example, `clinic`. Possible values: [Business Sub-Category](/api/payments/route).
