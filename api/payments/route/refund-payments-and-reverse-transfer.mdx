...
description: "**POST** `/v1/payments/:id/refund`"
---
...
`amount` _mandatory_
: `string` The amount of refund in the smallest unit of currency. For example, for an amount of â‚¹200.35, the value of this field should be 20035.
...
`amount`
: `integer` The amount of refund in the smallest unit of currency. For example, for an amount of â‚¹200.35, the value of this field should be 20035.
...
* code: 400
* description: This error occurs when the amount is less than the minimum amount. The transaction amount expressed in the currency subunit, such as paise (in INR) should always be greater than or equal to â‚¹1.
* solution: Make sure the amount is equal to or greater than the minimum amount of â‚¹1.
