...
description: "**GET** `/v1/transfers?expand[]=recipient_settlement`"
---
...
Descriptions for the optional query parameters are present in the [Pagination & Rate Limiting](/api/understand#pagination) documentation.
...
`amount` 
: `integer` The amount to be transferred to the Linked Account, in paise. For example, for an amount of â‚¹200.35, the value of this field should be 20035.
