...
`amount` _mandatory_
: `integer` The transaction amount, in paise. For example, for an amount of â‚¹299.35, the value of this field should be 29935.
...
: `array` Details regarding the transfer.
    ...
    `amount` _mandatory_
    : `integer` The amount to be transferred to the Linked Account. For example, for an amount of â‚¹200.35, the value of this field should be 20035. This amount cannot exceed the order amount.
...
`amount`
: `integer` The order amount, in paise. For example, for an amount of â‚¹299.35, the value of this field should be 29935.
...
: `array` Details regarding the transfer.
    ...
    `amount`
    : `integer` The amount to be transferred to the Linked Account, in paise. For example, for an amount of â‚¹200.35, the value of this field should be 20035. This amount cannot exceed the order amount.
...
* solution: Make sure the amount is equal to or greater than the minimum amount of â‚¹100.
...
* solution: Make sure you have enough balance. You can also [add funds](/payments/dashboard/account-settings/balances#add-funds-to-your-reserve-balance) to the account and then try doing the transfer.
