...
* solution: Ensure that the [Subscriptions feature](/payments/subscriptions#flash-checkout) is enabled both in the test and live modes before creating a Subscription.
