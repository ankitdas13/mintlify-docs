...
description: "**POST** `/v1/subscriptions`"
---

Use this endpoint to link an existing [Offer](/payments/subscriptions/offers) by creating a new Subscription link. Pass the `offer_id: ` parameter in the request when creating a Subscription.
