...
description: "**POST** `/v1/payments/:id/capture`"
---
...
- You can [configure automatic capture](/payments/payments/capture-settings#auto-capture-all-payments) of payments on the Dashboard.
...
: `string` ISO code of the currency in which the payment was made. Refer to the [list of supported currencies](/payments/international-payments#supported-currencies).
