...
### Emandate
      ...
      ---
      [Create Authorisation Transaction using Registration Link](/api/payments/recurring-payments/custom/emandate/create-authorization-transaction#12-using-a-registration-link) | API to create an authorisation transaction using Registration Link.
      ---
      [Fetch Tokens](/api/payments/recurring-payments/custom/emandate/tokens) | API to fetch tokens.
      ---
      [Create Subsequent Payments](/api/payments/recurring-payments/custom/emandate/create-subsequent-payments) | API to create subsequent payments.
...
### Cards
      ...
      ---
      [Fetch Tokens](/api/payments/recurring-payments/custom/cards/tokens) | API to fetch tokens.
      ---
      [Create Subsequent Payments](/api/payments/recurring-payments/custom/cards/create-subsequent-payments) | API to create subsequent payments.
...
### Paper NACH
      ...
      API | Description
      ---
      [Create Authorisation Transaction using Razorpay APIs](/api/payments/recurring-payments/custom/paper-nach/create-authorization-transaction#11-using-razorpay-apis) | API to create an authorisation transaction using Razorpay APIs.
      ---
      [Create Authorisation Transaction using Registration Link](/api/payments/recurring-payments/custom/paper-nach/create-authorization-transaction#12-using-a-registration-link) | API to create an authorisation transaction using Registration Link.
      ---
      [Fetch Tokens](/api/payments/recurring-payments/custom/paper-nach/tokens) | API to fetch tokens.
      ---
      [Create Subsequent Payments](/api/payments/recurring-payments/custom/paper-nach/create-subsequent-payments) | API to create subsequent payments.
...
### UPI Autopay
      ...
      API | Description
      ---
      [Create Authorisation Transaction using Razorpay APIs](/api/payments/recurring-payments/custom/upi/create-authorization-transaction#11-using-razorpay-apis) | API to create an authorisation transaction using Razorpay APIs.
      ---
      [Create Authorisation Transaction using Registration Link](/api/payments/recurring-payments/custom/upi/create-authorization-transaction#12-using-a-registration-link) | API to create an authorisation transaction using Registration Link.
      ---
      [Fetch Tokens](/api/payments/recurring-payments/custom/upi/tokens) | API to fetch tokens.
      ---
      [Create Subsequent Payments](/api/payments/recurring-payments/custom/upi/create-subsequent-payments) | API to create subsequent payments.
...
### UPI TPV
      ...
      API | Description
      ---
      [Create Authorisation Transaction using Razorpay APIs](/api/payments/recurring-payments/custom/upi-tpv/create-authorization-transaction#11-using-razorpay-apis) | API to create an authorisation transaction using Razorpay APIs.
      ---
      [Fetch Tokens](/api/payments/recurring-payments/custom/upi-tpv/tokens) | API to fetch tokens.
      ---
      [Subsequent Payment](/api/payments/recurring-payments/custom/upi-tpv/create-subsequent-payments) | API to create subsequent payment.
