...
You can create customers with basic details such as `email` and `contact` and use them for various Razorpay offerings. Know more about [Customers](/api/customers).
