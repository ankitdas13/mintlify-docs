...
description: "You can create an authorisation transaction using [Razorpay APIs](#11-using-razorpay-apis) or [Registration Link](#12-using-a-registration-link)."
---
...
<Step title="[Create Authorisation Payment using Razorpay APIs](#114-create-an-a...">
[Create Authorisation Payment using Razorpay APIs](#114-create-an-authorisation-payment).
</Step>
</Steps>
...
You can register a customer's mandate **AND** charge them the first recurring payment as part of the same transaction. Refer to the [Emandate section under Registration and Charge First Payment Together](/api/payments/recurring-payments/emandate/auto-debit) for more information.
