...
You will receive `razorpay_payment_id`, `razorpay_order_id` and `razorpay_signature` as a response when you create a Recurring Payment in [Test mode](/api/authentication).
</Warning>
