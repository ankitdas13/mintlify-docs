...
description: "The flow to complete an authorisation transaction using paper NACH differs from the other payment method's flow."
---
...
`max_amount`
: `integer` The maximum amount in paise a customer can be charged in a transaction. Know about [maximum and default values](/payments/recurring-payments/paper-nach/faqs#3-is-there-a-limit-on-the-debit).
...
: Details of the authorisation payment.
  ...
  `max_amount` _optional_
  : `integer` Use to set the maximum amount, in paise, per debit request. Know about [maximum and default values](/payments/recurring-payments/paper-nach/faqs#3-is-there-a-limit-on-the-debit).
