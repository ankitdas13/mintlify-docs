...
After this step, you can proceed to integrate with the [Fetch Token API](/api/payments/recurring-payments/cards/tokens).

## 1.2. Using a Registration Link

Registration Link is an alternate way of creating an authorisation transaction. You can create a registration link using the API or [Dashboard](/payments/recurring-payments/create#1-create-a-registration-link).
