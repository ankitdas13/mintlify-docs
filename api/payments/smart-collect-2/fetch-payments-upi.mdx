...
description: "**GET** `/v1/payments/:id/upi_transfer`"
---
...
: `object` Details of the Customer Identifier.
    ...
    `customer_id`
    : `string` The unique identifier of the customer the Customer Identifier is linked with. For more details, refer to the [Customers API](/api/customers).
