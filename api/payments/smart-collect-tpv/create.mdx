...
description: "**POST** `/v1/virtual_accounts`"
---
...
: `string` Unique identifier of the customer to whom the Customer Identifier must be tagged. Refer to the [Customer API](/api/customers) documentation to learn how to create a customer.

`notes` _optional_
: `json object` Any custom notes you might want to add to the Customer Identifier can be entered here. Refer to the [Notes section](/api/understand#notes) to learn more.
...
`notes`
: `json object` Any custom notes you might want to add to the Customer Identifier can be entered here. Check the [Notes section](/api/understand#notes) to know more.

`customer_id`
: `string` Unique identifier of the customer the Customer Identifier is linked with. Check the [Customer API](/api/customers) section to know more.
...
: `json object` Configuration of desired receivers for the Customer Identifier.
    ...
    `notes`
    : `json object` Any custom notes you might want to add to the Customer Identifier can be entered here. Check the [Notes section](/api/understand#notes) to know more. This parameter appears in the response only when `bank_account` is passed as the receiver `type`.
