---
title: "Route"
description: "You should create a linked account to integrate Route and start transferring payments to vendors."
---

 Below are the steps to integrate Route. You can also refer to our comprehensive [Route Integration guide](/payments/route/integration-guide).

 1. [Create a Linked Account](/api/payments/route/create-linked-account)
 2. [Create a Stakeholder](/api/payments/route/create-stakeholder)
 3. [Request a Product Configuration](/api/payments/route/request-product-config)
 4. [Update a Product Configuration](/api/payments/route/update-product-config)
 5. Transfer funds to Linked Accounts using [Orders](/api/payments/route/create-transfers-orders), [Payments](/api/payments/route/create-transfers-payments) or [Direct Transfer](/api/payments/route/direct-transfers) methods.

 Fork the Razorpay Postman Public Workspace and try the Linked Account APIs using your [Test API Keys](/api/authentication#generate-api-keys).
...
[About Linked Accounts](/payments/route/linked-account)
[About Route](/payments/route)
[Integrate With Route](/payments/route/integration-guide)
