...
description: "Create Razorpay [QR Codes](/payments/qr-codes) and share them with customers to accept digital payments."
---
...
Fork the Razorpay Postman Public Workspace and try the QR Codes (Image Content) APIs using your [Test API Keys](/api/authentication#generate-api-keys).
