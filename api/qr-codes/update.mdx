...
description: "**PATCH** `/v1/payments/qr_codes/:id/`"
---
...
`notes` _mandatory_
: `json object` Contains user-defined fields and is stored for reference purposes. Know more about [notes](/api/understand#notes).
...
`customer_id`
: `string` The unique identifier of the customer the QR Code is linked with. Know more about the [Customers API](/api/customers).
