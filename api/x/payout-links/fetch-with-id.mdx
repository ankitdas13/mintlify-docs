...
description: "**GET** `v1/payout-links/:id?expand[l=payouts`"
---
...
: `string` The unique identifier for the payout made to the contact. For example, `pout_00000000000001`. 
 ...
 This value is returned only when the Payout Link moves to the [`processed` state](/x/payout-links/life-cycle) after the contact receives the amount in their account. 
