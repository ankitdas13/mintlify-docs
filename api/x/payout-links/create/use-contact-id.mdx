...
Use this endpoint to create a Payout Link using the Contact id of the recipient. [Create a Contact](/x/contacts#create-a-contact) to generate the Contact id/Customer id.
...
: `integer` Timestamp, in Unix, when the Payout Link was to expire. This is set at the time of creation of the Payout Link and is set at least 15 minutes ahead of the current time. 
 ...
 This value is returned only if you have enabled the expiry feature for Payout Links. Know more about how to [set expiry](/x/payout-links/set-expiry) to Payout Links.
