...
description: "**GET** `/v1/payouts?account_number=\\{account number\\}`"
---
...
We do not recommend using the Fetch Payout API to check the status of the payouts. Instead, we recommend that you subscribe to our [Webhooks](/x/apis/subscribe) to get instant notifications. Whenever the status of your payouts change, you will be notified via these webhooks.
