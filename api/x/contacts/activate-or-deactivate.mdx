...
description: "**PATCH** `/v1/contacts/:id`"
---
...
* solution: Enter the correct Contact ID. You can find the Contact ID: - In the response body of [create a Contact](/api/x/contacts/create) API.
