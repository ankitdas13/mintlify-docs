---
title: "Customers"
description: "Add or create [Customers](/payments/customers) with basic details such as name, email and contact details. You can then offer various Razorpay solutions to your customers. Edit customer details as needed. You can create and manage customers using APIs or from the [Dashboard](/payments/customers)."
---

Fork the Razorpay Postman Public Workspace and try the Customers APIs using your [Test API Keys](/api/authentication#generate-api-keys).
...
[About Customers](/payments/customers)
