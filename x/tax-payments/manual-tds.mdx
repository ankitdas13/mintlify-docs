---
title: "Manual TDS"
description: "Tax Deducted at Source (TDS) is mandated by the government. You can upload TDS data to [RazorpayX Tax Payments](https://x.razorpay.com/tax-payments) and make payments. You can set up an automated method to pay taxes. Know more about [Automatic TDS payments](/x/tax-payments/automatic-tds)."
---
...
1. After you make the payment, it follows the [Approval Workflow](/x/manage-teams/approval-workflow) set on your RazorpayX account.
...
- [Advance Tax Payments](/x/tax-payments/advance)
