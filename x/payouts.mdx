---
title: "About Payouts"
description: "Payouts are transactions made to contacts. For every payout, you need to specify the amount, the contact, and the payout purpose. You become eligible to make payouts after you sign up, complete the account activation and KYC verification."
---

A payout transaction is made to a [Fund account](/x/fund-accounts) associated with a [Contact](/x/contacts). Contact is the beneficiary (person or institution) and Fund account is the account used for payment transactions.

**SUCCESS**

**What's New**

You can now initiate payouts directly to mobile numbers using the [Payout Composite API](/api/x/payout-composite/create/phone-number). This feature is currently not available on dashboard.
...
### Features and Functions
            ...
            Payouts in RazorpayX come with variety of features and functions. You can:
                ...
                - [Make payouts in Test Mode](/x/dashboard/test-mode#payouts) to understand the payout process and life cycle.

            If a payout fails at any stage, [a reversal is created](/x/payouts/states-life-cycle#reversal-transaction), which ends with the debited balance being credited back to your RazorpayX account.

            The payout amount, fees and tax are deducted from your RazorpayX account balance. These appear as a debit against your RazorpayX account. Know more about [Billing in RazorpayX](/x/manage-teams/billing).
...
<Steps>
<Step title="Add funds to your business account.">
Add funds to your business account.
</Step>
<Step title="Create a Contact and a Fund account. This is similar to adding a be...">
Create a Contact and a Fund account. This is similar to adding a beneficiary on your netbanking portal. Know more about adding [Contacts and Fund accounts](/x/contacts).
</Step>
...
<Step title="You can navigate to Payouts in two ways:">
...
<Step title="Select an existing contact or [create a new one](/x/contacts#create...">
Select an existing contact or [create a new one](/x/contacts#create-a-contact).
</Step>
<Step title="Hover over the fund account to which you want to make the payout an...">
Hover over the fund account to which you want to make the payout and click **NEXT** or [**+ FUND ACCOUNT**](/x/fund-accounts#update-a-contact-and-fund-account) as per requirement.
</Step>
<Step title="Enter the total amount to be paid and click **Next**.">
Enter the total amount to be paid and click **Next**.
</Step>
<Step title="Select the Payout Details:">
...
<Step title="Click **Next**. An OTP is sent to your registered mobile number and...">
...
You can cancel the payouts in a [`queued`](/x/payouts/states-life-cycle#queued), [`pending`](/x/payouts/states-life-cycle#pending) or [`scheduled`](/x/payouts/states-life-cycle#scheduled) state only.
...
Know more about creating [payouts using APIs](/api/x/payouts) and [payouts in bulk](/x/contacts/bulk-uploads).
...
### RazorpayX Lite
         ...
         The transaction limits and operating hours for different payout modes for [RazorpayX Lite](/x/account-types#virtual-account) are as below:
...
### Current Account
         ...
         The transaction limits and operating hours for different payout modes for [Current account](/x/account-types#current-account):
...
[Contact support](/x/support) for enabling **NEFT 24 * 7** in RBL and Yes Bank accounts.
...
- [Payout Status](/x/payouts/status-details)
