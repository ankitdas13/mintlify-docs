---
title: "Bulk Payout Links Report and Errors"
description: "After processing your [Payout Links bulk upload](/x/payout-links/bulk#process-bulk-payout-links) file, RazorpayX generates a Bulk Upload report. The report shows the:"
---
...
- Additional details as per the [fields requested](/x/payout-links/bulk#requested-fields-in-template) in the sample template for Payout Links.
...
---
3 | Expiry Date missing, but Expiry Time present | Expiry time has been entered but not the expiry date. Enter expiry date in the batch file and upload again. Know about [Payout Link Expiry](/x/payout-links/set-expiry).
---
...
- [Payout Links Life Cycle](/x/payout-links/life-cycle)  
- [Payout Links FAQs](/x/payout-links/faqs)
