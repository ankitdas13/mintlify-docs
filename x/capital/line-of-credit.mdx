---
title: "About Line of Credit"
description: "Razorpay [Line of Credit](https://razorpay.com/x/line-of-credit/) (LOC) is a convenient working capital solution offering flexible repayment options for a 12-month tenure. You can choose your repayment tenure and pay interest only on the amount you have withdrawn via equated monthly instalments (EMI) at your own pace."
---
...
- [Withdraw funds](/x/capital/line-of-credit/dashboard#make-withdrawals) from your line, 24/7. 
- Choose the tenure within which you want to repay the withdrawn amount, including the interest accumulated. 
- [Repay your withdrawals](/x/capital/line-of-credit/dashboard#make-repayments) in two different ways, or pre-close withdrawal.
...
---
`partially repaid` | If you repay less than total due amount when [repaying a withdrawal](/x/capital/line-of-credit/dashboard#make-repayments), this is the status.
---
...
---
`failed` | If your EMI repayment had failed, this is the status. This usually happens due to unavoidable server downtimes. Retry making the EMI payment. [Contact support](/x/support#razorpayx-capital) from the Dashboard for any queries. 
---
...
- However, **overdue charges are applicable** when you do not pay the EMIs on the due date. 
 ...
 The interest accrued is shown on the right pane of the [withdrawal summary](/x/capital/line-of-credit/dashboard) with ⓘ and is inclusive of the overdue charges when you view it after the due date.
...
- [Line of Credit FAQs](/x/capital/line-of-credit/faqs)
