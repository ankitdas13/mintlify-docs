...
Upon withdrawal, you can choose your repayment schedule. We deduct from your [settlement's current balance](/payments/settlements/dashboard#view-settlements-using-dashboard) to repay the loan instalments automatically. You can also make repayments manually. 
...
1. Follow these steps to apply for a [Line of Credit](/x/capital/line-of-credit#apply-for-line-of-credit). The process is the same. 
...
This happens on a daily basis and we recommend this for businesses using other [Razorpay products](/payments).

<Warning>

**Watch Out!**

We only deduct from your Razorpay [settlement's current balance](/payments/settlements/dashboard#view-settlements-using-dashboard) and not your linked bank account.
...
1. You can do either of the following:
            ...
            1. Select between your Razorpay [settlement's current balance](/payments/settlements/dashboard#view-settlements-using-dashboard) for us to deduct your instalment amount or pay using UPI/Debit Card/Netbanking. 
...
---
`failed` | Sometimes, your disbursal or repayments may fail due to unavoidable server downtimes. Retry the withdrawal/repayment process. You can [contact support](/x/support#razorpayx-capital) from the RazorpayX Dashboard for any queries. 
---
...
### 9. My question is not answered here.
         ...
         [Raise a request](/payments/dashboard/support#raise-a-new-ticket) from your [RazorpayX Dashboard](https://x.razorpay.com/auth) in case of any queries.
        

#### Related Information

- [Razorpay Capital Use Cases](/x/capital/line-of-credit#use-cases)
