---
title: "Make Withdrawals & Repayments"
description: "After your [credit limit](/x/capital/line-of-credit#how-it-works) is available to you, you can start withdrawing from your credit line on the [RazorpayX Dashboard](https://x.raz..."
---

After your [credit limit](/x/capital/line-of-credit#how-it-works) is available to you, you can start withdrawing from your credit line on the [RazorpayX Dashboard](https://x.razorpay.com/auth). Here you can:
...
- Once the amount is debited, the withdrawal status is updated as per the [withdrawal workflow](/x/capital/line-of-credit#withdrawal-workflow).
...
- Pay from the Withdrawal tab.
        ...
        When you want to repay more than one EMI at once, you can pay your EMIs directly from the Overview tab on the [RazorpayX Dashboard](https://x.razorpay.com/auth). 
            ...
            After receiving your payment, the instalment history gets updated as per the [withdrawal workflow](/x/capital/line-of-credit#withdrawal-workflow).
        ...
        If you want to repay a single withdrawal EMI before the due date:
            ...
            Once we receive your payment, the instalment history gets updated as per the [withdrawal workflow](/x/capital/line-of-credit#withdrawal-workflow).
...
Once we receive your payment, the instalment history gets updated as per the [withdrawal workflow](/x/capital/line-of-credit#withdrawal-workflow). You can withdraw 48 hours after pre-closing your EMI.
