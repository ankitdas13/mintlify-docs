---
title: "Billing - Fees and Taxes"
description: "When you make a payout from your RazorpayX account, you are charged fees and taxes, which is deducted from your account balance."
---
...
When you make a payout using [RazorpayX Lite](/x/account-types/razorpayx-lite), the fees and taxes are charged as a part of the payout in real-time.
...
In case of a [payout reversal](/x/payouts/states-life-cycle#reversal-transaction), the fees and tax are also reversed.

### Payouts from Current Account

When you make a payout from your [Current Account](/x/account-types/current-account), you are charged a fee. The fees and taxes are collected once everyday and **appear as a payout** in your account statement. This is an automated process and does not require any action from you.
...
<Step title="Navigate to **My Account & Settings** → **Billing**.">
Navigate to **My Account & Settings** → **Billing**.
</Step>
<Step title="In the **MONTHLY INVOICE** section, click **REPORT** against a part...">
In the **MONTHLY INVOICE** section, click **REPORT** against a particular month in the **EXPORT** column.
</Step>
<Step title="Select the **Include charged and pending fee details** check box if...">
Select the **Include charged and pending fee details** check box if required.
</Step>
</Steps>
...
<Step title="In the **MONTHLY INVOICE** section, click **INVOICE** against a par...">
In the **MONTHLY INVOICE** section, click **INVOICE** against a particular month in the **EXPORT** column.
</Step>
</Steps>
