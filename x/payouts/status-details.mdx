...
description: "Payout Status details are returned when a payout is created and moves to another state. Know more about [Payout States](/x/payouts/states-life-cycle)."
---
...
- [Fetch Payout API response](/errors/x/payout-status-details)
...
### Subscribe to Daily Reports
             ...
             To subscribe, [raise a support ticket](/x/support) from the RazorpayX Dashboard with a list of recipient email IDs. We will enable the function for you in 3 working days.
