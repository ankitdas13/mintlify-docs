---
title: "Intelligent Payouts"
description: "Intelligent Payouts detects downtimes or degradations at Razorpay's partner or beneficiary banks' side and prevents the money from being blocked for T+3 days. Downtimes refer to the time period when payouts underperform, leading to considerable delays in processing."
---
...
Intelligent payouts is available by default for Current Account users. RazorpayX Lite users must consume `payout.failed` [webhook](/webhooks#payout-failed) to enable Intelligent payouts.
...
You can customise the SLA by contacting our [Support Team](/x/support#razorpayx-users).
...
- [Webhooks](/webhooks/setup-edit-payouts)
