---
title: "Input Tax Credit Checker"
description: "Enabling GST Input Credit allows RazorpayX to use GSTR-2A data and check if your vendors have reported GST correctly and reports if there are discrepancies. This helps you optimise your GST input claim."
---
