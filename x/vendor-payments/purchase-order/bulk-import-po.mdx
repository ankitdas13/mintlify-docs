---
title: "Bulk Import"
description: "Managing Purchase Orders, Items and GRNs can be very tedious and time-consuming in a large scale business. The Bulk Import feature in RazorpayX helps to overcome this by enabling you to:"
---
...
### Related Information
   ...
   - [Bulk Import GRN](/x/vendor-payments/grn/bulk-import-grn)
   - [Bulk Import Items](/x/vendor-payments/items/bulk-import-items)
