---
title: "Pay TDS on Vendor Advances"
description: "On the RazorpayX Dashboard, you can make advance payments to a vendor and simultaneously deduct the Tax Deducted at Source (TDS), in compliance with the TDS law."
---
...
1. Navigate to **Vendor Payments** → **Advances** in the left menu and click **+ Advance**. Follow the steps to [create an advance payment](/x/vendor-payments/advances#create-vendor-advance) using the applicable POs and vendor details.
...
1. Click **Next**.  
1. [Create a payout](/x/payouts#create-a-payout) after selecting the [Payout purpose](/x/payouts#payout-purpose), debit account, mode of payment and more. You can also add attachments and additional details, and [schedule the payout](/x/payouts/scheduled#individual-payout). 
1. Authorise the payout with OTP. If [approval workflow](/x/vendor-payments/approvals-on-invoices) is applicable, the payout is sent to the approver. 
...
- [About Vendor Portal](/x/vendor-payments/portal/business)
