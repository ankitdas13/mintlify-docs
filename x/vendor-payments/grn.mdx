---
title: "About GRN"
description: "GRN - Goods Received Note is a document used in procurement to formally acknowledge the receipt of goods."
---
...
<Step title="Navigate to **Source to Pay** on the left-hand menu.">
Navigate to **Source to Pay** on the left-hand menu.
</Step>
<Step title="Click **GRN**.">
Click **GRN**.
</Step>
<Step title="Click **+ New GRN**. The New GRN modal is displayed.">
Click **+ New GRN**. The New GRN modal is displayed.
</Step>
<Step title="From the list of vendors, select the vendor for whom the GRN has to...">
From the list of vendors, select the vendor for whom the GRN has to be created. If it is a new vendor, you can click **+ NEW VENDOR** to create a new vendor.
