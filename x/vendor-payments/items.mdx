---
title: "Items"
description: "Items serve as a detailed description of products or services that are bought or sold. They enable buyers to verify that they are receiving what they ordered and at the agreed-upon prices, and they provide sellers with a clear record of what was delivered and the corresponding revenue."
---

[Invoices](/x/vendor-payments/invoices) and [purchase orders](/x/vendor-payments/purchase-order) often feature multiple items, making them records of a business transactions. The effective use of items streamlines the process of procurement, sales and financial management, contributing to more efficient and accurate business operations.
...
<Step title="Navigate to **Vendor Payments** → **Items**.">
Navigate to **Vendor Payments** → **Items**.
</Step>
<Step title="Click **+ Item**.">
Click **+ Item**.

</Step>
<Step title="Enter the fields mentioned [above](/x/vendor-payments/items#item-fi...">
Enter the fields mentioned [above](/x/vendor-payments/items#item-fields).
</Step>
...
<Step title="Select the item you want to edit.">
Select the item you want to edit.
</Step>
<Step title="Go to **Options** → **Edit Item**.">
Go to **Options** → **Edit Item**.

</Step>
<Step title="Add or modify the fields and click **Save**.">
...
<Step title="Select the item you want to mark inactive.">
Select the item you want to mark inactive.
</Step>
<Step title="Go to **Options** → **Mark Inactive**.">
