---
title: "Bring Invoices to Tally"
description: "With the accounting assistant, the [RazorpayX-Tally Integration](/x/vendor-payments/tally), you can:"
---
...
2. The bills received from the below-mentioned modes are auto-read by the RazorpayX AI OCR reader. You can create bills in RazorpayX via: - [Vendor Portal](/x/vendor-payments/portal/business)
- [Bulk drag and drop](/x/vendor-payments/bulk-invoices)
- [Email Integration](/x/vendor-payments/invoices#add-invoices-through-email)
 You can pay bills in RazorpayX via: - [Bulk Payouts](/x/vendor-payments/vendor-payouts/bulk)
...
When you [generate an invoice](/x/vendor-payments) in Vendor Payments, you can automate bringing that bill to Tally. 
...
<Steps>
<Step title="Set up the necessary ledgers and map the expenses and tax accordingly.">
Set up the necessary ledgers and map the expenses and tax accordingly.
</Step>
<Step title="When you bring a bill from RazorpayX, Tally maps that transaction t...">
When you bring a bill from RazorpayX, Tally maps that transaction to the respective ledger.
</Step>
<Step title="You can manually change the mapping to a different ledger if necess...">
...
After you [create an invoice](/x/vendor-payments) in Vendor Payments, sync the bill in Tally. To do so: 
