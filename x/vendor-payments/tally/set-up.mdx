...
description: "Start the RazorpayX-Tally Integration via your [RazorpayX Dashboard](https://x.razorpay.com/). To install and set up your integration, you must:"
---

<Steps>
<Step title="[Download the plugin](#download-plugin).">
[Download the plugin](#download-plugin).
</Step>
<Step title="[Locate the file path and install the integration](#install-and-set...">
[Locate the file path and install the integration](#install-and-set-up).
</Step>
<Step title="[Configure your Tally Application](#configure-integration).">
[Configure your Tally Application](#configure-integration).
</Step>
</Steps>
After setup, change or modify the settings in your Tally application to make the [four flows](/x/vendor-payments/tally#four-flows) of the integration work seamlessly.
...
Start integrating RazorpayX with Tally by yourself or invite your Finance Team to do it. Know more about [managing teams and user roles](/x/manage-teams) in RazorpayX. 
...
To fully configure the application, enable and disable the settings as per the [four flows](/x/vendor-payments/tally#four-flows) applicable to your business. 
- If you choose to [bring bills](/x/vendor-payments/tally/bring-bills) to Tally from RazorpayX, enable it at this step. 
- You can change the settings to sync [Purchase Vouchers](/x/vendor-payments/tally/sync-purchase-vouchers) and [Payment Vouchers](/x/vendor-payments/tally/sync-payment-vouchers) entries in Tally and RazorpayX. Select **Yes** against only one of them at a time. 
...
- [Create RazorpayX Ledger](/x/tally-epayments/set-up)
