---
title: "Smart Bank Statement Sync"
description: "The Smart Bank Statement feature syncs transactions from your bank statements as entries in your Tally application. With this feature, you can understand your transactions from a business perspective than just a banking perspective."
---

## How it Works 

<Steps>
<Step title="Suppose you paid a vendor and it shows in your bank statement as a...">
Suppose you paid a vendor and it shows in your bank statement as a debit and a double-entry transaction only.
</Step>
<Step title="When you sync the transaction using the RazorpayX-Tally Integration...">
...
<Step title="Create a journal entry and reconcile payments easily.">
...
Whether you [make a payout](/x/payouts#how-to-make-payouts), or the money is debited as part of a [payout link](/x/payout-links), payroll, tax payments and more, **all transactions** can be synced in Tally. 
...
- [Bring bills from RazorpayX to Tally](/x/vendor-payments/tally/bring-bills)
- Sync Vouchers in RazorpayX
   - [Purchase Vouchers](/x/vendor-payments/tally/sync-purchase-vouchers)
   - [Payment Vouchers](/x/vendor-payments/tally/sync-payment-vouchers)
