---
title: "Sync Payment Vouchers"
description: "After you [set up and configure](/x/vendor-payments/tally/set-up) the integration, you can send your [Payment Vouchers](#send-and-sync-payment-vouchers-to-razorpayx) to RazorpayX and sync them for reconciliation."
---
...
<Steps>
<Step title="[Send the Payment Vouchers to RazorpayX](#1-send-payment-voucher).">
[Send the Payment Vouchers to RazorpayX](#1-send-payment-voucher).
</Step>
<Step title="[Sync the voucher in RazorpayX](#2-sync-payment-voucher).">
[Sync the voucher in RazorpayX](#2-sync-payment-voucher).
</Step>
...
Go to RazorpayX and pay your invoices as per the standard [vendor payment flow](/x/vendor-payments).
...
All the payments made can be brought back to Tally. Know more about [bringing bills to Tally](/x/vendor-payments/tally/bring-bills) from RazorpayX.
