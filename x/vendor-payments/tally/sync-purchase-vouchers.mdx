---
title: "Sync Purchase Vouchers"
description: "After you [set up and configure](/x/vendor-payments/tally/set-up) the integration, you can send your Purchase Vouchers to RazorpayX and sync them for reconciliation."
---
...
<Steps>
<Step title="[Send the Purchase Voucher to RazorpayX](#1-send-purchase-voucher).">
[Send the Purchase Voucher to RazorpayX](#1-send-purchase-voucher).
</Step>
<Step title="[Sync the voucher in RazorpayX](#2-sync-purchase-voucher).">
[Sync the voucher in RazorpayX](#2-sync-purchase-voucher).
</Step>
<Step title="[Make payments as per the invoices created in RazorpayX](#pay-invoi...">
[Make payments as per the invoices created in RazorpayX](#pay-invoices).
</Step>
</Steps>
...
If the section is empty, [create a Contact](/x/contacts) of the type Vendor and [create a Fund Account](/x/fund-accounts) for that Contact. 
...
You have now successfully synced a Purchase Voucher made in Tally to RazorpayX. Know more about [syncing Payment Vouchers](/x/vendor-payments/tally/sync-payment-vouchers). 

## Pay Invoices

After you send and sync the vouchers in RazorpayX, you can pay the invoices in the following ways:
- [Pay your vendor immediately](/x/vendor-payments).
- [Pay vendor partially](/x/vendor-payments/vendor-payouts/partial-payouts).
- [Schedule the vendor payment](/x/vendor-payments/vendor-payouts/scheduled-payouts).
- [Make vendor payouts in bulk](/x/vendor-payments/vendor-payouts/bulk).

All the payments made can be brought back to Tally. Know more about [bringing bills](/x/vendor-payments/tally/bring-bills) to Tally from RazorpayX.

### Related Information

- [Bring Bills to Tally](/x/vendor-payments/tally/bring-bills) 
