...
You can automate this process to an extent by setting [**Contact Rules**](/x/accounting/zohobooks#rules). This means that you can select a corresponding **Tally Expense Account** to which you want the vendor payments made to that particular vendor, to sync. 
