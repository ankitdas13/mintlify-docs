...
description: "Tally is widely used accounting software known for its user-friendly interface. It helps businesses manage financial transactions, track inventory and comply with tax regulations. Tally provides customizable reports, ensures data security, and supports multi-user collaboration."
---
...
The [**Accounting** tab](/x/accounting) appears on your RazorpayX Dashboard left navigation. You can change the existing settings from **Accounting** → [**Rules & Configuration**](#rules--configuration) at any time.
...
### General
       ...
       You can choose to disable or enable the following options:
         ...
         - Sync and Categorise [Vendor Payments](/x/accounting/zohobooks/vendor-payments) from RazorpayX to Tally
         - Sync and Categorise [Payouts](/x/accounting/zohobooks/payouts) from RazorpayX to Tally
