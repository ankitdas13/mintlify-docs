---
title: "Bulk Upload - Contact and Fund Account"
description: "You can use the bulk upload feature to create Contacts and Fund accounts in bulk from the Dashboard. You can also use this feature to add Fund account details to existing Contacts. Export the existing Contacts and add the beneficiary details."
---
