...
description: "Unfortunately, we do not support freelancers/individuals on [RazorpayX](/x) at the moment."
---
...
### 1. Can I use RazorpayX as a freelancer/individual?
         ...
         Unfortunately, we do not support freelancers/individuals on [RazorpayX](/x) at the moment.
        

    
### 2. What reports are available on RazorpayX platform?

         Downloadable reports are available in every section of the Dashboard. Currently only `.csv` and `.xls` based reports are available. Know more about [Reports](/x/reports).
        

    
### 3. How to generate Account Statement report?

         Navigate to Account Statement on the RazorpayX Dashboard to generate the report. Know more about [Account Statement](/x/account-statement).
        

    
### 4. Is there a monthly invoice available for the charges deducted?

         Yes, we provide monthly invoices. You can download the invoice from the Billing section of your Dashboard. Know more about [Billing reports](/x/manage-teams/billing#billing-reports).
        

    
### 5. What are Actionable Insights?

         [RazorpayX](/x) Insights help businesses analyse and manage their expenses better and empower them to take more informed and impactful business decisions.
...
### 6. If an account has access to both Razorpay and RazorpayX platforms, is there a combined transactions report for both platforms?
         ...
         No, [Razorpay](/payments) and [RazorpayX](/x) are different platforms. Transactions created on Razorpay will not show up on RazorpayX platform and vice versa, neither on dashboard nor reports.
...
### 8. How do I contact the support team if my issue is not resolved?
             ...
             You can visit our [support page](/x/support) to reach out to our support team.
...
### 3. What to do if the account owner is locked?
         ...
         If user account gets locked for security reasons, contact our [Support Team](/x/support) to **Reset 2FA** for your account.
        

    
### 4. What to do if the account owner loses the mobile device?

         If an account owner has lost their mobile device, contact our [Support Team](/x/support) to **Reset 2FA** for your account.
...
### 2. Can different roles be assigned to my team members on RazorpayX?
         ...
         Yes, you can assign different set of roles to a team member as per your requirement to [manage your team](/x/manage-teams). 
