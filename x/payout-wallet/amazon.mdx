---
title: "About Amazon Payout Gift Card"
description: "You can make payouts to Amazon Pay Gift Cards using your [RazorpayX Lite](/x/account-types/razorpayx-lite). Once you process the payout, the amount gets instantly credited to your end customer's Amazon Pay Gift Card balance."
---
...
- This feature is available only on [RazorpayX Lite](/x/account-types/razorpayx-lite).
...
<Steps>
<Step title="Create a [Contact](/x/contacts#create-a-contact-with-fund-account).">
Create a [Contact](/x/contacts#create-a-contact-with-fund-account).
</Step>
<Step title="Create a Fund account with `type: wallet` and `provider: amazonpay`.">
Create a Fund account with `type: wallet` and `provider: amazonpay`.
</Step>
<Step title="Create a payout with `mode: amazonpay`.">
Create a payout with `mode: amazonpay`.
</Step>
<Step title="The money is credited to the Amazon Pay Gift Card balance linked to...">
The money is credited to the Amazon Pay Gift Card balance linked to the beneficiary's phone number.
</Step>
</Steps>

## Payout Life Cycle

See: [Payout states and life cycle](/x/payouts/states-life-cycle).
...
Know more about [creating a Fund account via API](/api/x/payout-wallet/create/fund-account) with `type: wallet` and `provider: amazonpay` and [creating payouts via Amazon Pay](/api/x/payout-wallet/create/payout).
...
Know more about to the [Amazon Branding Guidelines](/x/payout-wallet/amazon/branding-guidelines).
...
- [Amazon Payout APIs](/api/x/payout-wallet)
