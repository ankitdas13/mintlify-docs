...
description: "To make a payout to a Contact, you must [create a Fund Account](/x/fund-accounts#create-a-contact-with-fund-account) associated with that Contact. Payouts made to the Contact ar..."
---
...
To make a payout to a Contact, you must [create a Fund Account](/x/fund-accounts#create-a-contact-with-fund-account) associated with that Contact. Payouts made to the Contact are credited to that Fund Account. Thus, its necessary to create a Fund Account to start transacting with the contact. 
...
You can add a bank account for a contact by [creating a Fund Account](/x/fund-accounts#create-a-contact-with-fund-account) for that Contact. 
...
You must provide the Contact’s VPA while [creating a Fund Account](/x/fund-accounts#create-a-contact-with-fund-account) of type VPA.
...
Currently, it can be done via the [Fund Account Validation API](/api/x/composite-account-validation) only. We do not support validation of Fund Accounts through the Dashboard.
...
If this is not the case, please raise [a support query](/x/support#razorpayx-users).
...
For more information on fund account validation charges, please raise [a support query](/x/support#razorpayx-users).
...
No, it is not supported in [test mode](/x/dashboard/test-mode).
...
Know more about [Fund Account Validation statuses](/api/x/account-validation).
