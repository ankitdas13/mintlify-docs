...
description: "The Razorpay Local MCP Server is a self-hosted solution that provides complete control over your infrastructure and access to all available tools without restrictions. Choose this option if you need full functionality or have specific security requirements."
---
...
Restart your AI assistant application after configuration. You should see [Razorpay MCP tools](/mcp-server/tools-reference) become available. Test the connection by asking: **Show me available Razorpay tools**.
...
<Steps>
<Step title="**Explore Advanced Features**: Access all tools including refunds a...">
**Explore Advanced Features**: Access all tools including refunds and settlements.
</Step>
<Step title="**Configure Advanced Options**: See [Configuration Guide](/mcp-serv...">
**Configure Advanced Options**: See [Configuration Guide](/mcp-server/configuration) for detailed settings.
</Step>
<Step title="**Review Use Cases**: Check [practical examples](/mcp-server/use-ca...">
**Review Use Cases**: Check [practical examples](/mcp-server/use-cases) that leverage local-only tools.
</Step>
</Steps>
