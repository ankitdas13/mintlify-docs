---
title: "Integrate COD & Magic Checkout with iThink Logistics"
description: "iThink logistics is a third-party logistics service provider that makes your ecommerce shipping process easier."
---
...
### 2. Enable iThink Logistics on Razorpay Dashboard
         ...
         2. Navigate to **Magic Checkout** â†’ **Setup and Settings**. 
         3. Navigate to **RTO Settings** â†’ **Delivery Tracking**.  
