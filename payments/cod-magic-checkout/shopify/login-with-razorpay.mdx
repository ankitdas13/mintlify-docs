---
title: "Login With Razorpay Setup (SSO)"
description: "Razorpay Magic SSO (Single Sign-On) offers a seamless login experience, helping you enhance conversions and gain valuable insights into user behaviour."
---
...
<Steps>
<Step title="Step 1">
Log in to the [Shopify Store](https://accounts.shopify.com/store-login) and navigate to **Settings** → **Customer accounts**.
</Step>
<Step title="Step 2">
In the **Login Links** section, select **Legacy**. 
</Step>
<Step title="Step 3">
Click **Switch to legacy customer accounts** to confirm.

</Step>
<Step title="Step 4">
On the home page, navigate to **Online Store** → **Preferences** in the **Sales channels** section.
</Step>
<Step title="Step 5">
Scroll down to the **Spam Protection** section and disable the captcha settings:
...
<Steps>
<Step title="Step 1">
Log in to the Dashboard navigate to **Magic Checkout** → **Setup & Settings**. 
</Step>
<Step title="Step 2">
Navigate to **Login with Razorpay Setup**.
</Step>
<Step title="Step 3">
Turn on **Enable Login with Razorpay**.

</Step>
<Step title="Step 4">
You will be able to view the following options for the SSO widget: 
- [Settings](#settings)
- [Customise](#customise)
</Step>
</Steps>
...
- [Automatic Customer Tagging for Retargeting](/payments/cod-magic-checkout/shopify/login-with-razorpay/automation-tags)
- [Customer Analytics](/payments/cod-magic-checkout/shopify/login-with-razorpay/customer-analytics)
