---
title: "Coupons"
description: "You can choose to offer discounts to your customers by adding coupons using Razorpay Dashboard."
---
...
<Steps>
<Step title="Step 1">
Log in to the Dashboard and navigate to **Magic Checkout** → **Setup & Settings** → **Checkout Settings**. 
</Step>
<Step title="Step 2">
