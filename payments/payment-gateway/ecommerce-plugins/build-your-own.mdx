...
description: "You can build a plugin that integrates Razorpay Payment Gateway with websites created using ecommerce platforms such as Spree Commerce."
---
...
### WebView
     ...
     If your website is likely to be accessed mostly in the Facebook browser or via other mobile applications in a WebView, it might face certain issues. Refer to our [Callback URL documentation](/payments/payment-gateway/callback-url) for more details on how to handle this.
    

  
### Network Connectivity Issues

     If the customer has an issue with the network connectivity, you will not know of the payment completion from your website. In such cases, you can use our [Webhooks](/webhooks) to get notified of all authorized payments and then you can mark them as successful at your end.
...
### 3. Display the Checkout Form on Your Website to Your Customer.
     ...
     You can display the [Standard Checkout form](/payments/payment-gateway/web-integration/standard) on your website to collect payments from customers. Ensure that the `order_id` option is passed along with the other checkout options mentioned below.
