...
description: "Reconciling payments made on your Shopify store with the data available on your Dashboard is a simple process."
---
...
- [Integrate with Shopify Plugin](/payments/payment-gateway/ecommerce-plugins/shopify-razorpay-secure)
- [Shopify FAQs](/payments/payment-gateway/ecommerce-plugins/shopify-razorpay-secure/faqs)
