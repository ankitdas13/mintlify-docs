...
description: "**Cause**: Before connecting your account with the Wix platform, you need to set up Webhooks on the Dashboard. If you do not set up Webhooks, there may be connection errors."
---
...
### 4. What troubleshooting procedures should be carried out prior to initiating a support ticket?
         ...
         1. Reinstall the Razorpay Wix plugin and ensure that your system meets all the requirements mentioned [here](/payments/payment-gateway/ecommerce-plugins/wix/integration-steps).
