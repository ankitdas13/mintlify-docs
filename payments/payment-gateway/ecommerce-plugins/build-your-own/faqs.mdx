...
description: "You can sign up for a Razorpay account from the Dashboard sign up page. You don't need to submit any documents to access test mode. All to need to do is verify your email address."
---
...
### 1. How do I sign up for a test account?
         ...
         Refer to the [Set up your Razorpay Account](/payments/set-up) page for more details.
