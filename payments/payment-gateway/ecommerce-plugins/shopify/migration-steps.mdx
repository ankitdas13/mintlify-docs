...
description: "If you are using Razorpay to accept payments, you can now upgrade to the **1 Razorpay App** on your Shopify Store. Watch the [video tutorial](#video-tutorial) or follow the [migration steps](#migration-steps) to migrate to 1 Razorpay App. Know more about why you need to [upgrade to 1 Razorpay](/payments/payment-gateway/ecommerce-plugins/shopify/faqs#1-why-do-i-need-to-upgrade-to)."
---
...
### Deactivation
         ...
         For more information, see [Shopify FAQs](/payments/payment-gateway/ecommerce-plugins/shopify/faqs).
...
Know more about how to [reconcile Shopify orders on the Dashboard](/payments/payment-gateway/ecommerce-plugins/shopify/reconcile-payments). 
