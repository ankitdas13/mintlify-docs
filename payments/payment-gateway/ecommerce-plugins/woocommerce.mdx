---
title: "Prerequisites"
description: "Razorpay WooCommerce integration allows you to accept payments on your WordPress WooCommerce store using the Razorpay Payment Gateway plugin. This guide covers the prerequisites and setup steps to integrate Razorpay with"
---
...
- If you are not using WooCommerce, you can use our [native plugin for WordPress](/payments/payment-gateway/ecommerce-plugins/wordpress).
- Razorpay WooCommerce subscription plugin is available only in the paid versions of WooCommerce.
- For Subscriptions on a WooCommerce-based website, you can use our [Subscriptions plugin for WooCommerce](/payments/subscriptions/plugins/woocommerce).
...
Payment Gateway | Route | Subscriptions | [Razorpay Trusted Business](/payments/widgets/trusted-business/rtb-widget-woocommerce)
---
✓ | ✓ | ✓ | ✓
