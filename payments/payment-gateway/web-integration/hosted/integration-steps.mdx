...
description: "Watch this video to know how to integrate Razorpay Hosted Checkout on your website."
---
...
<Steps>
<Step title="Step 1">
[Build Integration](#1-build-integration): Use the sample codes to integrate the Razorpay Hosted Integration on your website.
</Step>
<Step title="Step 2">
[Test Integration](#2-test-integration): Make a test payment using the payment methods configured at checkout to ensure the integration is working as expected.
</Step>
<Step title="Step 3">
[Go-live Checklist](#3-go-live-checklist): Check the go-live checklist before taking the integration live.
</Step>
</Steps>
...
`key_id` _mandatory_
: `string` Enter [YOUR_Key_ID] generated from the [Dashboard](/payments/dashboard/account-settings/api-keys#generate-api-keys).
...
After you have completed the integration, you can [set up webhooks](/webhooks/setup-edit-payments), make test payments, replace the test key with the live key and integrate with other [APIs](/api).
     ...
     Here are the links to our [SDKs](/payments/payment-gateway/web-integration/standard#github-and-documentation-links-for-sdks) for the supported platforms.
