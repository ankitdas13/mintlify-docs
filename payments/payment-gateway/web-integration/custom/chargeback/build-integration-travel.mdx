...
description: "Follow the steps to integrate Custom Checkout in your site:"
---
...
Know more about [sample codes for various payment methods](/payments/payment-gateway/web-integration/custom/payment-methods).
...
[Step 2: Test Integration](/payments/payment-gateway/web-integration/custom/chargeback/test-integration)
