...
: `string` Currency code for the currency in which you want to accept the payment. For example, `INR`. Refer to the [supported currencies](/payments/international-payments#supported-currencies) for a list of supported international currencies.
