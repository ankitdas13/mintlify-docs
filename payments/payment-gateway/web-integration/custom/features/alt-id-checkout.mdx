...
description: "Razorpay offers Alternate Identifier (Alt id), a solution that is compliant with RBI guidelines for guest checkout payments. Alternate Identifier provides a smooth payment experience to customers."
---
