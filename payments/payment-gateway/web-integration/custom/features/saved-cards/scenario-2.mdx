...
description: "If you do not intend to collect customer consent to save card details on your UI and want Razorpay to collect the consent, follow the steps below."
---
...
You can create customers using the [Create a Customer API](/api/customers). The `customer_id` received in the response should be passed in the Create Payment request.
