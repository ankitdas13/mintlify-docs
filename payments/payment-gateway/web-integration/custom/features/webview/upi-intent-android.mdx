...
<Steps>
<Step title="Open your website integrated with custom checkout.">
...
Pass `webview_intent: true` parameter in the [payload](/payments/payment-gateway/web-integration/custom/build-integration#132-instantiate-custom-checkout) sent to checkout to enable UPI intent support.
</Step>
