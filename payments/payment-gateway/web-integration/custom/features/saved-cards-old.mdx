...
description: "You can save sensitive card information entered by the customer as \"tokens\" in Razorpay. On a repeat visit, the customers will be able to pay directly just by entering the cvv o..."
---
...
- [Generate the API Keys on Dashboard](/payments/dashboard/account-settings#api-keys).

Watch the video to see how to generate API key in Test Mode.

- [Integrate with our Custom Checkout](/payments/payment-gateway/web-integration/custom).
...
<Steps>
<Step title="[Enable Flash Checkout on Dashboard](#step-1-enable-flash-checkout-...">
[Enable Flash Checkout on Dashboard](#step-1-enable-flash-checkout-on-razorpay-dashboard).
</Step>
<Step title="[Create a Customer](#step-2-create-a-customer).">
[Create a Customer](#step-2-create-a-customer).
</Step>
<Step title="[Save Card Details on Checkout](#step-3-save-the-card-details-on-ch...">
[Save Card Details on Checkout](#step-3-save-the-card-details-on-checkout).
</Step>
<Step title="[Fetch all Tokens of Customer](#step-4-fetch-all-tokens-of-customer).">
[Fetch all Tokens of Customer](#step-4-fetch-all-tokens-of-customer).
</Step>
<Step title="[Create Payments using Saved Card](#step-5-create-payments-using-sa...">
[Create Payments using Saved Card](#step-5-create-payments-using-saved-card).
</Step>
</Steps>
...
**Read more:** [Learn more about Flash Checkout.](/payments/dashboard/account-settings#flash-checkout)
...
**Read More**: [Learn more about Customers API](/api/customers).
...
**Read more:** [Learn about the other Checkout parameters](/payments/payment-gateway/web-integration/custom/build-integration) for web integration.
