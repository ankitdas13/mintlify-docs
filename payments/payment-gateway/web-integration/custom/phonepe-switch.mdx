...
- Generate the API keys from the [Dashboard](/payments/dashboard/account-settings#api-keys). Use the test API Keys to test out the integration.
...
1. [Create an Order from your Server](/payments/payment-gateway/web-integration/custom/phonepe-switch#step-1-create-an-order-from-your-server).
1. [Invoke Checkout and Pass Order Id and Other Options to it](/payments/payment-gateway/web-integration/custom/phonepe-switch#step-2-invoke-checkout-and-pass-order-id)
  1. [Include the JavaScript code in your Webpage](/payments/payment-gateway/web-integration/custom/phonepe-switch#step-21-include-the-javascript-code-in-your).
  1. [Instantiate Razorpay Custom Checkout](/payments/payment-gateway/web-integration/custom/phonepe-switch#step-22-instantiate-razorpay-custom-checkout).
  1. [Submit Payment Details](/payments/payment-gateway/web-integration/custom/phonepe-switch#step-23-submit-payment-details).
1. [Store Fields in Your Server](/payments/payment-gateway/web-integration/custom/phonepe-switch#step-3-store-fields-in-your-server).
1. [Verify the Signature](/payments/payment-gateway/web-integration/custom/phonepe-switch#step-4-verify-the-signature).
