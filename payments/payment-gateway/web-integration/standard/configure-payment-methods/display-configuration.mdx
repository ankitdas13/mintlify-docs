...
description: "The `display` configuration can be passed in the Checkout options."
---
...
Descriptions for the checkout options parameters are present in the [Checkout Options](/payments/payment-gateway/web-integration/standard/integration-steps#123-checkout-options) table.
...
Descriptions for the request parameters are present in the [Create an Order Request Parameters](/api/orders/create) table.
