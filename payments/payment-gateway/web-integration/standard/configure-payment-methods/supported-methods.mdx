...
description: "All the supported payment methods and instruments are listed below:"
---
...
Know the standard debit card interest rates charged by the [banks](/payments/payment-methods/emi/faqs#5-can-you-provide-a-list-of-the).
...
Know the standard credit card interest rates charged by the [banks](/payments/payment-methods/emi/faqs#1-what-are-the-standard-credit-card-interest).
