...
description: "Payments made without an `order_id` cannot be captured and are automatically refunded. Create an order using the [Orders API](/payments/payment-gateway/web-integration/standard/integration-steps#11-create-an-order-in-ser"
---

### 1. Why are my customer payments being automatically refunded?

         Payments made without an `order_id` cannot be captured and are automatically refunded. Create an order using the [Orders API](/payments/payment-gateway/web-integration/standard/integration-steps#11-create-an-order-in-server) before initiating payments.
         ```
...
### 11. Can I accept payments through my Instagram page even if I do not have a website?
         ...
         Yes, you can accept payments without a website using Razorpay's no-code products such as [Payment Links](/payments/payment-links), [Payment Pages](/payments/payment-pages) or [Payment Button](/payments/payment-button), as Razorpay does not offer a direct Instagram integration.
        

    
### 12. Are language-based SDKs available?

         Yes, language-based SDKs are available [here](/payments/server-integration).
...
### 14. Which payment methods appear on Instagram/Facebook browsers?
         ...
         Payment methods like [UPI Intent](/payments/payment-methods/upi/upi-intent) and [Cards](/payments/payment-methods/cards) will appear on Instagram/Facebook browsers. These browsers do not support any other payment method that opens on a pop-up page.
...
### 15. Can I enable UPI Intent in WebView on my app?
         ...
         - [Android app](/payments/payment-gateway/web-integration/standard/webview/upi-intent-android)  
         - [iOS app](/payments/payment-gateway/web-integration/standard/webview/upi-intent-ios)
...
### 17. How can I accept payments on my Android or iOS apps without integrating with the native SDKs?
         ...
         If you want to accept payments on your Android or iOS apps without integrating with our native SDKs, you can reuse your Standard Integration code. This approach opens the checkout form in a WebView within your mobile app. Know more about [Webview for Mobile Apps](/payments/payment-gateway/web-integration/standard/webview).
        

    
### 18. How do I accept international payments on checkout?

         You need to enable the international payments feature on your Razorpay account. Refer to [international payments](/payments/international-payments).
        

    
### 19. What languages are supported on Razorpay checkout?

         Razorpay checkout fields support multiple languages, with English as the default. Customers can also choose Hindi, Marathi, Gujarati, Telugu, Tamil, Bengali and Kannada. Know more about [checkout in local languages](/payments/payment-gateway/features).
        

    
### 20. Can I switch between Standard Integration and Quick Integration?

         Yes, it is possible to easily switch from one integration method to another. If you were earlier using Standard Integration, you can switch to using [Quick Integration](/payments/payment-gateway/quick-integration).
