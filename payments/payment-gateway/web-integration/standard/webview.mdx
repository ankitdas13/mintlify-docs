...
description: "If you want to accept payments on your Android or iOS apps without integrating with our native SDKs, reuse your Standard Integration code. This opens the checkout form in a WebView on your mobile app. Pass the **callback_url** parameter along with other checkout options to process payments."
---
...
We strongly recommend migrating to our [SDK](/payments/payment-gateway/web-integration/standard) instead of using webviews to ensure full compatibility and a smoother experience.
...
- **Integration Steps**: Follow the [integrations steps](/payments/payment-gateway/web-integration/standard/webview/integration-steps) for a seamless setup.
...
- **Configure UPI Intent**: Follow additional steps to ensure UPI intent payments function correctly on [Android](/payments/payment-gateway/web-integration/standard/webview/upi-intent-android) or [iOS](/payments/payment-gateway/web-integration/standard/webview/upi-intent-ios).
