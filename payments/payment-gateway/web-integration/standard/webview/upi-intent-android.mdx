...
description: "Follow the steps given below to enable UPI intent in WebView on your android application:"
---
...
<Steps>
<Step title="Open your website integrated with standard checkout.">
Open your website integrated with standard checkout.
</Step>
<Step title="Pass `webview_intent: true` parameter in the [payload](/payments/pa...">
Pass `webview_intent: true` parameter in the [payload](/payments/payment-gateway/web-integration/standard/integration-steps#122-code-to-add-pay-button) sent to checkout to enable UPI intent support.
</Step>
<Step title="Ensure that UPI intent is triggered when the payment request is made.">
