...
description: "Follow these steps to integrate the standard checkout form on your website:"
---
...
Here are the links to our [SDKs](/api/authentication#client-libraries) for the supported platforms.
...
[Step 2: Test Integration](/payments/payment-gateway/web-integration/standard/chargeback/test-integration)
