...
<Step title="Step 2">
**Automatic offer application**: The best available offer is applied to the total. If they change the offer, the system recalculates and updates the total amount.
</Step>
<Step title="Step 3">
