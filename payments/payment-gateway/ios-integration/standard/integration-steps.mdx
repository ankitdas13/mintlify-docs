...
description: "Follow these steps to integrate your iOS application:"
---
...
### 1.2 Initialize Razorpay iOS Standard SDK
         ...
         - API keys. You can generate this from the [Dashboard](/payments/dashboard/account-settings/api-keys#generate-api-keys).
