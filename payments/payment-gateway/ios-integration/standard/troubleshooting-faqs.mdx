...
### 8. Does Razorpay support Xamarin for SDK integration?
         ...
         No, we do not support Xamarin. However, since Xamarin is essentially a wrapper around Android and iOS, you can create your own Xamarin wrapper using our [Android](/payments/payment-gateway/android-integration/standard) and [iOS](/payments/payment-gateway/ios-integration/standard) SDKs.   
...
### 16. Can I enable UPI Intent on my Android or iOS app?
         ...
         Yes, you can enable UPI Intent on your [Android](/payments/payment-gateway/web-integration/standard/webview/upi-intent-android) or [iOS](/payments/payment-gateway/web-integration/standard/webview/upi-intent-ios) app.
