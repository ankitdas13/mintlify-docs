...
description: "This section explains the additional configurations available for Razorpay iOS Custom SDK."
---

- [Change API Key](/payments/payment-gateway/ios-integration/custom/configurations#change-api-key)
- [Card Utilities](/payments/payment-gateway/ios-integration/custom/configurations#card-utilities)
- [Save Card Details](/payments/payment-gateway/ios-integration/custom/configurations#save-card-details)
- [Fetch Logo](/payments/payment-gateway/ios-integration/custom/configurations#fetch-logos)
...
<Steps>
<Step title="Step 1">
[Create a Customer](#step-1-create-a-customer)
</Step>
<Step title="Step 2">
[Create a Token for the Card](#step-2-create-a-token)
</Step>
<Step title="Step 3">
[Fetch Card Tokens](#step-3-fetch-card-tokens)
</Step>
<Step title="Step 4">
[Create a Payment using the Token](#step-4-create-a-payment-using-the-token)
</Step>
</Steps>

#### Step 1: Create a Customer 

Create a customer, whose card details should be saved, from the Dashboard or [Customers API](/api/customers).
