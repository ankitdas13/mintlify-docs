...
Follow these steps to integrate with [Turbo UPI Headless](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-noui#turbo-headless-integration-and-payment-flow).
...
Complete this [Go-live Checklist](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-noui#3-go-live-checklist) to take your integration live.
