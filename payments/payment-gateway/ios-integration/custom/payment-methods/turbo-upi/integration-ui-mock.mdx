...
### Prerequisites
         ...
         2. Integrate with the [Razorpay iOS Custom SDK](/payments/payment-gateway/ios-integration/custom/build-integration).
...
Follow these steps to integrate with [Turbo UPI with UI](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-ui#1-integration-steps).
...
### 2.3.6 Transactions
                        ...
                        Payments Successful
                         ...
                         1. Begin by following the [integration steps](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-ui#1-integration-steps), specifically the `submit` method.
...
Complete this [Go-live Checklist](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-ui#3-go-live-checklist) to take your integration live.
