...
description: "Follow the steps to integrate the Razorpay iOS Custom SDK:"
---
...
<Steps>
<Step title="Step 1">
Download the file and unzip the SDK attachment.
</Step>
<Step title="Step 2">
...
- API key. You can generate this from the [Dashboard](/payments/dashboard/account-settings#api-keys).
...
You can accept payments through UPI, credit/debit cards, netbanking and wallets, depending on the methods enabled for your account. When you use [Razorpay iOS Standard SDK](/payments/payment-gateway/ios-integration/standard), you do not have to handle the availability of different payment methods. However, when creating a custom checkout form, ensure the display of only the methods activated for your account to the customer.
...
[Step 2: Test Integration](/payments/payment-gateway/ios-integration/custom/test-integration)
