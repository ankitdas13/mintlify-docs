...
description: "The Razorpay iOS Custom SDK lets you integrate the supported payment methods on your iOS app's Checkout form."
---
...
Check the list of supported [debit card](/payments/payment-methods/emi/debit-card-emi#supported-banks-for-debit-card-emis) and [credit card](/payments/payment-methods/emi/credit-card-emi#supported-banks-for-credit-card-emis) EMI providers.
...
Check the [list of supported banks](/payments/payment-methods/netbanking).
...
1. [Turbo UPI Headless Integration](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-ui)
2. [Turbo UPI UI Integration](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi/integrate-noui)

Know more about the [Customer Onboarding](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi#customer-onboarding-flow) and [Integration Steps](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi#next-steps).
