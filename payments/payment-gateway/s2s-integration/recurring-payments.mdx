...
### Step 1: Create Authorisation Payment
      ...
      Set up the authorisation payment using:
       - [APIs for Cards](/payments/payment-gateway/s2s-integration/recurring-payments/cards/authorization-transaction)
       - APIs for UPI Autopay: [Collect](/payments/payment-gateway/s2s-integration/recurring-payments/upi/authorization-transaction) and [Intent](/payments/payment-gateway/s2s-integration/recurring-payments/upi-intent/authorization-transaction)
       - APIs for UPI OTM: [Collect](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/authorization-transaction) and [Intent](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/intent/authorization-transaction)
       - [APIs for UPI TPV](/payments/payment-gateway/s2s-integration/recurring-payments/upi-tpv/authorization-transaction)
       - [APIs for Emandate](/payments/payment-gateway/s2s-integration/recurring-payments/emandate/authorization-transaction)
       - [APIs for Paper NACH](/payments/payment-gateway/s2s-integration/recurring-payments/paper-nach/authorization-transaction)
...
### Step 2: Fetch Token Details
      ...
      Fetch the customer's token detail to proceed with the authorisation payment using:
       - [APIs for Cards](/payments/payment-gateway/s2s-integration/recurring-payments/cards/tokens)
       - APIs for UPI Autopay: [Collect](/payments/payment-gateway/s2s-integration/recurring-payments/upi/tokens) and [Intent](/payments/payment-gateway/s2s-integration/recurring-payments/upi-intent/tokens)
       - APIs for UPI OTM: [Collect](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/tokens) and [Intent](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/intent/tokens)
       - [APIs for UPI TPV](/payments/payment-gateway/s2s-integration/recurring-payments/upi-tpv/tokens)
       - [APIs for Emandate](/payments/payment-gateway/s2s-integration/recurring-payments/emandate/tokens)
       - [APIs for Paper NACH](/payments/payment-gateway/s2s-integration/recurring-payments/paper-nach/tokens)
...
### Step 3: Charge Subsequent Payments
      ...
      Use the token to charge customers as needed using:
       - [APIs for Cards](/payments/payment-gateway/s2s-integration/recurring-payments/cards/subsequent-payments)
       - APIs for UPI Autopay: [Collect](/payments/payment-gateway/s2s-integration/recurring-payments/upi/subsequent-payments) and [Intent](/payments/payment-gateway/s2s-integration/recurring-payments/upi-intent/subsequent-payments)
       - APIs for UPI OTM: [Collect](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/one-time-payment) and [Intent](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/intent/one-time-payment)
       - [APIs for UPI TPV](/payments/payment-gateway/s2s-integration/recurring-payments/upi-tpv/subsequent-payments)
       - [APIs for Emandate](/payments/payment-gateway/s2s-integration/recurring-payments/emandate/subsequent-payments)
       - [APIs for Paper NACH](/payments/payment-gateway/s2s-integration/recurring-payments/paper-nach/subsequent-payments)
