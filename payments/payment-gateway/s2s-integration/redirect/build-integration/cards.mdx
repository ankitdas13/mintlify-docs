...
description: "You can integrate with Razorpay APIs to start accepting payments made using cards. Razorpay APIs support the latest 3DS2 authentication protocol."
---
...
[migrate to the 3DS2 flow](/payments/payment-gateway/s2s-integration/redirect/build-integration/cards/migrate-3ds2.0).
...
<Steps>
<Step title="`razorpay_payment_id`">
`razorpay_payment_id`
</Step>
<Step title="`razorpay_order_id`">
`razorpay_order_id`
</Step>
<Step title="`razorpay_signature`">
`razorpay_signature`
</Step>
</Steps>
...
[Step 2: Test Integration](/payments/payment-gateway/s2s-integration/redirect/test-integration)
