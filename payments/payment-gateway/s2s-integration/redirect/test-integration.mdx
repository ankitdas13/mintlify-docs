...
description: "You can make test payments using one of the payment methods configured at the Checkout."
---
...
[Step 3: Go-Live Checklist](/payments/payment-gateway/s2s-integration/json/v2/go-live-checklist)

## Next Steps

[Step 3: Go-live Checklist](/payments/payment-gateway/s2s-integration/redirect/go-live-checklist)
