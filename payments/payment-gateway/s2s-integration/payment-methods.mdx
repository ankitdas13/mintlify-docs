...
description: "You can accept payments through several payment methods such as netbanking, debit cards, credit cards, wallets and UPI. However, you can configure payment methods of your choice for collecting payments from your customers."
---

Check the [payment methods](/payments/payment-gateway/s2s-integration/payment-methods/methods-api) activated for your account.
...
Fetch the supported bank codes using the [Methods API](/payments/payment-gateway/s2s-integration/payment-methods/methods-api).
...
- Fetch the available EMI plans (for each supported bank) by invoking the [Methods API](/payments/payment-gateway/s2s-integration/payment-methods/methods-api). Extract the EMI plans from the response to be shown to your customers while making the payment.
- Know more about EMI plans offered by [OneCard](/payments/payment-gateway/s2s-integration/payment-methods/emi/one-card) and [HSBC](/payments/payment-gateway/s2s-integration/payment-methods/emi/hsbc).
...
---
[PhonePe Switch](/payments/payment-gateway/web-integration/custom/phonepe-switch) | **For businesses registered with PhonePe Switch only** | `phonepeswitch`
---
[PayPal](/payments/payment-methods/wallets/paypal) | **International Payments Only**.
Requires [approval](https://razorpay.com/support) | `paypal`
---
[Amazon Pay](/payments/payment-methods/wallets/amazon-pay)| Requires [approval](https://razorpay.com/support) | `amazonpay`
...
---
[PhonePe Switch](/payments/payment-gateway/web-integration/custom/phonepe-switch) | `phonepeswitch` | **For businesses registered with PhonePe Switch only**
---
[PayPal](/payments/payment-methods/wallets/paypal) | `paypal` | **International Payments Only**
Requires approval (Reach out to support team)
---
[Amazon Pay](/payments/payment-methods/wallets/amazon-pay) | `amazonpay` | Requires approval (Reach out to support team)

<Info>

**Handy Tips**

[Integrate your PayPal account](/payments/payment-gateway/s2s-integration/payment-methods/paypal#integration-steps) with Razorpay Checkout to accept payments in international currencies.
...
Know about [UPI Intent](/payments/payment-gateway/s2s-integration/payment-methods/upi/intent) and [UPI Collect](/payments/payment-gateway/s2s-integration/payment-methods/upi).
...
`currency` _mandatory_
: `string` The currency in which the transaction should be made. See the [list of supported currencies](/payments/international-payments#supported-currencies). Default is `INR`.
...
You can accept recurring payments from your customers using `emandate`, `card` or `upi` as the method. Know more about [Recurring Payments](/payments/recurring-payments).
...
<Steps>
<Step title="Step 1">
[Create a customer.](/api/customers#create-a-customer)
</Step>
<Step title="Step 2">
...
Know more about steps 2,3,4 and 5 in [Recurring Payments](/api/payments/recurring-payments).
...
Know about [errors under Recurring Payments FAQs](/payments/recurring-payments/paper-nach/faqs#14-what-are-the-errors-i-get-while).
</Info>
