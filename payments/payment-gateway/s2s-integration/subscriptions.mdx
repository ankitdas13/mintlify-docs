...
description: "You can create, fetch, query or cancel plans, subscriptions and addons using the Subscriptions API. These operations can also be performed on the [Dashboard](/payments/subscriptions)."
---
...
: `object` Details of the plan.
    ...
    : `string` Currency for the payment. For example, `INR`. You can accept payment in any of the [supported currencies](/payments/international-payments#supported-currencies).
...
: `array` Details of the plan.
    ...
    `currency`
    : `string` Currency for the payment. You can accept payment in any of the  [supported currencies](/payments/international-payments#supported-currencies).
...
`status`
: `string` Status of the subscription. Refer to the [life cycle section](/payments/subscriptions/states) for more details. Possible values:
    - `created`
    - `authenticated`
    - `active`
    - `pending`
...
: `array` List of invoices generated for the Subscription.
  ...
  : `object` Details of the customer.
      ...
      `name`
      : `string` The customer's name. Know more [Customers API](/api/customers).
...
1. Create a signature in your server using the following attributes:
 ...
 The `key_secret` that was generated from the [Dashboard](/payments/payment-gateway/web-integration/standard#prerequisites).
...
- [Subscription product documentation](/payments/subscriptions)
