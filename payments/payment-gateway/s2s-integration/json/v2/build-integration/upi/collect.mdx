...
description: "In case of UPI collect flow there is no redirect involved when the customer completes the payment, you will have to poll the Razorpay APIs to get the latest status of the payment."
---
...
The payment request for each of the supported payment methods will slightly vary. Know more about the [relevant payment request fields](/payments/payment-gateway/s2s-integration/payment-methods).
