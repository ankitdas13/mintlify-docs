...
description: "S2S integration is an API-based white label integration provided by Razorpay wherein you can capture payment details on your page and pass it."
---
...
### Related Information
- [Server-to-Server Integration](/payments/payment-gateway/s2s-integration)
- [Webhooks](/webhooks)
