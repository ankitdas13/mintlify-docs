...
<Steps>
<Step title="[Create a Customer](#11-create-a-customer)">
[Create a Customer](#11-create-a-customer)
</Step>
<Step title="[Create an Order](#12-create-an-order)">
[Create an Order](#12-create-an-order)
</Step>
<Step title="[Create Authorisation Payment](#13-create-an-authorisation-payment)">
[Create Authorisation Payment](#13-create-an-authorisation-payment)
</Step>
</Steps>
...
You can also retrieve the `token_id` via the [payment.failed webhook](/api/payments/recurring-payments/webhooks#payment-failed).
...
Before initiating a debit, it is good practice to check the remaining funds available under the mandate to avoid payment failures. See [Track Mandate Funds](/payments/payment-gateway/s2s-integration/recurring-payments/upi-reserve-pay/manage#track-mandate-funds).
