...
### Response Parameters
     ...
     If the payment request is valid, the response contains the following fields. Refer to the [S2S Json V2 integration document](/payments/payment-gateway/s2s-integration/json/v2#step-2-create-a-payment) for more details.
...
After this step, you can proceed to integrate with the [Fetch Token API](/payments/payment-gateway/s2s-integration/recurring-payments/cards/tokens).
