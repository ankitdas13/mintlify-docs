...
For example, **Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.130 Safari/537.36**
 ...
 Refer to the [Notes](/api/understand#notes) section of the API Reference Guide.
      ...
      **Response Parameters**
      ...
      If the payment request is valid, the response contains the following fields. Refer to the [UPI Collect Flow document](/payments/payment-gateway/s2s-integration/payment-methods/upi/collect#step-4-initiate-a-payment) for more details.
