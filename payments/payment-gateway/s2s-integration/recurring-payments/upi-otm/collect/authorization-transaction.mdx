...
<Steps>
<Step title="[Create an authorisation transaction](#create-an-authorisation-tran...">
[Create an authorisation transaction](#create-an-authorisation-transaction)
</Step>
<Step title="[Fetch and manage tokens](/payments/payment-gateway/s2s-integration...">
[Fetch and manage tokens](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/tokens)
</Step>
<Step title="[Create a one time mandate](/payments/payment-gateway/s2s-integrati...">
[Create a one time mandate](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/one-time-payment)
</Step>
</Steps>
