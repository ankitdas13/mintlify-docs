...
You can start creating payment requests using the [sample payloads](/payments/payment-gateway/s2s-integration/payment-methods) for the payment methods of your choice.
