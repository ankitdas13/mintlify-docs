...
description: "3DS2 is an authentication protocol, the successor of 3DS1, that enables businesses and payment providers to send additional information (such as customer device or browser data) to verify the transaction's authenticity."
---
...
- [Integration Steps for New Razorpay Businesses (Integrating after October 15, 2022)](/payments/payment-gateway/s2s-integration/json/v2/build-integration/cards)
- [Migration Steps for Existing Razorpay Businesses (Integrated before October 15, 2022)](/payments/payment-gateway/s2s-integration/json/v2/build-integration/cards/migrate-3ds2.0)
