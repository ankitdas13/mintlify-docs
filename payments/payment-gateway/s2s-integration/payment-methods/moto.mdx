...
description: "With Razorpay, you can use MOTO (Mail-Order-Telephone-Order) transactions to charge a customer's credit card without using the CVV or 2-factor-authentication. You can extend this flow to your customers to reduce payment failures that may occur due to low internet speeds or redirects to bank pages."
---
...
You can create bulk payments from the [Dashboard](https://dashboard.razorpay.com). Know more about [batch payments](/payments/payment-methods/moto/batch).
