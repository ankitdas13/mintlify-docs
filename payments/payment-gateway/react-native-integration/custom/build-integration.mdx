...
description: "Follow the steps given below to use the SDK and integrate with Razorpay Payment Gateway:"
---
...
Check the [additional support for payment methods](/payments/payment-gateway/react-native-integration/custom/additional-features) available with the Razorpay React Native Custom SDK.
...
Know more about [passing callback URL](/payments/payment-gateway/callback-url).
...
[Step 2: Test Integration](/payments/payment-gateway/react-native-integration/custom/test-integration)
