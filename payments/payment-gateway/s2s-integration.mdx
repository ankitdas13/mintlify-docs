...
### S2S Redirect API
     ...
     This is our default [server-to-server integration](/payments/payment-gateway/s2s-integration/redirect). The payment creation request returns a variety of responses, which must be rendered on your customer's browser to proceed with the payment. These responses typically result in the browser being redirected to a bank or gateway page to complete payment authentication.
...
- [Integration Best Practices](/payments/payment-gateway/s2s-integration/best-practices)
