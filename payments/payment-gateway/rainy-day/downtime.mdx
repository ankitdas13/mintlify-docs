...
Know more about [the possible values](/payments/payment-methods/upi).

## Fetch Payment Downtime Details

To retrieve details of payment downtimes, see this [endpoint](/api/payments/downtime/fetch-all).

## Fetch Payment Downtime Details by ID

To retrieve details of payment downtimes by ID, see this [endpoint](/api/payments/downtime/fetch-with-id).
