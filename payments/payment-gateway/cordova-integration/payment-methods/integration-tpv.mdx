...
### Prerequisites
         ...
         1. Integrate with [Razorpay Cordova Standard SDK](/payments/payment-gateway/cordova-integration).
...
- `SERVER_ERROR`: Failure at PSP.
         ...
         [Refer to the list of possible error reasons](/payments/payment-gateway/cordova-integration/payment-methods/turbo-upi/error-codes).
