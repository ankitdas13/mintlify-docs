...
description: "You can use the Razorpay Flutter Custom SDK to integrate the supported payment methods on your Flutter app's Checkout form."
---
...
View the complete list of [UPI supported apps and their package names](/payments/payment-methods/upi/supported-apps).
...
Given below is the sample code for the payment method `paylater`. Know more about [paylater](/payments/payment-methods/pay-later/custom-integration).
...
Given below is the sample code for the payment method `cardless_emi`. Know more about [Cardless EMI](/payments/payment-methods/emi/cardless-emi/custom-integration).
