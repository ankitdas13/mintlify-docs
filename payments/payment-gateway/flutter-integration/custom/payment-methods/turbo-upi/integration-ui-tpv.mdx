...
description: "Third-party validation (TPV) of bank accounts is mandatory for businesses in the BFSI (Banking, Financial Services and Insurance) sector dealing with Securities, Brokering and Mutual Funds. You can accept customer payments by integrating with the Turbo UPI UI with TPV SDK. Know more about [How TPV works](/payments/third-party-validation#how-it-works)."
---
...
### Prerequisites
         ...
         2. Integrate with [Razorpay Flutter Custom Integration](/payments/payment-gateway/flutter-integration/custom/build-integration).
