...
description: "Follow these steps to integrate your Flutter application with the Razorpay Payment Gateway:"
---
...
Refer to the [post-integration steps](/payments/payment-gateway/flutter-integration/custom/test-integration).
...
[Step 2: Test Integration](/payments/payment-gateway/flutter-integration/custom/test-integration)
