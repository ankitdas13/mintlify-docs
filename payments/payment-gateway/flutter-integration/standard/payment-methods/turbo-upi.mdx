...
description: "- **Turbo UPI Flutter Standard SDK**: Discover new features, updates and deprecations related to Turbo UPI on Flutter Standard Checkout (since Jan 2024)."
---
...
You can easily integrate Turbo UPI with the Razorpay Flutter Standard SDK. Explore the full potential of [Razorpay Turbo UPI](/payments/payment-methods/upi/turbo-upi) and learn how it works.
...
### Prerequisites
                ...
                2. Review the [Razorpay Flutter Standard SDK](/payments/payment-gateway/flutter-integration/standard) documentation for integration guidelines.
