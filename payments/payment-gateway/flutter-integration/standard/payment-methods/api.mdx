...
description: "Documented below is the API package for the plugin."
---
...
The `options` map has `key` as a required property in the open checkout method. All other properties are optional. Know about all the [options available on checkout form](/payments/payment-gateway/flutter-integration/standard/integration-steps#17-add-checkout-options).
