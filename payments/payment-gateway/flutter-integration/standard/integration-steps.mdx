...
description: "Follow these steps to integrate your Flutter application:"
---
...
Refer to the [post-integration steps](/payments/payment-gateway/flutter-integration/standard/integration-steps#2-test-integration).
