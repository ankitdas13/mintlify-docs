...
description: "The Razorpay Android Custom SDK lets you integrate the supported payment methods on your Android app's Checkout form."
---
...
Check the [list of supported cards](/payments/payment-gateway/web-integration/standard/configure-payment-methods/supported-methods#supported-cards).

If you want to securely store customer's card details as network tokens, know about [Saved Cards feature](/payments/payment-gateway/web-integration/custom/features/saved-cards).
...
Check the list of supported [debit card](/payments/payment-methods/emi/debit-card-emi#supported-banks-for-debit-card-emis) and [credit card](/payments/payment-methods/emi/credit-card-emi#supported-payment-partners) EMI providers.
...
Check the [list of supported Cardless EMI providers](/payments/payment-methods/emi/cardless-emi#supported-payment-partners).
...
Check the [list of Pay Later providers](/payments/payment-methods/pay-later#providers).
...
Check the list [Wallets supported by Razorpay](/payments/payment-methods/wallets#supported-wallets).
...
Check the complete list of [UPI supported apps and their package names](/payments/payment-methods/upi/supported-apps).
...
1. [Turbo UPI Headless Integration](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-noui)
2. [Turbo UPI UI Integration](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui)

Know more about the [Customer Onboarding](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi).
...
<Steps>
<Step title="Step 1">
[Detect presence of CRED app on customer's Android device](#1-detect-presence-of-cred-app).
</Step>
<Step title="Step 2">
[Create a payment](#2-create-payment).
</Step>
<Step title="Step 3">
[Implement PaymentResultWithDataListener Method](#3-implement-paymentresultwithdatalistener-method).
</Step>
</Steps>
