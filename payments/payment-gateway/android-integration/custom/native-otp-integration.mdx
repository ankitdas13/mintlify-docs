...
description: "Razorpay Payment Gateway supports one-time passwords (OTPs) at the Checkout itself, preventing the customers from being redirected to the ACS page of their respective issuing banks."
---
...
1. Log in to the Dashboard and generate the [API Keys](/payments/dashboard/account-settings/api-keys).
2. Integrate with the [Razorpay Android Custom SDK](/payments/payment-gateway/android-integration/custom).
...
**1.3** [Call `razorpay.getCardOtpData(CardsFlowCallback)` Function.](/payments/payment-gateway/android-integration/custom/native-otp-integration#13-call-razorpaygetcardotpdata-cardsflowcallback-function) 
...
[Step 2: Test Integration](/payments/payment-gateway/android-integration/custom/test-native-otp-integration)
