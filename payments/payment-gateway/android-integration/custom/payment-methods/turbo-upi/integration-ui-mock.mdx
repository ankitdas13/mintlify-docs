...
Follow these steps to integrate with [Turbo UPI with UI](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui#1-integration-steps).
...
### 2.3.7 Transactions
                        ...
                        Payments Successful
                         ...
                         1. Begin by following the [integration steps](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui#1-integration-steps), specifically the `submit` method.
...
Complete this [Go-live Checklist](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-ui#3-go-live-checklist) to take your integration live.
