...
### Prerequisites
         ...
         1. Integrate with the [Razorpay Android Custom SDK](/payments/payment-gateway/android-integration/custom/build-integration).
...
- Use the `rzp_test_0wFRWIZnH65uny` API key id for testing on the UAT environment and the [Razorpay live keys](/api/authentication#live-mode-api-keys) on the prod testing.
