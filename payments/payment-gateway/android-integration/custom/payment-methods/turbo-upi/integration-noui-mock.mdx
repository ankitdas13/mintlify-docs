...
description: "Mock SDK is a tool designed to facilitate your integration with Turbo UPI. Unlike conventional integration methods that rely on the stability of partner banks and NPCI UAT environments, Mock SDK removes this dependency, streamlining the integration process."
---
...
Follow these steps to integrate with [Turbo UPI Headless](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-noui#1-integration-steps).
...
### 2.5.7 Transactions
                        ...
                        Payments Successful
                         ...
                         1. Begin by following the [integration steps](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-noui#1-integration-steps), specifically the `submit` method.
...
Complete this [Go-live Checklist](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi/integration-noui#3-go-live-checklist) to take your integration live.
