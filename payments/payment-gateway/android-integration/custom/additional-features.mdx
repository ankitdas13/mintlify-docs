...
description: "Use the Razorpay Android Custom SDK to integrate supported payment methods on the Checkout form of your Android app as per your business requirements. Here are some **additional methods** provided by the SDK for the integration and usage of payment methods:"
---

- [Card Utilities](/payments/payment-gateway/android-integration/custom/additional-features#card-utilities)
- [Validate VPA](/payments/payment-gateway/android-integration/custom/additional-features#validate-vpa)
- [Fetch Logo](/payments/payment-gateway/android-integration/custom/additional-features#logo)
- [Validate Data](/payments/payment-gateway/android-integration/custom/additional-features#data-validation)
- [Custom `WebViewClient` and `WebChromeClient`](/payments/payment-gateway/android-integration/custom/additional-features#custom-webviewclient-and-webchromeclient)
- [Save Customer Data](/payments/payment-gateway/android-integration/custom/additional-features#save-customer-data)
...
You can associate card details with a saved customer or create payments using tokens for saved cards. To use this functionality, you must use [customer APIs](/api/customers) at server side.
