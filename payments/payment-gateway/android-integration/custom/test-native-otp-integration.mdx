...
description: "Integrate the [Native OTP](/payments/payment-gateway/android-integration/custom/native-otp-integration) feature with Android custom checkout to avoid customer payment issues such as payment failures due to low internet speeds and bank page redirects."
---
...
Know more about how to [Verify Payment Status](/payments/payment-gateway/android-integration/custom/build-integration#19-verify-payment-status).
...
Know more about how to [Accept Live Payments](/payments/payment-gateway/android-integration/custom/go-live-checklist#accept-live-payments).
