---
title: "Prerequisites"
description: "You can use Razorpay Standard SDK to integrate the Razorpay Payment Gateway with your Android Application."
---
...
- If you are using SDK version below 1.6.15, you need to make [changes to your Android `Manifest.xml` file](/payments/payment-gateway/android-integration/standard/troubleshooting-faqs).

**SUCCESS**

**Update SDK**

Check your [current SDK version](/payments/payment-gateway/android-integration/standard/troubleshooting-faqs#5-how-can-i-check-the-razorpay-android). If it is outdated, please [update the SDK](/payments/payment-gateway/android-integration/standard/troubleshooting-faqs#6-how-can-i-update-the-razorpay-android) manually to ensure uninterrupted settlements of your funds. 
