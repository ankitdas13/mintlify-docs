...
description: "- **Turbo UPI Android Standard SDK**: Discover new features, updates and deprecations related to Turbo UPI on Android Standard Checkout (since Jan 2024)."
---
...
You can seamlessly integrate Turbo UPI with Razorpay Android Standard SDK. Explore the full potential of [Razorpay Turbo UPI](/payments/payment-methods/upi/turbo-upi) and know How it Works.
...
### Prerequisites
         ...
         1. **SDK Version Compatibility:**
             - Integrate with [Razorpay Android Standard SDK](/payments/payment-gateway/android-integration/standard). Ensure that you integrate with SDK version 1.6.37 or higher.
         ...
         5. **Contact Prefill in Standard Checkout:**
             ...
             - Make sure your Checkout options include [**prefill contact**](/payments/payment-gateway/android-integration/standard/integration-steps#14-initiate-payment-and-display-checkout-form).
        

## Onboarding Flow

Ensure your customers [onboard with Razorpay Turbo UPI](/payments/payment-methods/upi/turbo-upi#onboarding-flow) to get started.
...
Razorpay SDK will handle all the changes related to `UpiTurbo` internally. To integrate with the payment flow, [initiate payment and display the checkout form](/payments/payment-gateway/android-integration/standard/integration-steps#14-initiate-payment-and-display-checkout-form).
