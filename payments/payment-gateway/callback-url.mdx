---
title: "Callback URL"
description: "If you reuse your web integration of Razorpay Checkout inside a web view on Android or iOS, the checkout form may not open. Issues like this are handled in our [Android SDK](/payments/payment-gateway/android-integration/"
---

If you reuse your web integration of Razorpay Checkout inside a web view on Android or iOS, the checkout form may not open. Issues like this are handled in our [Android SDK](/payments/payment-gateway/android-integration/standard) and [iOS SDK](/payments/payment-gateway/ios-integration/standard), with the SDKs being the preferred method of integration.

However, if you want to reuse the web integration for some reason, you can pass the following `callback_url` along with other [checkout options](/payments/payment-gateway/web-integration/standard/integration-steps#123-checkout-options) to process the desired payment:
