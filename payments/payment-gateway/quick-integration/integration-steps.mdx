...
Know more about the complete [list of available Checkout options](/payments/payment-gateway/web-integration/standard/integration-steps#123-checkout-options).
