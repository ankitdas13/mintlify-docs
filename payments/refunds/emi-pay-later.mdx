...
description: "You can refund payments to customers who have used EMI methods, such as Debit Card EMI, Credit Card EMI, Cardless EMI and so on, offered by different banks that have partnered with Razorpay."
---

You can also process refunds to your customers who have made payments using the [Pay Later](/payments/payment-methods/pay-later) option. Know more about the various [third-party providers offering Pay Later](/payments/payment-methods/pay-later).
...
- The interest paid for EMI payments cannot be refunded and is directly managed by the issuing bank.
       ...
       **Examples -  How refund is processed for Debit Cards EMIs**
        ...
        Know more about [Debit Card EMI](/payments/payment-methods/emi/debit-card-emi).
...
- To cancel a Credit Card EMI, your customer should contact the credit card issuing bank.
        ...
        To cancel a Credit Card EMI, your customer must reach out to the bank. Know more about [Credit Card EMI](/payments/payment-methods/emi).
...
- The processing charges levied by the bank for using the No Cost EMI option cannot be refunded to the customer.
        ...
        Know more about [No Cost EMIs](/payments/payment-methods/emi/no-cost-emi).
...
Razorpay does not do calculations for Cardless EMI.
        ...
        Know more about [Cardless EMI](/payments/payment-methods/emi/cardless-emi).
...
<Step title="Step 3">
Razorpay passes the refund request details to the respective [Pay Later providers](/payments/payment-methods/pay-later#supported-pay-later-providers), where the refund takes place before the Payback Period:
...
Know more about [Pay Later](/payments/payment-methods/pay-later).
