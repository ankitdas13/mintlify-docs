...
description: "You can add or change fields on the Batch Payments Page to show important information for your business. Then, upload a file with the data. Your customers will see the data specific to them and can make a payment based on it."
---
...
<Steps>
<Step title="Step 1">
**Payment Pages Creation and Customer Data Upload**: Businesses can create individualised Payment Pages with an option to upload a file containing specific customer data for their customer base. You can use this data to personalise the payment page for each customer.
</Step>
<Step title="Step 2">
**Automated Notifications**: After the business uploads the data, an automated system will send the Payment Page URLs to the customers via their registered email and mobile number. You can simply embed the page URL on your website if you do not wish to send notifications.
</Step>
<Step title="Step 3">
...
<Step title="Step 4">
**Customer-specific Details Access**: After successful validation, customers can view the specific details on their personalised Payment Page as per what was uploaded by you during the batch upload.
</Step>
</Steps>
...
<Step title="Step 2">
Select **Batch Payment Pages** and click **+ Create Payment Pages**.
</Step>
<Step title="Step 3">
Add Business Details to your Payment Page. Know more about how to add [Business Details](/payments/payment-pages/create#add-business-details) to your Payment Page.
</Step>
<Step title="Step 4">
Add payment details to your Payment Page:
...
<Step title="Step 5">
Click **Save and Proceed to next Step**. You can download the sample file from here or do it later from the Dashboard.

</Step>
<Step title="Step 6">
Click **Create and Publish Page** to create the Payment Page.
</Step>
</Steps>
