...
<Steps>
<Step title="Step 1">
Log in to the Dashboard and create a Payment Page titled **Registration**.
</Step>
<Step title="Step 2">
...
<Steps>
<Step title="Step 1">
On the Dashboard, create a Payment Page titled **Limited Edition iPhone 11 Phone Case**.
</Step>
<Step title="Step 2">
Fill in the details of the product.
</Step>
<Step title="Step 3">
In the Payment Details Section, create a price field called `Marble Pink Case` using `Item with Quantity` as the amount field type.



</Step>
<Step title="Step 4">
Create any additional fields required such as Name, Address and so on.
</Step>
<Step title="Step 5">
**Save and Publish** the Payment Page.
</Step>
...
<Steps>
<Step title="Step 1">
On the Dashboard, create a Payment Page titled **Creative Writing Course Registration**.
</Step>
<Step title="Step 2">
Fill in the details of the product.
</Step>
<Step title="Step 3">
In the Payment Details Section, create a price field called `Creative Writing Course Registration` using `Fixed Amount` as the amount field type.
...
<Steps>
<Step title="Step 1">
On the Dashboard, create a Payment Page titled **Registration**.
</Step>
<Step title="Step 2">
Fill in the details of the event such as description, venue, time and more.
</Step>
<Step title="Step 3">
In the Payment Details Section, create a price field. - `Customer Decides Amount`.
...
- [Add Images, Videos and More](/payments/payment-pages/add-images-videos)
