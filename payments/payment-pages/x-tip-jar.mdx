...
description: "Use X's Tip Jar (available to select users) to receive money from other X users using third-party service providers. X users in India can use Razorpay to accept payments via the Tip Jar feature."
---
...
- [Set up](/payments/set-up) your Razorpay account and complete the KYC process.
- Create a [Payment Page](/payments/payment-pages/create) and copy the page URL. If you already have a Payment Page, follow the steps given below.
...
<Step title="Step 2">
Open X profile and tap on **Edit Profile**.
</Step>
<Step title="Step 3">
Set the **Tip Jar** feature to **On**.
</Step>
<Step title="Step 4">
Enable **Allow tips** and tap **Razorpay**.
</Step>
<Step title="Step 5">
Paste the Payment Page URL suffix copied from the Dashboard. For example, `livingarts2021`.
</Step>
<Step title="Step 6">
Save the changes.
</Step>
...
<Step title="Step 2">
Open the profile of the user to whom they want to send money.
</Step>
<Step title="Step 3">
Tap the tips icon and select the payment service provider.
</Step>
<Step title="Step 4">
Select **Razorpay** and tap **Continue**.
</Step>
<Step title="Step 5">
The Payment Page opens. Enter the details, select a payment method and complete the payment.
</Step>
</Steps>
...
<Step title="Step 3">
Scroll down to the transaction details section. A list of the payments made to the Payment Page is displayed.
</Step>
<Step title="Step 4">
Click on the payment_id for more details.
</Step>
</Steps>
