...
description: "We support all the apps and banks mentioned in the [NPCI list](https://www.npci.org.in/what-we-do/autopay/list-of-banks-and-apps-live-on-autopay)."
---
...
Refer to the [list of supported MCCs, issuing banks and PSP applications](/payments/subscriptions/supported-banks-apps#supported-mccs).
...
- [Recurring Payments APIs for UPI](/payments/recurring-payments/upi/apis)
