...
description: "The maximum transaction amount allowed is ₹15,000 when using UPI as a recurring payment method. Any auto debit above ₹15,000 undergoes an additional authorisation from the customer."
---
...
### 18. Is QR Code supported for UPI Autopay?
     ...
     Yes, [QR Code](/payments/recurring-payments/upi/qr-codes) is supported on Standard Checkout to collect Recurring Paymennts. The customers can scan the QR using any PSP app and make the payment.
