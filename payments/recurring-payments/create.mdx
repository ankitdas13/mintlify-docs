...
<Steps>
<Step title="Step 1">
[Create a registration link](#1-create-a-registration-link)
</Step>
<Step title="Step 2">
[View the payment status](#2-view-the-payment-status)
</Step>
<Step title="Step 3">
[Search for the token](#3-search-for-the-token)
</Step>
<Step title="Step 4">
[Charge the token](#4-charge-the-token)
</Step>
</Steps>
...
You can create registration links using APIs. Refer to the [API section](/api/payments/recurring-payments) for more details.
