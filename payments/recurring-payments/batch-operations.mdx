...
description: "You can [create registration links](#create-registration-links) and [charge tokens](#charge-tokens) in bulk using the batch feature available from the Dashboard. You can check the status of the bulk action in the respective batch reports."
---
...
To charge tokens using the batch upload feature, you will first need the list of [Tokens](/payments/recurring-payments/create#3-search-for-the-token) for which recurring payments are to be created.
...
1. Add the required data. Know more about the Batch Fields from the [below table](/payments/recurring-payments/batch-operations#charge-token-batch-fields).
1. Upload the file to the Dashboard.
...
### Related Information
- [Create Recurring Payments](/payments/recurring-payments/create)
- [Paper NACH Form](/payments/recurring-payments/upload-paper-nach-form)
