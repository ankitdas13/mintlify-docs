...
description: "Refer to the [list of banks that support cards](/payments/recurring-payments/cards/supported-banks)."
---
...
### 4. Can we continue to process recurring payments through card tokens of banks that are not yet available for Recurring Payments on Cards?
       ...
       All the card tokens of the banks that are not yet available for Recurring Payments on cards are put in a `paused` state. You cannot debit these mandates. Please contact your customers and register new mandates using other methods such as UPI or Emandate. Know more about other [Recurring Payments methods](/payments/recurring-payments). Alternatively, use [Payment Links](/payments/payment-links) from the Dashboard or Razorpay [Mobile App](/payments/mobile-app) and collect payment from customers on the due date.
...
Businesses should initiate the debit. The banks and Razorpay take action on the rest of the process.
       ...
       To process subsequent debits above ₹15,000 (upto ₹1,00,000 for [certain merchant categories](/payments/recurring-payments/cards/faqs#8-is-there-a-maximum-monetary-limit-for)):
...
### 13. What is the TAT for processing debits of cards mandates?
       ...
       - For processing debits **above ₹15,000** (upto ₹1,00,000 for [certain merchant categories](/payments/recurring-payments/cards/faqs#8-is-there-a-maximum-monetary-limit-for)), the amount will be debited as soon as the customer provides consent through AFA, which has a validity of 72 hours.
...
### 15. Can I cancel a card mandate?
       ...
       - [From the Dashboard](/payments/recurring-payments/create#delete-the-token)
       - [Using APIs](/api/payments/recurring-payments/cards/tokens#23-delete-tokens)
