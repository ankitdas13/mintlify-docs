...
description: "Razorpay UPI Autopay enables businesses to offer a frictionless recurring payment experience to their customers using UPI mandates. With one-time authentication via UPI apps like Google Pay, PhonePe or Paytm, customers can authorise recurring payments without having to manually approve every transaction."
---
...
### Phase 1: Mandate Registration
         ...
         [Mandate Registration →](/payments/recurring-payments/upi/integrate#1-mandate-registration)
...
### Phase 2: Fetch Token
         ...
         [Token Fetch →](/payments/recurring-payments/upi/integrate#2-fetch-mandate-registration-details)
...
### Phase 3: Subsequent Debits
     ...
     [Charge Subsequent Payments →](/payments/recurring-payments/upi/integrate#3-charge-customers)
...
Given below are the steps to proceed with UPI Autopay.
        ...
        If you are new to Razorpay, [set up your account](/payments/set-up) to start accepting payments using UPI Autopay.
...
**Recommendations:**
- Use **Subscriptions** for predictable, fixed-amount recurring billing. Know more about [Razorpay Subscriptions](/payments/subscriptions).
...
### Switch from Razorpay Subscriptions to Razorpay Recurring Payments
         ...
         [Subscriptions](/payments/subscriptions) allow you to automatically charge your customers at regular intervals. The system handles the scheduling and execution of payments based on predefined plans, reducing manual intervention and ensuring consistent revenue collection.
...
### UPI Autopay
         ...
         **Available Integrations** 
         ...
         ---
         Standard Checkout | [Link to Guide](/api/payments/recurring-payments/upi/create-authorization-transaction)
         ---
         Custom Checkout | [Link to Guide](/api/payments/recurring-payments/custom/upi/create-authorization-transaction)
         ---
         S2S APIs | - [Link to S2S Collect Guide](/payments/payment-gateway/s2s-integration/recurring-payments/upi/authorization-transaction)
- [Link to S2S Intent Guide](/payments/payment-gateway/s2s-integration/recurring-payments/upi-intent/authorization-transaction)
...
### UPI TPV (Third Party Validation)
         ...
         Integrations | Docs Link
         ---
         Standard Checkout | [Link to Guide](/api/payments/recurring-payments/upi-tpv/create-authorization-transaction)
         ---
         Custom Checkout | [Link to Guide](/api/payments/recurring-payments/custom/upi-tpv/create-authorization-transaction)
         ---
         S2S APIs | [Link to Guide](/payments/payment-gateway/s2s-integration/recurring-payments/upi-tpv/authorization-transaction)
...
### UPI OTM (One Time Mandate)
         ...
         **Example** 
         ...
         Integrations | Docs Link
         ---
         Standard Checkout | [Link to Guide](/api/payments/recurring-payments/upi-otm/authorization-transaction)
         ---
         Custom Checkout | Not Applicable
         ---
         S2S APIs | - [Link to S2S Collect Guide](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/collect/authorization-transaction)
- [Link to S2S Intent Guide](/payments/payment-gateway/s2s-integration/recurring-payments/upi-otm/intent/authorization-transaction)
