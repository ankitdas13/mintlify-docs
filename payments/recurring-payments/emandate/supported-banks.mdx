...
description: "Use the **Methods API** endpoint to fetch the list of banks that support Emandate payments using Netbanking, Aadhaar and Debit card authorisation types. Know more about [authentication types](/payments/recurring-payments"
---

Use the **Methods API** endpoint to fetch the list of banks that support Emandate payments using Netbanking, Aadhaar and Debit card authorisation types. Know more about [authentication types](/payments/recurring-payments/emandate/integrate#12-complete-authentication).
