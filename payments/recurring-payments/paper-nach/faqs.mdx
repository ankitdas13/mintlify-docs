...
description: "You can generate and submit physical mandates from the [Dashboard](/payments/recurring-payments/create) or [using our APIs](/api/payments/recurring-payments)."
---
...
### 1. How can I create physical mandates?
         ...
         You can generate and submit physical mandates from the [Dashboard](/payments/recurring-payments/create) or [using our APIs](/api/payments/recurring-payments).
...
### 12. Can I cancel a physical Mandate?
         ...
         Yes. You can use the cancel a physical mandate by deleting the token from the [Dashboard](/payments/recurring-payments/create#delete-the-token) or [using APIs](/api/payments/recurring-payments/paper-nach/tokens#24-delete-tokens).
