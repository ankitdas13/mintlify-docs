...
description: "Recurring Payment integration involves the following steps:"
---

<Steps>
<Step title="Step 1">
[NACH Mandate Registration](#nach-mandate-registration)
</Step>
<Step title="Step 2">
[Fetch NACH Mandate Registration Details](#fetch-nach-mandate-registration-details)
</Step>
<Step title="Step 3">
[Charge Customers](#charge-customers)
</Step>
</Steps>
...
- Check if the NACH is enabled using the [Fetch Methods](/payments/recurring-payments/emandate/supported-banks#fetch-supported-methods) API.
...
<Step title="Step 2">
Create an order by passing the `customer_id` and method `nach`. When you do this, Razorpay generates a NACH form with the customer information pre-filled and ready to sign.
</Step>
<Step title="Step 3">
...
1. [**Create a customer**](/api/payments/recurring-payments/paper-nach/create-authorization-transaction#111-create-a-customer) 
This returns a `customer_id`.
1. [**Create an order**](/api/payments/recurring-payments/paper-nach/create-authorization-transaction#112-create-an-order) 
This returns an `order_id`.
1. [**Create authorisation transaction**](/api/payments/recurring-payments/paper-nach/create-authorization-transaction#113-create-an-authorization-payment) 
...
- [APIs](/api/payments/recurring-payments/paper-nach/create-authorization-transaction#121-create-a-registration-link)
...
- [APIs](/api/payments/recurring-payments/paper-nach/tokens)
...
Know more about the turnaround time (TAT) for NACH from the [FAQs](/payments/recurring-payments/paper-nach/faqs#7-for-physical-mandates-how-long-does-it).
...
- [Dashboard](/payments/recurring-payments/paper-nach/integrate#using-the-dashboard)
- [APIs](/payments/recurring-payments/paper-nach/integrate#using-apis)
...
1. [**Create a new Order**](/api/payments/recurring-payments/paper-nach/create-subsequent-payments#31-create-an-order-to-charge-the-customer). 
...
2. [**Create a Payment**](/api/payments/recurring-payments/paper-nach/create-subsequent-payments#32-create-a-recurring-payment). 
...
### Related Information
- [Paper NACH APIs](/payments/recurring-payments/paper-nach/apis)
