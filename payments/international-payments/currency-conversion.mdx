...
description: "Razorpay Settlements occur in INR based on the conversion rate at the time of payment."
---
...
### Sample Code
        ...
        : `string` Currency in which you want to accept the payment. For example, `GBP`. Check the [supported international currencies.](/payments/international-payments#supported-products-and-currencies)
...
### Payment Entity
         ...
         The [Payment entity](/api/payments#payment-entity) will contain additional fields when the currency is not INR to provide visibility into the conversion rate.
