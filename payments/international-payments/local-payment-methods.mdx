...
description: "Razorpay supports the following local payment methods instruments to accept payments across different geographies and varied currencies."
---
...
<Step title="Step 3">
Click **Activate** beside **Local payment methods**. 
