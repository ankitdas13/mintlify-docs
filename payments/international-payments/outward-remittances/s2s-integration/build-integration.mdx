...
`currency` _mandatory_
: `string` Currency code for the currency in which you want to accept the payment. For example, `INR`. Refer to the [list of supported currencies](/payments/international-payments/outward-remittances/s2s-integration/supported-currencies). Length must be of 3 characters.
...
Refer to the [Payment Methods](/payments/payment-gateway/s2s-integration/payment-methods) section for other payment options request parameters.
...
[Step 2: Test Integration](/payments/international-payments/outward-remittances/s2s-integration/test-integration)
