...
description: "You can enable your customers to make payments to foreign universities towards fees payments such as admission, application, hostel, tuition, and travel (flight and hotel bookings) with our Outward Remittance solution."
---
...
Integrate with [Razorpay Standard Checkout](/payments/third-party-validation#integration-flow). No additional integration is required for Outward Remittances.
