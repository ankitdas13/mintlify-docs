...
description: "Consider these steps before taking the integration live."
---
...
Authorized payments can be automatically captured. You can auto-capture all payments [using global settings](/payments/payments/capture-settings#auto-capture-all-payments) on the Dashboard.
