...
Test your integration using these [test cards](/payments/payment-gateway/web-integration/standard/integration-steps#2-test-integration).
...
<Steps>
<Step title="Invoice collection is mandatory for any import payment to be eligib...">
Invoice collection is mandatory for any import payment to be eligible for settlement.
</Step>
<Step title="Turnaround Time (TAT) for settlement begins **only after a valid in...">
Turnaround Time (TAT) for settlement begins **only after a valid invoice** is uploaded.
</Step>
<Step title="Ensure each invoice contains the following details:">
...
[Step 2: Test Integration](/payments/international-payments/accept-international-payments-from-indian-customers/import-flow/standard-integration/test-integration)
