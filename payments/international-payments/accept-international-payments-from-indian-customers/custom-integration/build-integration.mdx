...
description: "Given below are the steps to integrate Razorpay Custom Checkout in your site:"
---
...
You can try out our APIs on the Razorpay Postman Public Workspace. Fork the workspace and test the APIs with your [Test API Keys](/api/authentication#generate-api-keys).
...
Know more about [sample codes for various payment methods](/payments/payment-gateway/web-integration/custom/payment-methods) and [supported payment methods](#supported-payment-methods).
...
```
    ...
    Following payment methods are supported under the Import Flow:
      ...
      - UPI
      - Cards
      - [Recurring](/payments/international-payments/accept-international-payments-from-indian-customers/custom-integration/recurring-payments) 
...
[Step 2: Test Integration](/payments/international-payments/accept-international-payments-from-indian-customers/custom-integration/test-integration)
