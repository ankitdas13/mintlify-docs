...
description: "Given below are the steps to create an authorisation transaction using the Razorpay APIs."
---
...
: `object` Details related to the authorisation such as max amount, frequency and expiry information.
  ...
  : `integer` The maximum amount that can be debited in a single charge.
    ...
    ---
    6211 | Financial Services | `100` (â‚¹1) | `20000000` (â‚¹2,00,000)
    ---
    6300 | Financial Services | `100` (â‚¹1) | `20000000` (â‚¹2,00,000)
    ---
    7322 | Financial Services | `100` (â‚¹1) | `20000000` (â‚¹2,00,000)
    ---
    6529 | Financial Services | `100` (â‚¹1) | `20000000` (â‚¹2,00,000)
    ---
    5960 | Services | `100` (â‚¹1) | `20000000` (â‚¹2,00,000)
    

  For other categories and MCCs, the minimum value is `100` (â‚¹1) and maximum value is 9999900 (â‚¹99,999).
...
`notes`_optional_
: `object` Key-value pair you can use to store additional information about the entity. Maximum 15 key-value pairs, 256 characters each. For example, `"note_key": "Beam me up Scottyâ€`.
...
```html: Custom checkout with handler functions
  ...
  const btn = document.querySelector("#btn");
          ...
          var data = {
      "amount": 300, // in currency subunits. Here 1000 = 1000 paise, which equals to â‚¹10
