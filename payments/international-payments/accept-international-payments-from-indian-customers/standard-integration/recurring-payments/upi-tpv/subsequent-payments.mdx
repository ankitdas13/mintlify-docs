...
description: "You should perform the following steps to create and charge your customer subsequent payments:"
---
...
`amount` _mandatory_
: `integer` The amount associated with the payment in smallest unit of the supported currency. For example, `2000` means â‚¹20. Must match the amount in [Create an order to charge the customer](#21-create-an-order-to-charge-the-customer).
...
Check your integration/payment request or reach out to Razorpay. Refer to the [API Reference Guide](/api).
---
