...
description: "You can integrate Low Cost EMI offers with your payment flows while integrating directly with our APIs."
---
...
<Step title="[Create a Payment](#step-3-create-a-payment)">
[Create a Payment](#step-3-create-a-payment)
</Step>
<Step title="[Show the Offer on Checkout](#step-4-show-the-offer-on-checkout)">
[Show the Offer on Checkout](#step-4-show-the-offer-on-checkout)
</Step>
<Step title="[Verify the Payment](#step-5-verify-the-payment)">
[Verify the Payment](#step-5-verify-the-payment)
</Step>
</Steps>

## Step 1: Create a Low Cost EMI Offer

[Create a Low Cost EMI offer](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create) from the Dashboard.
