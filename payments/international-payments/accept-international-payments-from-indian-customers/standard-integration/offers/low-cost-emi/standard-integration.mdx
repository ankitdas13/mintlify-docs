...
description: "After creating [Low Cost EMI Offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create) from the Dashboard, you have to integrate them with Razorpay Standard Checkout so that your customers can avail them while making payments."
---
...
---
**Amount Match** | Order amount should be more than or equal to the [Minimum Order Amount](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create) set in an offer.
--- 
...
This is the easiest way to display Low Cost EMI offers at the Checkout. While [creating the Low Cost EMI offer](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create) from the Dashboard, enable the **Show Offer on Checkout** option.
...
To display offers:
<Steps>
<Step title="[Create an Offer](#step-1-create-an-offer-from-the-dashboard).">
[Create an Offer](#step-1-create-an-offer-from-the-dashboard).
</Step>
<Step title="[Pass offer_id in Orders API](#step-2-pass-offer-id-in-orders-api).">
[Pass offer_id in Orders API](#step-2-pass-offer-id-in-orders-api).
</Step>
<Step title="[Pass order_id and Trigger Checkout](#step-3-pass-order-id-and-trig...">
[Pass order_id and Trigger Checkout](#step-3-pass-order-id-and-trigger-the).
</Step>
</Steps>

### Step 1: Create an Offer from the Dashboard

You can [create Low Cost EMI offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create#create-offers) from the Dashboard.
...
Know more about [Standard Checkout](/payments/payment-gateway/web-integration/standard).
...
- By polling our [payment APIs](/api/payments).
...
- [Disable Offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/low-cost-emi/create#disabling-low-cost-emi-offers)
