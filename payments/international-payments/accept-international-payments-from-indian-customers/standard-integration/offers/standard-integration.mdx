...
description: "After creating [offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create) from the Dashboard, you have to integrate them on Razorpay Standard Checkout so that your customers can avail them while making payments."
---
...
---
**Amount Match** | Order amount should be more than or equal to the [Minimum Order Amount](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create#instant) set in an offer.
---
...
<Step title="[Pass the Offer in Orders API](#step-2-pass-the-offer-in-orders-api).">
[Pass the Offer in Orders API](#step-2-pass-the-offer-in-orders-api).
</Step>
...
You can [create offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create#create-offers) from the [Dashboard](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create).
...
Create an order and pass the offer in the `offers` array as a request parameter in the [Orders API](/api/orders).
...
- From the Dashboard.
- By [configuring webhooks](/webhooks/setup-edit-payments).
- By polling our [payment APIs](/api/payments/fetch-with-id).
...
- [Create Offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create)
...
- [Disable Offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create#disabling-offers)
