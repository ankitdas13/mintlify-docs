...
<Steps>
<Step title="[Create Offers from Dashboard](#step-1-create-offers).">
...
[Create Orders to include the Offers in the payment request](#step-2-create-an-order).
</Step>
<Step title="[Create a payment to be sent to the customer](#step-3-create-a-paym...">
[Create a payment to be sent to the customer](#step-3-create-a-payment).
</Step>
<Step title="[Verify the payment made by the customer](#step-4-verify-the-payment).">
...
[Create an offer](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create) from the Dashboard.
...
Know more about the [error codes](/api#error-codes).
