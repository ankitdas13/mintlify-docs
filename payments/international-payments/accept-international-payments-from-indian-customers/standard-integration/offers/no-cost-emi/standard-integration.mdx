...
description: "After creating [No Cost EMI Offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/no-cost-emi/create) from the Dashboard, you must integrate them with the Razorpay Standard Checkout so your customers can avail of them while making payments."
---
...
---
**Amount Match** | Order amount should be more than or equal to the [Minimum Order Amount](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/no-cost-emi/create) set in an offer.
---
...
This is the easiest way to display No Cost EMI offers at the Checkout. While [creating the  No Cost EMI offer](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/no-cost-emi/create) from the Dashboard, enable the **Show Offer on Checkout** option.
...
You can [create  No Cost EMI offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/create#create-offers) from the Dashboard.
...
- [Create No Cost EMI Offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/no-cost-emi/create)
...
- [Disable Offers](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/offers/no-cost-emi/create#disabling-no-cost-emi-offers)
