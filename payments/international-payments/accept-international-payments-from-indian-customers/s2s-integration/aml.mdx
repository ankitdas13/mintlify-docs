...
description: "Razorpay offers two Anti-Money Laundering (AML) solutions—Basic AML and Smart AML—designed to help businesses reduce settlement delays and minimise compliance-related transaction flags. Our risk prediction engine analyses historical transaction data and regulatory signals to accurately identify potential risks, reducing AML flags by up to 90% while maintaining compliance standards."
---
...
You need to pass a few additional parameters related to AML in the Orders API. There is no other change in the rest of the [S2S integration steps](/payments/international-payments/accept-international-payments-from-indian-customers/s2s-integration/build-integration).
...
<Steps>
<Step title="Step 1">
Create Order with AML screening.
</Step>
<Step title="Step 2">
Fetch Order With Updated Risk Assessment (optional).
</Step>
<Step title="Step 3">
Patch Order (If High Risk).
</Step>
<Step title="Step 4">
Create a Payment.
</Step>
...
<Step title="Step 2">
If high risk detected: Order fails immediately.
</Step>
<Step title="Step 3">
No payment creation possible - transaction ends here.
</Step>
<Step title="Step 4">
Handle error and inform customer.
</Step>
</Steps>
...
Once the order is created, pass the order_id from the Orders API response to the [Create a Payment API](/payments/international-payments/accept-international-payments-from-indian-customers/s2s-integration/build-integration#13-create-a-payment).
...
[Test Integration](/payments/international-payments/accept-international-payments-from-indian-customers/s2s-integration/test-integration)
