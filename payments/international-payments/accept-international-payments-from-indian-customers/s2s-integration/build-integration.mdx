...
description: "Given below are the steps to integrate with the Import Flow APIs."
---
...
- [Recurring](/payments/international-payments/accept-international-payments-from-indian-customers/s2s-integration/recurring-payments) 
...
[Step 2: Test Integration](/payments/international-payments/accept-international-payments-from-indian-customers/s2s-integration/test-integration)
