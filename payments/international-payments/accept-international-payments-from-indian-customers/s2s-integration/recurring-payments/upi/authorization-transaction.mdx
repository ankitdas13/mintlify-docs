...
If the payment request is valid, the response contains the following fields. Refer to the [UPI Intent Flow document](/payments/payment-gateway/s2s-integration/payment-methods/upi/intent#step-2-initiate-a-payment) for more details.
