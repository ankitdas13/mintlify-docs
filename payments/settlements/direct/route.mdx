---
title: "Direct Settlements on Route"
description: "is an enhancement to Razorpay's existing Route product that enables businesses using Direct Settlement transactions to automatically split payments among multiple vendors, suppliers or linked accounts."
---
...
- [Setup and Configuration](/payments/settlements/direct/route/setup)
- [Troubleshooting FAQs](/payments/settlements/direct/route/troubleshooting-faqs)
