...
description: "You can use the **Instant Settlement** feature in Razorpay to settle your available balance to your bank account instantly, 24x7, for a small fee."
---
...
<Steps>
<Step title="Step 1">
Amounts up to ₹5 Lakhs are settled instantly through Instant Settlements. Instant Settlements are routed through the IMPS channel.
</Step>
<Step title="Step 2">
Smart Settlements option also is enabled when the entered amount is between ₹5 Lakhs to ₹5 Crores. You can choose between Instant or Smart Settlements here.
...
<Step title="Step 3">
Amounts between ₹5 Crores to ₹50 Crores are settled only through Smart Settlements.
</Step>
</Steps>
...
Settle amounts **up to ₹5 Crores** through **Instant Settlement** feature via Dashboard and API: 
        ...
        5. Click **Settle Now** to settle instantly.
            ...
            Create and retrieve Instant Settlements requests using APIs. Refer to the [list of Instant Settlements APIs](/payments/settlements/apis#list-of-settlements-api).
