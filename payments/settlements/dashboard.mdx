...
description: "You can view details of settlements made to you from the Dashboard."
---
...
You can view settlement details using the [Settlements API](/api/settlements).
...
- [Settlements API](/payments/settlements/apis)
