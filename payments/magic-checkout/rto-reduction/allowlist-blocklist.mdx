...
description: "With Magic Checkout, you can determine which cash on delivery orders you would like to allow or block based on a set of parameters to reduce RTO."
---
