...
description: "You can share your historical order data (pre-Magic Checkout) and delivery status with Razorpay Magic Checkout for improved COD intelligence and better RTO protection. You must upload the following:"
---
...
If you have not integrated with logistics partners like [Shiprocket](/payments/magic-checkout/rto-reduction/logistics-partners/shiprocket), [Delhivery](/payments/magic-checkout/rto-reduction/logistics-partners/delhivery), [iThink Logistics](/payments/magic-checkout/rto-reduction/logistics-partners/ithink-logistics), [Unicommerce](/payments/magic-checkout/rto-reduction/logistics-partners/unicommerce) and [ClickPost](/payments/magic-checkout/rto-reduction/logistics-partners/clickpost), you must manually upload the data. 
...
### Related Information 
- [RTO Analytics](/payments/magic-checkout/analytics/rto)
- [Integrate with Logistics Partners](/payments/magic-checkout/rto-reduction/logistics-partners)
