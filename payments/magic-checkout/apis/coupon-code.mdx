---
title: "Coupon Code"
description: "Use the Coupon Code APIs to send coupon details to Razorpay. Razorpay will create the coupon codes, which you can then apply to transactions."
---
