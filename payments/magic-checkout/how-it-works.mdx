---
title: "How Magic Checkout Works"
description: "Given below is a complete end-to-end flow about how customers can use Magic Checkout."
---
...
### Logged In
         ...
         Customers who already are logged in have 2 ways to proceed with checkout:
                ...
                This results in a faster, more efficient checkout experience that boosts conversion rates and enhances satisfaction for both customers and businesses. Know more about [Quickbuy](/payments/payment-gateway/features/quickbuy).
