---
title: "Integrate Magic Checkout on Website"
description: "Follow these steps to integrate the Razorpay Magic Checkout on your website."
---
...
If your website is running on WooCommerce or Shopify, please integrate with the Razorpay [WooCommerce](/payments/magic-checkout/woocommerce) or [Shopify](/payments/magic-checkout/shopify) plugin based on your requirement.
...
### 1.8 Verify Payment Status
     ...
     Verify the payment status using the APIs and webhooks.
         ...
         You can fetch the payment details using the [Fetch Payments API](/api/payments/fetch-with-id).
         ...
         You should [set up webhooks](/webhooks/setup-edit-payments) on the Razorpay Dashboard to receive notifications when certain events occur.
...
### Related Information
[Troubleshoot and FAQs](/payments/magic-checkout/troubleshooting-faqs#web)
