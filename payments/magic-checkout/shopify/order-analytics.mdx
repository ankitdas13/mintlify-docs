...
description: "Magic Checkout's Order Analytics Dashboard gives you an in-depth view of the Order-related activities on your Shopify store."
---
...
<Step title="Step 2">
Navigate to **Magic Checkout** → **Order Analytics**. 

</Step>
<Step title="Step 3">
The Dashboard offers insight into the following:
