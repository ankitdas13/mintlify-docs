...
description: "After you successfully integrate your Shopify website with Magic Checkout, the following configurations are available on your Razorpay and Shopify Dashboard:"
---
...
### Manually Review COD Orders
         ...
         Once you enable manual review, you can review the COD orders and take necessary actions. Refer to the [COD Orders](/payments/magic-checkout/order-settings/review-cod-orders#cod-orders) section for the next steps.
...
Razorpay Magic SSO (Single Sign-On) offers a seamless login experience, helping you enhance conversions and gain valuable insights into user behaviour. Know more about how to setup [login with Razorpayt](/payments/magic-checkout/login-with-razorpay) on your shopify store.
...
Know how to [create offers](/payments/offers/create).
