---
title: "Integrate Magic Checkout on React Native Android App - Shopify"
description: "Follow these steps to integrate the Razorpay Magic Checkout on your React Native Android application when using Shopify as your e-commerce platform."
---
...
- Integrate with [React Native: Android Integration](/payments/magic-checkout/react-native-android-integration).
