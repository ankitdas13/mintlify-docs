---
title: "Integrate Magic Checkout on iOS App - Shopify"
description: "Follow these steps to integrate the Razorpay Magic Checkout on your iOS application when using Shopify as your e-commerce platform."
---
...
- Integrate with [iOS Integration](/payments/magic-checkout/ios-integration).
