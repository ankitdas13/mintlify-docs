---
title: "Integrate Magic Checkout on Android App - Shopify"
description: "Follow these steps to integrate the Razorpay Magic Checkout on your Android application when using Shopify as your e-commerce platform."
---
...
- Integrate with [Android Integration](/payments/magic-checkout/android-integration).
...
### 1.4 Initialise Razorpay Android Standard SDK
     ...
     Use the `setKeyId()` method of the Checkout class to dynamically add your API key id. You can generate your API keys from the [Razorpay Dashboard](/payments/dashboard/account-settings/api-keys#generate-api-keys).
...
### 1.6 Initiate Payment and Display Checkout Form
     ...
     Create an instance of the `Checkout` and pass the payment details and options as a `JSONObject`. Ensure that you add the `order_id` generated in [Step 5](/payments/magic-checkout/android-integration#15-create-an-order).
