---
title: "Integrate Magic Checkout on Flutter App - Shopify"
description: "Follow these steps to integrate the Razorpay Magic Checkout on your Flutter application when using Shopify as your e-commerce platform."
---
...
- Integrate with [Flutter Integration](/payments/magic-checkout/flutter-integration).
