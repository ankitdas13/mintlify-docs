---
title: "Integrate Magic Checkout on React (Next.JS) Website - Shopify"
description: "Follow these steps to integrate the Razorpay Magic Checkout on your React (Next.JS) Website when using Shopify as your e-commerce platform. This integration treats the platform as Shopify while using a custom frontend, allowing unified order management in Shopify admin."
---
