...
<Step title="Step 3">
We will verify the following eligibility requirements with your Shopify store:
...
- [Automatic Customer Tagging for Retargeting](/payments/magic-checkout/login-with-razorpay/automation-tags)
- [Customer Analytics](/payments/magic-checkout/login-with-razorpay/customer-analytics)
