---
title: "Configure WooCommerce Options"
description: "You have various configuration options available on your Razorpay and WooCommerce Dashboard. You can perform the following configurations to suit your business needs:"
---
...
### To enable COD settings:
         ...
         2. Select **WooCommerce** from the **Platform** drop-down list. Paste the [WordPress Address or Site Address](/payments/magic-checkout/woocommerce#step-1-configure-settings-on-razorpay-dashboard) in the **Domain hyperlink** field and click **Next**.
...
### COD Intelligence
         ...
         You can disable **COD Intelligence** if required. This will enable the COD option for all the customers, including those considered risky by Magic Checkout. Once you enable COD intelligence, the **RTO Analytics** tab will appear. Know more about [RTO Analytics](/payments/magic-checkout/analytics/rto).
...
### Manually Review COD Orders
         ...
         Once you enable manual review, you can review the COD orders and take necessary actions. Refer to the [COD Orders](/payments/magic-checkout/order-settings/review-cod-orders#cod-orders) section for more information.
...
Converting orders to prepaid can help you increase order commitment, reduce RTO, streamline operations and enhance customer trust. Know how to [convert COD orders to prepaid](/payments/magic-checkout/order-settings/prepay-cod).
...
>                  
>              - You will get a pop-up if you have not opted for [COD Engine](/payments/magic-checkout/woocommerce/configuration#cash-on-delivery) and [COD order to prepaid](/payments/magic-checkout/woocommerce/configuration#convert-cod-orders-to-prepaid). Enter the **Consumer Key** and **Secret**. Follow the steps given below to generate API keys:
>                  1. Log in to the [WordPress account](https://wordpress.com/log-in) and navigate to  **WooCommerce** → **Settings**.
...
### Logistics Partners
         ...
         You can integrate Magic Checkout with following logistics partners to easily fetch delivery status details. This is a mandatory step if you have opted for [RTO protection](/payments/magic-checkout/woocommerce/configuration#rto):
...
### To enable international shipping: 
 ...
 the Razorpay Dashboard and navigate to **Magic Checkout** → **Setup & Settings** → **Platform Settings**.   
         2. Select **WooCommerce** from the **Platform** drop-down list. Paste the [WordPress Address or Site Address](/payments/magic-checkout/woocommerce#step-1-enable-features-on-razorpay-dashboard) in the **Domain hyperlink** field and click **Next**.
...
>              
         ...
         6. Select **WooCommerce** from the **Platform** drop-down list. Paste the [WordPress Address or Site Address](/payments/magic-checkout/woocommerce#step-1-enable-features-on-razorpay-dashboard) in the **Domain hyperlink** field and click **Next**.
...
[Troubleshooting and FAQs](/payments/magic-checkout/troubleshooting-faqs#woocommerce)
