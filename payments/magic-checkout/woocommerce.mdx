...
- [Cash on Delivery](/payments/magic-checkout/woocommerce/features#cash-on-delivery): Enable COD and configure rules for specific locations, products, and order amounts, catering to customer preferences and logistical needs to increase sales.
- [RTO](/payments/magic-checkout/woocommerce/features#rto): Use automated COD intelligence or manual review to decide whether to offer COD based on customer buying history, thus reducing RTO rates.
- [Convert COD Orders to Prepaid](/payments/magic-checkout/woocommerce/features#convert-cod-orders-to-prepaid): Encourage COD customers to switch to prepaid by offering discounts or incentives, reducing cash handling risks.
- [Shipping Options](/payments/magic-checkout/woocommerce/features#shipping-options): Set up shipping rates at the product, zone and method levels to optimise costs and improve delivery efficiency.
- [International Shipping](/payments/magic-checkout/woocommerce/features#international-shipping): Allow customers to enter international PIN codes, expanding your market reach globally.
- [Coupons](/payments/magic-checkout/woocommerce/features#coupons): Provide discounts via coupons to enhance engagement and reduce cart abandonment.
- [Google and Facebook Analytics](/payments/magic-checkout/woocommerce/features#google-and-facebook-analytics): Integrate Google and Facebook Analytics for insights into customer behaviour and optimised marketing strategies.
