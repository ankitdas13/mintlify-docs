...
description: "When customers authenticate through [Login with Razorpay (SSO)](/payments/magic-checkout/login-with-razorpay), their activity is captured in the **Customer Analytics** dashboard. It displays login metrics, account creation data, and customer-level insights to help you track engagement, understand user behaviour, and retarget high-intent customers across marketing channels."
---
