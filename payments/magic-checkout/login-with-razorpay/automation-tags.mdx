...
description: "When customers authenticate through [Login with Razorpay (SSO)](/payments/magic-checkout/login-with-razorpay) on your Shopify store, specific tags are automatically assigned to their profiles. These tags provide automation capabilities that enhance your marketing efforts and improve customer engagement."
---
