---
title: "COD Orders Review Workflow"
description: "Reviewing and acting upon COD orders manually can be time-consuming. With the automation feature, you can configure workflows to approve, hold or cancel COD orders based on the RTO risk levels."
---
...
You can access the **COD Orders Review Workflow** feature only if you opt for [manual review of COD orders](/payments/magic-checkout/order-settings/review-cod-orders).
...
<Step title="Step 2">
Navigate to **Magic Checkout** → **Orders**.
</Step>
<Step title="Step 3">
In the **Manual Review of COD Orders** tab, click **Automate now**. This redirects you to the **COD Review Workflow** field in the **Setup & Settings** section.
...
This feature is available for your Custom ecommerce platform, [WooCommerce website](/payments/payment-pages) and [Shopify store](/payments/payment-pages).
