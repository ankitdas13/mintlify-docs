---
title: "About Manual Review of COD Orders"
description: "You can manually review COD orders and take necessary actions based on our recommendations post-order placement to filter out potential RTOs."
---
...
### Cancel Order
         ...
         You can cancel the order based on the risk level and our recommendation. For example, if we have noticed a high return behaviour associated with this order; we recommend cancelling the order. The order status will change to cancelled on the COD orders tab and your [e-commerce platform](/payments/magic-checkout/order-settings/review-cod-orders#e-commerce-platform). Click the **cancel icon** to cancel the order.
...
### Related Information 
[COD Review Workflow](/payments/magic-checkout/order-settings/review-cod-orders/workflow)
