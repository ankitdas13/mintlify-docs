...
description: "Cash on Delivery transactions are popular in India. However, they can result in a higher return rate due to less customer commitment."
---
...
- This feature is available only if you use [Shopify](/payments/magic-checkout/shopify) or [WooCommerce](/payments/magic-checkout/woocommerce) (v4.3.5 and above) plugin.
...
<Steps>
<Step title="Step 1">
Log in to the Dashboard and navigate to **Magic Checkout** → **Setup & Settings**.
</Step>
<Step title="Step 2">
Navigate to **COD Setup** → **Convert COD to Prepaid**.
</Step>
<Step title="Step 3">
Click **Convert COD to Prepaid**.
...
The **Enable conversion for** field will appear if you enable the [Manually review COD orders](/payments/magic-checkout/order-settings/review-cod-orders) feature. The COD conversion will be based on the type of RTO risk.
...
If you are a WooCommerce user and have not opted for the [Manually review COD orders](/payments/magic-checkout/order-settings/review-cod-orders) feature, you must provide your **WooCommerce API credentials** to enable us to send the conversion links to your customers.
