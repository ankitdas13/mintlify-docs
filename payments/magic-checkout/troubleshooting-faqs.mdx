...
### 5. How do I set up coupon codes with Magic Checkout on Shopify?
        ...
        Follow these [steps](/payments/magic-checkout/shopify/configuration#coupons) to configure coupon codes on your [Razorpay Dashboard](https://dashboard.razorpay.com/app/magic/coupons) for your Shopify store.
...
### 16. How do I set up shipping profiles on Razorpay Dashboard?
          ...
          You can configure shipping rates at product, zone and method levels for your customers. Follow these [steps](/payments/magic-checkout/shopify/configuration#method-1-razorpay-dashboard-1) to set up shipping profiles on the [Razorpay Dashboard](https://dashboard.razorpay.com/app/magic/settings/shipping-setup).
...
### 6. How do login rewards work?
         ...
         Login rewards are incentives such as coupons offered to users who log in via the widget. You must create the coupon using [Razorpay Coupon Engine](/payments/magic-checkout/shopify/configuration#coupons) and raise a request with our [support team](https://razorpay.com/support/#request) to get the feature enabled. 
