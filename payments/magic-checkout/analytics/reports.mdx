---
title: "View Reports"
description: "You can generate Magic Checkout reports from the Dashboard to analyse order performance and customer behaviour on your store. Magic Checkout offers two types of reports:"
---
...
<Steps>
<Step title="Step 1">
Log in to the [Dashboard](https://dashboard.razorpay.com/app) and navigate to **Reports**.
</Step>
<Step title="Step 2">
In the **Overview** section, click **Download Report**.
...
<Step title="Step 5">
Navigate to the **Downloads** section to track the download status and click the download icon to download the report.
...
You can also schedule reports to receive them automatically at regular intervals. This ensures you get timely data for consistent decision-making without manual downloads. Know more about how to [schedule reports](/payments/dashboard/reports#schedule-reports).
...
### Order Reports
         ...
         ---
         `order_status` | Status of the order. Know more about [Order Status](/payments/orders#order-states).
         ---
         `payment_method` | Code of the payment method used. Know more about [Razorpay Payment Methods](/payments/payment-methods).
         ---
         `payment_amount` | Amount paid through the payment method in smallest currency unit.
         ---
         `payment_status` | Status of payment. Know more about [Payment Status](/payments/payments#payment-life-cycle).
         ---
