---
title: "Risk Report"
description: "You can compare the probability of risk associated with orders reviewed via COD Intelligence or manual review. View the graphs for a selected period up to the last 90 days."
---

## Widgets

The following widgets are available in the **Risk Report** tab of the [RTO Analytics Dashboard](/payments/magic-checkout/analytics/rto). Check which widgets are applicable when you opt either for: 
- COD Intelligence.
