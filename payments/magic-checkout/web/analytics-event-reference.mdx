...
description: "This page is a technical reference for all Magic Checkout analytics events. For setup instructions, see the [Magic Checkout Analytics Integration](/payments/magic-checkout/web/analytics-integration) guide."
---
