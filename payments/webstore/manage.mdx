...
description: "You can perform the following actions:"
---
...
<Step title="Step 2">
From the list, select the Webstore you want to modify.
</Step>
<Step title="Step 3">
In the top right corner, click the **Edit Page** button.
...
<Step title="Step 2">
Select the Webstore you want to modify.
</Step>
<Step title="Step 3">
...
#### At the Time of Creation
Know how to [set the Webstore's expiry date](/payments/webstore/create#step-3-configure-store-settings) at the time of creation.
