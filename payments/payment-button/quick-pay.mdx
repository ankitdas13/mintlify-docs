...
description: "You can create a Quick Pay Button using the Dashboard and embed it on your website to accept payments from customers. This is useful in cases where you want to accept a fixed amount as payment."
---
...
<Step title="Step 3">
Select a payment method. For example, netbanking, and complete the payment.
</Step>
<Step title="Step 4">
