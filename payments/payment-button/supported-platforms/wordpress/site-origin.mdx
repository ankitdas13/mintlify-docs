...
description: "You can accept payments on your SiteOrigin-built WordPress website using the [Payment Button SiteOrigin Plugin](https://wordpress.org/plugins/razorpay-payment-button-for-siteorigin/)."
---
