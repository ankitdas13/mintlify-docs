...
description: "After an active Subscription button accepts payments, view its subscriptions and one-time payment details on the Dashboard → **Payment Button** → **Subscription Buttons** tab."
---
...
- [Subscription Button](/payments/payment-button/subscription-buttons)
