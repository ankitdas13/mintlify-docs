...
description: "You can create a Subscription Button via Dashboard and embed it on your website to accept payments from customers. This is useful in cases where you want to provide subscription plans."
---
...
- The Dashboard has [test and live modes](/payments/dashboard/test-live-modes). Subscription Buttons created in the test mode do not appear in the live environment. **You must create a new Subscription Button in live mode**.
...
You can [View Subscriptions and One-time Payments](/payments/payment-button/subscription-buttons/download-reports). To download reports, refer to the [Download Report](/payments/payment-button/subscription-buttons/download-reports) section.
...
- [Manage Subscription Buttons](/payments/payment-button/subscription-buttons/manage)
- [View Notifications using Webhooks](/payments/payment-button/subscription-buttons/subscribe-to-webhooks)
