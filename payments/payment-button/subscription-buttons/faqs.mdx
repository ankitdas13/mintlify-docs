---
title: "FAQs"
description: "Here are some frequently asked questions about Subscription Button."
---
...
You cannot setup a one-time payment subscription button. For one-time payment, please use [Payment Button](/payments/payment-button).
...
<Step title="Step 2">
Under **Account Settings**, in the **Your Logo** section, click **Choose File**.
</Step>
<Step title="Step 3">
Upload the logo file. Ensure that the logo is a square image of minimum dimensions 256x256 px. Maximum file size allowed is 1MB.
</Step>
</Steps>
...
<Step title="Step 2">
Under **Account Settings**, in the **Theme Color** section, enter the HEX code for your brand. For example, `#6822CC`.
</Step>
<Step title="Step 3">
Click **Save Changes**.
</Step>
...
<Steps>
<Step title="Step 1">
Go to Dashboard → **Payment Button**.
</Step>
<Step title="Step 2">
Click **Subscription Buttons** tab.
</Step>
<Step title="Step 3">
In the list that appears, navigate to the relevant button and copy the button code.
</Step>
<Step title="Step 4">
In your website code, paste this code on the page where you want the subscription button to appear.
</Step>
</Steps>
...
You can view the payments as and when they are made in the [Transactions Details View](/payments/payment-button/view-reports) of the Subscription Button.
...
Raise a request on the Dashboard to display more [payment methods](/payments/dashboard/account-settings/payment-methods#request-for-payment-methods-and-support) on Checkout.
...
You can accept payments in international currency using Subscription Button. Refer to the [list of supported currencies](/payments/international-payments#supported-currencies). Follow these steps:
