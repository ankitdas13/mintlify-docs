...
description: "As an NGO using Subscription Button to accept donations from patrons, you can share payment receipts with 80 G details to customers via email once they make the payment."
---
...
<Step title="Step 3">
You can show an input field such as `Name`, `Address` and its associated value on the Receipt. To do this:
