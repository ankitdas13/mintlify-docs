...
description: "You can use the Razorpay Payments Mobile app to quickly create and share Payment Links with your customers. The customers can open the Payment Links to make payments using any of the payment methods, such as, UPI, Debit/Credit Card, Netbanking or Wallets."
---
...
<Steps>
<Step title="Step 1">
Under the **Accept Payments** section, tap **Payment Link** and scroll down to the **Recent Payment Links** section. 

</Step>
<Step title="Step 2">
Tap on the link you want to cancel.
</Step>
<Step title="Step 3">
Scroll to the end of the page and tap **Cancel Link**. 
...
- [Payment Pages Mobile App](/payments/mobile-app/accept-payments/payment-pages)
