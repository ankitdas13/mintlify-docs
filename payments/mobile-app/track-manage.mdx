...
description: "You can use the Razorpay Mobile app to track payments made by your customers and analyse payment trends over different time periods."
---
...
<Step title="Step 3">
A list of payments appears. You can also filter the payments by:
- Date
