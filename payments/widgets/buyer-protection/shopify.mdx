...
description: "Integrate Razorpay Buyer Protection widget into your Shopify website's product pages."
---
...
- Log in to the Dashboard and [generate the API keys](/api/authentication#generate-api-keys) in Live mode.
...
3. After installing the app, you will be directed to your Shopify store. Enter your Razorpay Live API Key ID and click **Save**. This step is necessary to verify your eligibility for the widget. Know how to [generate API Keys](/api/authentication#generate-api-keys) from the Dashboard.
...
### Related Information
- [Money Back Promise](/payments/widgets/buyer-protection/money-back-promise)
