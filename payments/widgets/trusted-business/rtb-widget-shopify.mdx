...
description: "Integrate Razorpay Trusted Business (RTB) widget into your Shopify website's product pages."
---
...
If you have multiple stores, select the store for which you want to install the RTB widget.
     ...
     5. After installing the app, you will be directed to your Shopify store and asked to enter your Razorpay Live API Key ID. This step is necessary to verify your eligibility for the RTB badge. Know how to [generate API Keys](/api/authentication#generate-api-keys) from the Dashboard.
...
After previewing and testing the widget on your Shopify Dashboard, you must replace the test mode API keys with the live mode API keys. You can generate the [live mode API keys](/api/authentication#live-mode-api-keys). from the Dashboard.
