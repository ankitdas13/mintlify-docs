...
description: "You can create 2 types of Payment Links using the Razorpay Dashboard:"
---
...
### To create a Standard Payment Link:
         ...
         4. Enter the required details in the Standard Payment Link pop-up page.
            ...
            - **Amount** (Mandatory): Select the currency and amount for the Payment Link. For example, select `₹` and enter`1000` for ₹1,000. You can also accept payments in [international currencies](/payments/international-payments#supported-currencies).
...
- [Create a Standard Payment Link API](/api/payments/payment-links/create-standard)
- [Create a UPI Payment Link API](/api/payments/payment-links/create-upi)
