---
title: "Manage Team"
description: "You can manage your team of users who can access the Dashboard. You can provide specific access to a user or a set of users for Payment Links."
---
