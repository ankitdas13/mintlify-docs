...
description: "You can send your customers automated SMS and email reminders for Payment Links. Setting reminders helps you to:"
---
...
Customers will receive the reminder email or SMS only if their contact and email details were provided when the Payment Link was created. Know more about [creating Payment Links](/payments/payment-links/create).
...
Know more about enabling or disabling reminders when creating [Payment Links using Bulk Upload](/payments/payment-links/batch#:~:text=Send%20auto%20reminders).
...
- `reminder_enable` parameter in [Create a Standard Payment Link API](/api/payments/payment-links/create-standard)
- `reminder_enable` parameter in [Create a UPI Payment Link API](/api/payments/payment-links/create-upi)

#### Related Information

- [How Payment Links Work](/payments/payment-links/how-it-works)
- [Payment Link States](/payments/payment-links/states)
