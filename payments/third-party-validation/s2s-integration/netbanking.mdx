...
description: "In the TPV integration flow, Razorpay maps the customer's bank accounts so that the payment is processed only from their registered bank accounts."
---
...
<Steps>
<Step title="Step 1">
[Collect Customer Bank Account Details](#step-1-collect-customer-bank-account-details)
</Step>
<Step title="Step 2">
