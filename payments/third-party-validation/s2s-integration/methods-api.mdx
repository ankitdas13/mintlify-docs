---
title: "Methods API"
description: "You can configure payment methods of your choice for collecting payments from your customers."
---
...
Now that you know the available payment methods, you can start creating payment requests using the [sample payloads](/payments/payment-gateway/s2s-integration/payment-methods) for the payment methods of your choice.
