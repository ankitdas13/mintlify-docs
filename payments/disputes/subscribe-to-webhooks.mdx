...
description: "Subscribe to webhook events available for disputes to get notifications."
---
...
Know more about [Webhooks](/webhooks) and check the [sample payloads.](/webhooks/disputes)

### Related Information
- [About Disputes](/payments/disputes)
- [Disputes APIs](/payments/disputes/apis)
