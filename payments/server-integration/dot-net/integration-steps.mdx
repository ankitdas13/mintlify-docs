...
You can capture payments automatically with one-time [Payment Capture setting configuration](/payments/server-integration/dot-net/integration-steps#3-go-live-checklist) on the Dashboard.
...
<Steps>
<Step title="Step 1">
Edit the [KEY_ID] inside **Payment.aspx**. Use the test keys while testing your application.  Know how to [Generate API keys](/api/authentication#generate-api-keys).  
</Step>
<Step title="Step 2">
...
```
- Test your integration using these [test cards](/payments/server-integration/dot-net/integration-steps#2-test-integration).
...
[Troubleshooting and FAQs](/payments/server-integration/dot-net/troubleshooting-faqs)
