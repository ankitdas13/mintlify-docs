...
You can capture payments automatically with one-time [Payment Capture setting configuration](/payments/server-integration/java/integration-steps#3-go-live-checklist) on the Dashboard.
...
Test your integration using these [test cards](/payments/server-integration/java/integration-steps#2-test-integration).
...
Razorpay offers a range of [payment products](/payments) to meet your business requirements. Visit our  [GitHub repository](https://github.com/razorpay/razorpay-java) for sample codes.
