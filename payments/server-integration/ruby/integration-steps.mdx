...
You can capture payments automatically with one-time [Payment Capture setting configuration](/payments/server-integration/ruby/integration-steps#3-go-live-checklist) on the Dashboard.
...
Test your integration using these [test cards](/payments/server-integration/ruby/integration-steps#2-test-integration).
