...
description: "If you do not have a website or app, you can still create and send Subscriptions to customers using a link. When the customer opens the link, they are taken to a checkout page hosted by Razorpay, where they make the authorisation payment. You can also use this feature to create and send custom Subscriptions to customers."
---

Subscription Links can be created from the [Dashboard](/payments/subscriptions/create-subscription-links#create-a-subscription-link-from-dashboard) or using [APIs](/payments/subscriptions/create-subscription-links#create-a-subscription-link-using-api).
...
1. [Create a plan](/payments/subscriptions/create-plans#create-a-plan).
1. [Create and send a Subscription link](/payments/subscriptions/create-subscription-links#create-a-subscription-link).
...
You can create a Subscription Links using [Create a Subscription Link API](/api/payments/subscriptions/create-subscription-link).
