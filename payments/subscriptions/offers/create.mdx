...
description: "You can create offers only from the Dashboard. You can control the discounts you offer your customers, restrict the payment methods on which offers are applied and limit their usage to a defined time period."
---
...
Know how to [delete an offer linked to a subscription](/payments/subscriptions/offers/delete).

To disable an offer:
<Steps>
<Step title="Step 1">
Log in to the Dashboard and click **Offers** under **PAYMENT PRODUCTS** in the left menu.
</Step>
<Step title="Step 2">
Click the required Offer Id.
</Step>
<Step title="Step 3">
In the right pane that appears, click **Disable**.
</Step>
</Steps>
