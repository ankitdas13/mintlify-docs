---
title: "About Offers"
description: "You can use Subscription Offers to provide discounts or cashback on Subscriptions. This attracts more customers, retains existing customers and increases sales. You have complete control over the offers you provide to your customers, such as the payment methods on which the Offer should be applied, maximum number of customers who can avail the offers and define the time of offers."
---

## How it Works

You can create and apply offers for Subscriptions in 3 easy steps:
1. [Create an Offer from the Dashboard](/payments/subscriptions/offers/create).
1. [Create a Plan for the Subscription](/payments/subscriptions/create-plans#create-a-plan).
1. [Link the Offer to a Subscription](/payments/subscriptions/offers/link).
