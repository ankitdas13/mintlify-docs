...
description: "Add-ons can be charged to your customers at any time during the life of a Subscription. Add-ons are typically charged for extra services taken by a customer during the billing cycle."
---
...
- [Using APIs](/api/payments/subscriptions#create-an-add-on).
...
You can create add-ons for the Subscriptions using [Create an Add-on](/api/payments/subscriptions#create-an-add-on) API.
