...
description: "Razorpay Subscriptions plugin for Magento does not support updating an existing subscription product."
---
...
If you need to refund money to a customer for any reason, you need to do this manually from the [Razorpay Dashboard](/payments/payments/dashboard#issue-refunds).
