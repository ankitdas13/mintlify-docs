...
description: "Follow the steps given below to integrate Razorpay Payment Gateway with your OpenCart enabled site using the Razorpay Subscription for OpenCart plugin."
---
...
1. [Install the Razorpay Subscriptions for OpenCart Plugin](/payments/subscriptions/plugins/opencart/build-integration#step-1-install-razorpay-subscriptions-for-opencart-plugin).
1. [Configure OpenCart Settings](/payments/subscriptions/plugins/opencart/build-integration#step-2-configure-opencart-settings).
1. [Create a Plan for Subscriptions product](/payments/subscriptions/plugins/opencart/build-integration#step-3-create-a-plan-for-subscriptions-product).
1. [Test integration](/payments/subscriptions/plugins/opencart/test-integration).

### On Razorpay Dashboard

1. [Enable Webhooks](/payments/subscriptions/plugins/opencart/build-integration#subscribe-to-webhook-events).
...
<Steps>
<Step title="Step 1">
Go to the **Admin Panel** → **Razorpay Subscription**  → **Plans** to add a new Plan.
</Step>
<Step title="Step 2">
Click **Add new** to create a new Plan.
</Step>
<Step title="Step 3">
Enter the required details and click **Save** to save the Plan.
</Step>
</Steps>
...
[Step 2: Test Integration](/payments/subscriptions/plugins/opencart/test-integration)
