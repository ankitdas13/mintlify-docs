...
description: "After the integration is complete, Razorpay will appear as a payment option on your web page/app. You need to make a test transaction to ensure that the integration is working as expected. You can start accepting actual payments from your customers once the test is successful."
---
...
[Step 3: Go Live Checklist](/payments/subscriptions/plugins/opencart/go-live-checklist)
