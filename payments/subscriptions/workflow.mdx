...
description: "Understand the Subscription flow and how to create Subscriptions from the Checkout or using links."
---
...
1. [Create a Plan](/payments/subscriptions/create#plan).
1. After the Plan is created, you can then [create a Subscription](/payments/subscriptions/create#subscription) for your customer.
1. Customer makes the [Authentication Transaction](/payments/subscriptions/create#authentication-transaction).
...
You can [integrate Subscriptions](/payments/subscriptions/integration-guide) into your checkout only using [Subscriptions APIs](/api/payments/subscriptions).
...
- [Pause and Resume a Subscription](/payments/subscriptions/pause-resume-cancel)
- [Cancel a Subscription](/payments/subscriptions/pause-resume-cancel#cancel-a-subscription-via-the-dashboard)
...
Know more about the [Subscription states](/payments/subscriptions/states).
