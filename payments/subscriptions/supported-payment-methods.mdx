...
description: "Razorpay Subscriptions supports Cards, UPI Autopay and Emandate. The table below provides a summary of each payment method, the supported networks or banks, and the maximum subscription amount allowed."
---
...
----
Cards | Visa, Mastercard and RuPay | [Refer to monetary limits](/payments/subscriptions/faqs#7-is-there-a-maximum-monetary-limit-for)
---
UPI Autopay | [Popular UPI apps](/payments/subscriptions/supported-banks-apps#upi-autopay) and [NPCI-supported banks](https://www.npci.org.in/product/autopay/all-members) | Up to ₹1,00,000 (mandate creation)
Frictionless debits: ₹15,000 (all) / ₹1,00,000 (BFSI only)
---
Emandate (eNACH) | [NPCI-supported banks](/payments/subscriptions/supported-banks-apps#emandate) | ₹1,00,00,000
...
Standing Instructions (SI) on cards are supported on **Visa**, **Mastercard** and **RuPay** cards of all major banks. For the list of supported banks, see [Supported Banks — Cards](/payments/subscriptions/supported-banks-apps#cards).

For maximum monetary limits for card mandates, see [Card mandate limits](/payments/subscriptions/faqs#7-is-there-a-maximum-monetary-limit-for).
...
For the complete list of supported UPI applications, handles and banks, see [Supported Banks and Apps — UPI Autopay](/payments/subscriptions/supported-banks-apps#upi-autopay).
...
- [Supported Banks and Apps](/payments/subscriptions/supported-banks-apps)
- [Create Subscriptions](/payments/subscriptions/create)
- [Test Subscriptions](/payments/subscriptions/test)
- [Payment Retries](/payments/subscriptions/payment-retries)
