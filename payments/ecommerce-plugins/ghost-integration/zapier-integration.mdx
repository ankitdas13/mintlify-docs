...
description: "Zapier Integration consists of 2 sets of steps - **Trigger** and **Action**."
---
...
9. Zapier generates a **Custom Webhook URL**. Copy and save this URL for later use. You will need this URL while creating the [Razorpay Webhook](/webhooks/setup-edit-payments).
...
Configure your Razorpay Dashboard to send the `payment.captured` webhook to this Zapier URL. Refer to [Razorpay Webhook Setup](/webhooks/setup-edit-payments) for detailed instructions.
...
4. Configure the Custom Request to **Find Member**:
    ...
    - **Headers**:
        - Authorisation: Ghost-Admin. Replace `your_admin_api_key` with the Ghost Admin API credentials you got while [setting up Ghost](/payments/ecommerce-plugins/ghost-integration#integration-steps) (refer #3 under Integrations).
    ...
    You will use the output from the **Find Member** steps for this.
        ...
        Define **Path A** to update an existing member.
            ...
            - Action - Update Existing Member
                ...
                - Headers: 
                    - Authorisation: Ghost-Admin. Replace `your_admin_api_key` with the Ghost Admin API credentials you got while [setting up Ghost](/payments/ecommerce-plugins/ghost-integration#integration-steps) (refer #3 under [Integrations](/payments/ecommerce-plugins/ghost-integration#integration-steps)).
...
- [Ghost Integration](/payments/ecommerce-plugins/ghost-integration)
