---
title: "Integrate Razorpay Payment Button with Ghost CMS"
description: "Integrate Razorpay Payment Buttons with Ghost CMS for automated member creation using [Zapier](https://zapier.com/). Zapier is a tool that connects your apps without requiring any code."
---
...
### How It Works
         ...
         2. Razorpay detects a `payment.captured` [webhook event](/webhooks/payments).
...
<Steps>
<Step title="Step 1">
Sign up for a [Razorpay account](https://dashboard.razorpay.com/signup) (with Payment Links or Subscriptions set up).
</Step>
<Step title="Step 2">
Sign up for a [Zapier](https://zapier.com/sign-up) account (Pro plan recommended for webhook features).
</Step>
<Step title="Step 3">
Ensure you have a Ghost CMS account (self-hosted or Ghost Pro).
</Step>
</Steps>

### Integration Steps

1. Set up your [Razorpay Webhook](/webhooks/setup-edit-payments). 
    - You will need the [Zapier **Catch Hook** URL](/payments/ecommerce-plugins/ghost-integration/zapier-integration)to complete the webhook set up. 
...
2. Create a [Razorpay Payment Button](/payments/ecommerce-plugins/ghost-integration/add-payment-button).
...
4. Create a [Zapier Zap](/payments/ecommerce-plugins/ghost-integration/zapier-integration).
...
- **Ensure Certificate Verification**: Always configure your application to enable [SSL/TLS certificate verification](/security/whitelists) for all outgoing API calls. This prevents Man-in-the-Middle (MITM) attacks by ensuring you are communicating with the legitimate server.

### Related Information

- [Zapier Integration](/payments/ecommerce-plugins/ghost-integration/zapier-integration)
- [Integrate a Payment Button with Ghost](/payments/ecommerce-plugins/ghost-integration/add-payment-button)
- [Razorpay Payment Button](/payments/payment-button)
- [Razorpay Webhook](/webhooks/setup-edit-payments)
