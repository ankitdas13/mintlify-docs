...
description: "RBI [revised guidelines](https://www.rbi.org.in/scripts/FS_Notification.aspx?Id=11822&fn=9&Mode=0) for PA/PG requires Razorpay to have an escrow account with RBL as banking partner. Existing Customer Identifiers with Yes Bank and ICICI Bank will be shut down, and all banking ops moved to RBL escrow account. Dashboard shows both old and newly created Customer Identifier until Jan 31, 2022."
---
