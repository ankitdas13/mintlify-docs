...
description: "Smart Collect makes reconciling payments received through bank transfers easy by allowing you to create Customer Identifiers for specific customers and reconciling payments automatically."
---
...
Refer to the [Third Party Validation](/payments/smart-collect/third-party-validation) document for more details.
