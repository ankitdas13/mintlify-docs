...
description: "Using Smart Collect, you can create unique UPI IDs to be shared with your customers. The structure and components of these are explained below."
---
