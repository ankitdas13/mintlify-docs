...
description: "All payments made using Smart Collect will show up on your Dashboard as well as in the usual payment response APIs, as payments made with method `bank_transfer`."
---

## Webhooks
Payments made using this method will also trigger webhooks much like regular payments. To use webhooks, refer our [Webhooks](/webhooks) documentation.
