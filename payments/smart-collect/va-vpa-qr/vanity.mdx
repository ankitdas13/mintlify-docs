...
To enable Vanity Accounts for your account, contact our [support](https://razorpay.com/support/), with the desired merchant [handle](/payments/smart-collect/va-vpa-qr/vanity#handle).
