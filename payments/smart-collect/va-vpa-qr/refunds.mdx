---
title: "Refunds"
description: "You can create refunds for the payments received on a virtual account. Refunds are generally processed within 3-5 business days via the same mode used by your customer. The platform fee and GST charged on successful transactions will not be reversed in the case of refunds."
---

You can initiate refunds from the [Dashboard](/payments/smart-collect/va-vpa-qr/dashboard/refund) or using [APIs](/payments/smart-collect/va-vpa-qr/api/refunds).
