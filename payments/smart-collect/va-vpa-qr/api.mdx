...
description: "The Smart Collect APIs enable you to create Customer Identifiers, fetch details of payments made and also close the Customer Identifiers."
---

## Prerequisite

Ensure you have read the [product document](/payments/smart-collect/va-vpa-qr) before you proceed with the API integration.
...
- [Create a customer](/api/customers) (optional)
- [Create a Customer Identifier](/payments/smart-collect/va-vpa-qr/api/create)
- Share Customer Identifier details with customer
- [Setup webhooks to receive payment notifications](/payments/smart-collect/va-vpa-qr/notification) (optional)
...
`customer_id`
: `string` Unique identifier of the customer the virtual account is linked with. Refer the [Customer API](/api/customers) section to learn more.
