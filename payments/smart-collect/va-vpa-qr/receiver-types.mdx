---
title: "API Endpoints"
description: "Base URL: `https://api.razorpay.com/v1/`"
---
...
The request format for virtual account creation recently underwent a change, and the updated format can be found [here](/payments/smart-collect/va-vpa-qr/api). The request format given below will eventually be deprecated.
...
With the exception of the `Create` API, the request format for all other API endpoints remains the same, and can be checked [here](/payments/smart-collect/va-vpa-qr/api).
