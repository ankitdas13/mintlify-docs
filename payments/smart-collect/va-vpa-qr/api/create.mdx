...
description: "You can create a new virtual bank account, virtual UPI ID or QR code using this API. You can choose to link it to a specific customer."
---
...
`notes` _optional_
: `json object` Any custom notes you might want to add to the virtual account can be entered here. Refer to the [Notes section of the API Reference Guide](/api/understand#notes) to learn more.
