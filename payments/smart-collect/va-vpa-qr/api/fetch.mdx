...
description: "You can retrieve details of Customer Identifiers and payments made to Customer Identifiers using these APIs."
---

APIs are available to:
- [Fetch Customer Identifier by ID](/payments/smart-collect/va-vpa-qr/api/fetch#fetch-virtual-account-by-id)
- [Fetch All Customer Identifiers](/payments/smart-collect/va-vpa-qr/api/fetch#fetch-all-virtual-accounts)
- [Fetch Payments made to a Customer Identifier](/payments/smart-collect/va-vpa-qr/api/fetch#fetch-payments-made-to-a-virtual-account)
- [Fetch Payment Details using ID and Transfer Method](/payments/smart-collect/va-vpa-qr/api/fetch#fetch-payment-details-using-id-and-transfer-method)
...
The response parameters are the same as those mentioned in [Fetch a Payment API](/api/payments/fetch-with-id).
...
- `closed`
    ...
    `customer_id`
    : `string` The unique identifier of the customer the virtual account is linked with. For more details, refer to the [Customers API](/api/customers).
