...
description: "You can process refunds for a payment made towards a Customer Identifier. The following endpoint refunds a payment using the payment ID."
---
...
`notes` _optional_
: `json object` Array of notes fields. You can enter custom data in key-value pairs. Refer the [Notes section of the API Reference](/api/understand#notes) documentation to learn more.
...
`currency`
: `string` The currency in which the payment is made. We support [international currencies](/payments/international-payments#supported-currencies).
...
Refer [Refunds API](/api/refunds) to perform other refund-related operations:
