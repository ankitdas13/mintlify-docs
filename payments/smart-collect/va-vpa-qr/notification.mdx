---
title: "Notifications"
description: "All payments made using Smart Collect will show up on your Dashboard as well as in the usual payment response APIs."
---

## Webhooks

Payments made using Smart Collect will also trigger webhooks much like regular payments. To use webhooks, refer our [Webhooks](/webhooks) documentation.
