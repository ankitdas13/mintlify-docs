...
description: "To continue delivering the best services, we are switching our banking partner in Smart Collect. This upgrade will help us deliver a superior experience with bank transfers."
---
...
<Steps>
<Step title="Step 1">
All active Customer Identifiers will be migrated from RBL Bank to Axis Bank within 2 days from the date of confirmation from your side.
1. The Bank Account number will stay the same.
2. The IFSC code will be changed to `UTIB000RAZP`.
</Step>
<Step title="Step 2">
All new Customer Identifiers will be created with Axis Bank as the banking partner.
</Step>
<Step title="Step 3">
Inform your customers using your Customer Identifiers about the newly migrated Customer Identifier details, which retains the same bank account number but features an updated IFSC code.
</Step>
</Steps>
