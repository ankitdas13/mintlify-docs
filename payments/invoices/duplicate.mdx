...
description: "You can duplicate an existing invoice to save time and reduce errors."
---
...
1. Click on **Invoices**.
1. Search for the invoice for which you want to create a duplicate copy using the [search criteria](/payments/invoices/search).
