...
Know more about [List of supported international currencies.](/payments/international-payments#supported-currencies/)
...
Click **All Invoices** on the top ribbon to view the newly created invoice in the list of all the invoices. Know more about [invoice states](/payments/invoices/states).
...
**Read More**: Know more about [customers](/payments/customers).
...
[this](/api/payments/invoices#create-an-invoice/) API.
However, you can create only non-GST invoices using this API.

## What Next
If you have saved the invoice as `draft`, you should next [issue it](/payments/invoices/issue) to the selected customer to receive payments. You can also choose to do any one of the following actions:

- [Update invoice](/payments/invoices/update)
- [Duplicate invoice](/payments/invoices/duplicate)
- [Delete invoice](/payments/invoices/delete)

### Related information
- [Invoices](/payments/invoices)
- [Invoice States](/payments/invoices/states)
- [How Invoices Work](/payments/invoices/how-it-works)
- [Download or Print an Invoice](/payments/invoices/download-print)
