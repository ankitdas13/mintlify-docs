...
description: "Items are products or services that you can add to [Invoices](/payments/invoices) and charge to customers. You can create an item on your Dashboard from **Invoice** → **Items**. Once created, it appears on the list of items in the Dashboard."
---
