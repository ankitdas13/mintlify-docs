...
description: "A dispute is a situation where a customer or the issuing bank questions the validity of payments. It may arise due to unauthorised charges, failure to deliver the promised merchandise or excessive charges levied by the business."
---
...
2. You will be [notified about the dispute.](/payments/disputes#notifications)
    ...
    - [Contest the dispute by submitting evidence](/payments/disputes/submit-evidence) to prove that the transaction was fair.
...
- **Webhooks**
You can [subscribe to Webhook events](/payments/disputes/dashboard#subscribe-to-webhook-events) to receive alerts whenever a dispute is created or there is a change in status.
...
- [View disputes](/payments/disputes/dashboard#view-disputes-using-dashboard)
- [Accept disputes](/payments/disputes/dashboard#accept-disputes-using-dashboard)
- [Contest disputes and submit evidence](/payments/disputes/dashboard#contest-disputes-using-dashboard)
- [Subscribe to Webhook Events related to disputes](/payments/disputes/dashboard#subscribe-to-webhook-events)
...
- [Dispute APIs](/payments/disputes/apis)
