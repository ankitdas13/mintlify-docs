...
description: "To enable Razorpay - Payments on WhatsApp:"
---
...
<Step title="Step 2">
Create a **Direct Pay Method**.
</Step>
<Step title="Step 3">
On the form, fill in details and give the method a name. This will be used to make API calls.
</Step>
<Step title="Step 4">
Select **Payment Gateway** as the option and choose **Razorpay** in the drop-down menu. 
</Step>
<Step title="Step 5">
On submission, you will be redirected to Razorpay. Log in and allow Meta to request payments on your behalf.
</Step>
</Steps>
...
<Steps>
<Step title="Step 1">
The BSP logs in to WhatsApp Manager.
</Step>
<Step title="Step 2">
Creates a **Direct Pay Method** and selects **Razorpay** as the payment gateway.
</Step>
<Step title="Step 3">
Shares the link generated with the business that will redirect them to Razorpay.
</Step>
<Step title="Step 4">
The business logs in and allows Meta to request payments on their behalf. The business must log in using the Facebook Business Manager account linked to the WABA.
</Step>
</Steps>
