...
description: "Given below is the high-level migration process."
---
...
- `false` (default): QR Code will accept any amount.
        ...
        **API Reference Links**
        - BharatQR: [Create a virtual account](/payments/payment-methods/bharatqr/api#create)
        - QR Code: [Create a QR Code](/api/qr-codes#create-a-qr-code)
        ...
        **API Reference Links**
        - BharatQR: [Close a virtual account](/payments/payment-methods/bharatqr/api#close)
        - QR Code: [Close a QR Code](/api/qr-codes/close)
        ...
        **API Reference Links**
        - BharatQR: [Fetch all virtual accounts](/payments/payment-methods/bharatqr/api#fetch-all-payments)
        - QR Code: [Fetch all QR Codes](/api/qr-codes/fetch-all)
        ...
        **API Reference Links**
        - BharatQR: [Fetch a virtual account](/payments/payment-methods/bharatqr/api#fetch-a-payment)
        - QR Code: [Fetch a QR Code](/api/qr-codes/fetch-with-id)
        ...
        **API Reference Links**
        - BharatQR: [Fetch payments by id](/payments/payment-methods/bharatqr/api#fetch-a-payment)
        - QR Code: [Fetch payments made to a QR Code](/api/qr-codes/fetch-payments)
...
---
QR Code created | [virtual_account.created](/webhooks/smart-collect#virtual-account-created) | [qr_code.created](/payments/qr-codes/subscribe-to-webhooks#qr-code-created)
---
QR Code credited | [virtual_account.credited](/payments/payment-methods/bharatqr/notification#webhooks) | [qr_code.credited](/payments/qr-codes/subscribe-to-webhooks#qr-code-credited)
---
QR Code closed | [virtual_account.closed](/webhooks/smart-collect#virtual-account-closed) | [qr_code.closed](/payments/qr-codes/subscribe-to-webhooks#qr-code-closed)
