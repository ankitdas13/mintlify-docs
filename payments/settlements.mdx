...
- Your account must be fully activated for payments to be settled to your bank account. Know more about [KYC Verification](/payments/set-up#2-submit-kyc-details).
- The payment must be captured. Know more about [capturing payments](/payments/payments/capture-settings).

## Settlement Cycle

We automatically settle captured payments to the bank account you submitted to us during your [KYC verification](/payments/set-up#2-submit-kyc-details) following our settlement cycle. The settlement cycle is subject to bank approval and can vary based on your business vertical, risk factors and so on.
...
Razorpay allows you to accept payments in any of the [supported international currencies](/payments/international-payments#supported-currencies).
...
- [View settlement details](/payments/settlements/dashboard#view-settlements-using-dashboard)
- [Check settlements break-up](/payments/settlements/dashboard#settlements-break-up-description)
- [Enable settlements on hold](/payments/settlements/dashboard#enable-settlements-placed-on-hold)
- [View reports related to settlements](/payments/settlements/dashboard#reports)

### Related Information

- [Settlements APIs](/payments/settlements/apis)
