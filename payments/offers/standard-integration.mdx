...
description: "After creating [offers](/payments/offers/create) from the Dashboard, you have to integrate them on Razorpay Standard Checkout so that your customers can avail them while making payments."
---
...
---
**Amount Match** | Order amount should be more than or equal to the [Minimum Order Amount](/payments/offers/create#instant) set in an offer.
---
...
You can [create offers](/payments/offers/create#create-offers) from the [Dashboard](/payments/offers/create).
...
Create an order using the [Orders API](/api/orders). Depending on the method, you can pass specific offers in the request or let Razorpay apply the default offers automatically.
...
For a complete list of response parameters, refer to the [Create an Order API](/api/orders/create)
...
- [Disable Offers](/payments/offers/create#disabling-offers)
