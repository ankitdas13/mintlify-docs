...
description: "No Cost EMI is an offer by which your customer pays the EMI provider only the product price, which is equally divided over the repayment timeline. Know more about [No Cost EMIs](/payments/payment-methods/emi/no-cost-emi) as a Razorpay payment method."
---
...
- [Create No Cost EMI Offers from the Dashboard](/payments/offers/no-cost-emi/create)
- [Integrate No Cost EMI Offers with Standard Checkout](/payments/offers/no-cost-emi/standard-integration)
- [Tutorial on How to Create No Cost EMI Offers](/payments/offers/no-cost-emi/tutorial)
