...
<Step title="Step 2">
[Fetch all Offers](#step-2-fetch-all-offers).
</Step>
<Step title="Step 3">
[Create Orders to include the Offers in the payment request](#step-3-create-an-order).
</Step>
<Step title="Step 4">
[Validate Offers](#step-4-validate-offers).
</Step>
<Step title="Step 5">
[Fetch Orders](#step-5-fetch-orders).
</Step>
<Step title="Step 6">
[Create a Payment](#step-6-create-a-payment).
</Step>
<Step title="Step 7">
[Verify the Payment](#step-7-verify-the-payment).
</Step>
</Steps>

### Step 1: Create Offers

[Create an offer](/payments/offers/create) from the Dashboard.
            ...
            : `object` Criteria that qualify transactions for the offer.
                ...
                : `object` Filters on payment methods and instruments. For example, `issuer`, `apps` or `vpa`.
                    ...
                    : `object` Details of wallet payment method. 
                        ...
                        `providers`
                        : `string` List of supported wallet providers. For example, [Wallet providers](/payments/payment-methods/wallets#supported-wallets).
