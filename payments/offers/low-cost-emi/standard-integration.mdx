...
description: "After creating [Low Cost EMI Offers](/payments/offers/low-cost-emi/create) from the Dashboard, you have to integrate them with Razorpay Standard Checkout so that your customers can avail them while making payments."
---
...
---
**Amount Match** | Order amount should be more than or equal to the [Minimum Order Amount](/payments/offers/low-cost-emi/create) set in an offer.
--- 
...
This is the easiest way to display Low Cost EMI offers at the Checkout. While [creating the Low Cost EMI offer](/payments/offers/low-cost-emi/create) from the Dashboard, enable the **Show Offer on Checkout** option.
...
You can [create Low Cost EMI offers](/payments/offers/create#create-offers) from the Dashboard.
...
- [Disable Offers](/payments/offers/low-cost-emi/create#disabling-low-cost-emi-offers)
