...
You can decide the cost to subvent for each EMI tenure while [creating an offer](/payments/offers/low-cost-emi/create) and the customer bears the remaining cost. This approach ensures that customers enjoy the benefits of EMI at an affordable cost, helping you minimise the overall cost.
...
You can create a Low Cost EMI offer from the [Dashboard](/payments/offers/create).
...
This is mandatory only in cases where you want to associate an offer or offers with the Order or you had not selected the [Show Offer on Checkout](/payments/offers/create#offer-validity) while creating the offer from the Dashboard.
...
### Related Information
- [About Low Cost EMI Offers](/payments/offers/low-cost-emi)
- [Create Low Cost EMI Offers](/payments/offers/low-cost-emi/create)
