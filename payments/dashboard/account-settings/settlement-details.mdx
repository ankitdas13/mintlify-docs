...
description: "You can view details regarding your settlement cycle and next settlement date on the Dashboard."
---
...
<Step title="Step 2">
Navigate to **Account & Settings → Settlement details**.
</Step>
<Step title="Step 3">
You will see balance cards for each channel type such as:
</Step>
</Steps>
