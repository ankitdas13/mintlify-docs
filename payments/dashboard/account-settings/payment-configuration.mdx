...
description: "Perform multiple configurations related to the payment methods and instruments that you want to show on your checkout page."
---
...
- You can hide, show, create custom blocks and rearrange payment methods and instruments as required, but you cannot enable or disable them from this setting. Know more about how to [enable/disable payment methods](/payments/dashboard/account-settings/payment-methods#enable-payment-methods).
...
<Steps>
<Step title="Step 1">
Identify the configuration you want to set as default and click on the options icon → **Save as Default**. Click **Save all changes**. 
</Step>
<Step title="Step 2">
Once saved, this configuration will be displayed to your customers at checkout.

</Step>
<Step title="Step 3">
All the changes will reflect on the **Checkout** page, **Invoices**, **Payment Button**,   **Webstore**, **Payment Links** and **Payment Pages**.
</Step>
<Step title="Step 4">
Share the Configuration ID with your developer to integrate this setup. You can also define conditions for displaying this configuration to a particular set of customers by using the Configuration ID.
</Step>
</Steps>
