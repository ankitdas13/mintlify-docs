...
description: "Check the available payment methods, enable and disable payment methods or request for new payment methods."
---
...
- You can also accept [international payments](/payments/international-payments#get-started).
...
The **Additional details required** tab must be updated to request any payment method.
         ...
         4. Fill in the business website/app details and click **Proceed to update website/app**. Know more about [how to add website details](/payments/dashboard/account-settings/business-website-details).
         5. Fill in the GSTIN details and click **Submit**. Know more about [how to add GSTIN details](/payments/dashboard/account-settings/gst-details).
...
<Step title="Step 2">
Click any payment method under **Payment methods**.
</Step>
<Step title="Step 3">
You can view the list of payment methods and providers and their status.
</Step>
</Steps>
...
<Steps>
<Step title="Step 1">
On the Dashboard, navigate to **Account & Settings → Payment Methods**.
</Step>
<Step title="Step 2">
Look for the payment method you requested and click **Update Request Form**.
</Step>
<Step title="Step 3">
Provide the requested clarifications.
</Step>
<Step title="Step 4">
Fill in the required details, add attachments if requested, and click **Submit Form**.
</Step>
<Step title="Step 5">
The status of your request changes from **Action Required** to **Reinitiated**.
</Step>
</Steps>
