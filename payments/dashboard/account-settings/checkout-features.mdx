...
description: "Customise your checkout experience on the Dashboard by setting a default language, enabling email collection , activating flash checkout, making the summary page mandatory and adding a custom banner message to enhance customer engagement."
---
...
- All the below changes will reflect on [Checkout page](/payments/payment-gateway),  [Invoices](/payments/invoices), [Payment Button](/payments/payment-button),   [Webstore](/payments/webstore),  [Payment Links](/payments/payment-links) and [Payment Pages](/payments/payment-pages).
...
[FAQs](/payments/dashboard/faqs#checkout-settings)
