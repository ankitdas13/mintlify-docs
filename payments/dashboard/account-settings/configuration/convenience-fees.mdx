...
<Step title="Step 2">
You select the **Convenience Fee Model** option on the **Settings** → **Fee Bearer** section of the Dashboard.
...
<Step title="Step 4">
The checkout pop-up page is displayed.
</Step>
<Step title="Step 5">
