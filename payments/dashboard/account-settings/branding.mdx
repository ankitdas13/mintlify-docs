---
title: "Branding"
description: "You can modify the Checkout to reflect your brand colour and logos. You can also make customer email an optional field on Checkout. These configurations can be done on the Dashboard."
---
