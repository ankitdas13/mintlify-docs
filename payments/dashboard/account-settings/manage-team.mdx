---
title: "Manage Team"
description: "Manage your team of users who can access the Dashboard. You can provide specific access to a user or a set of users."
---
...
- Use the [Dispute Manager](/payments/dashboard/account-settings/manage-team#dispute-manager) role for team members who only need to handle chargebacks without access to refunds or bank details.
- Use the [Pseudo Owner](/payments/dashboard/account-settings/manage-team#pseudo-owner) role sparingly for trusted individuals who need to manage the account when the Owner is unavailable.
- Use the [View-Only](/payments/dashboard/account-settings/manage-team#view-only-auditor) role for auditors and stakeholders who need visibility without operational access.
