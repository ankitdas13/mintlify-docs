...
description: "Use the Dashboard to add and manage linked accounts, transfer funds to them and initiate reversals in case of refunds to customers."
---
...
For more details, refer to the [Linked Account Dashboard](/payments/route/linked-account#grant-dashboard-access-to-linked-accounts) documentation.
...
<Step title="Step 2">
Under **PAYMENT PRODUCTS**, navigate to **Route** → **Transfers**.
</Step>
<Step title="Step 3">
Click **+Create Direct Transfer**.
...
<Step title="Step 3">
The refund transfer takes place from your primary account. Hence, you must create a corresponding reversal for the linked account. This can be done manually, or you may use the **Reverse all Route Transfers as well** option for automatic reversal.
</Step>
<Step title="Step 4">
In the dialog box that appears, confirm refund by clicking **Yes, Refund**.
</Step>
</Steps>
...
<Steps>
<Step title="Step 1">
Under the **Transfers** tab, click the relevant **Transfer ID**.
</Step>
<Step title="Step 2">
...
<Step title="Step 3">
In the dialog box that appears, confirm reversal by clicking **Yes, Reverse**.
</Step>
</Steps>
...
<Steps>
<Step title="Step 1">
Under the **Transfers** tab, select the **Period** - Daily or Monthly and choose the date or month.
</Step>
<Step title="Step 2">
Select the file format - You can choose CSV, XLSX or XLS formats.
</Step>
<Step title="Step 3">
Click **Download Report** or get it emailed to your registered email address by clicking **Email Report**.
</Step>
</Steps>
...
<Steps>
<Step title="Step 1">
Under the **Reversals** tab, select the **Period** - Daily or Monthly and choose the date or month.
</Step>
<Step title="Step 2">
Select the file format - You can choose CSV, XLSX or XLS formats.
</Step>
