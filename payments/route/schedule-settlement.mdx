...
description: "You can assign a settlement schedule for your linked accounts and update it anytime. By default, every new Linked Account is created with the same settlement schedule assigned to your main account."
---
