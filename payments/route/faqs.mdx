...
### 1. How can I transfer money to customers?
         ...
         **To use Route from the Dashboard**:
         ...
         You can also use [Route Transfers APIs](/api/payments/route) to transfer money.
...
### 2. How can I track the status of transactions initiated using Route?
         ...
         The transfer is processed asynchronously and on success, `transfer.processed` webhook is sent (if enabled). Know more about [setting up Webhooks](/payments/route/subscribe-to-webhooks).
...
### 3. How can I track the status of funds transferred to linked accounts?
         ...
         Know more about [setting up Webhooks](/payments/route/subscribe-to-webhooks).
...
### 4. Can you reverse a transfer?
         ...
         **To create a reversal from the Dashboard**:
         ...
         5. Go to **Route** → **Transfers**. Click on a **Transfer id** to view the details. Click on the **Create Reversal** button to reverse the transfer.
                - You can also use the [Reverse Transfers from all Linked Accounts API](/api/payments/route/reverse-a-transfer) to reverse money transfer.
                - You can also [refund payment and simultaneously reverse](/api/payments/route/refund-payments-and-reverse-transfer) all the transfers made on that payment.
...
### 10. How do I create linked accounts using bulk upload?
         ...
         You can create linked accounts using bulk upload from the Dashboard. Know more about [Batch Upload](/payments/route/batch-upload).
...
### 15. How do I transfer funds using the Route API after accepting a payment via a Razorpay Payment Link?
        ...
        Know more about the [Create Transfers from Payments API](/api/payments/route/create-transfers-payments).
...
### 16. What are the different fees involved when splitting a payment using Razorpay Route?
        ...
        For detailed calculation examples, refer to our [Transfers and Related Fees Examples](/payments/route/transfer-fees-example) page.
...
### 9. How many Linked Accounts can I create in bulk for Penny Testing?
         ...
         You can upload 50,000 rows in one go with 11 MB as the max file size using the [Bulk Upload](/payments/route/batch-upload#create-linked-accounts-via-batch-upload) feature. Below is the expected TAT:
