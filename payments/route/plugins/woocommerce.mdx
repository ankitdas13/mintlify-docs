---
title: "Razorpay Route for WooCommerce"
description: "Use Razorpay Route on your WooCommerce website to split payments received using the Razorpay Payment Gateway and transfer the funds to Linked Accounts. Razorpy Route is available in the [Razorpay Payment Gateway for WooC"
---
...
- Integrate your [WooCommerce website](/payments/payment-gateway/ecommerce-plugins/woocommerce) with the Razorpay Payment Gateway plugin.
- Create [Linked Accounts](/payments/route/linked-account#create-linked-accounts) to split the received payments.
