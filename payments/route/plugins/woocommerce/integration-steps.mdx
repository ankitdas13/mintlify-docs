...
description: "Follow these steps to integrate Razorpay Route on your WooCommerce-enabled WordPress website:"
---
...
### 1.3 Enable Webhooks on the Dashboard
            ...
            [Enable Webhooks](/webhooks/setup-edit-payments#set-up-webhooks) to receive notifications for these events.
...
###  1.6 Verify Payment Status
                ...
                1. Log in to the **WordPress Admin Dashboard** and navigate to **Razorpay Route woocommerce** → **Payments**.
                2. Check if a **Payment Id** has been generated and note the status. In case of a successful payment, the status is marked as **Captured**. Know more about various [payment states](/payments/payments#payment-life-cycle).
...
- Ensure you have entered [Test Mode API keys](/api/authentication#generate-api-keys) in the Checkout code.
...
### 3.2 Generate an API Key in Live Mode
         ...
         Watch this video to generate an API Key in Live Mode.
            ...
            You have successfully generated your API keys in Live Mode. Use this pair of `Key_ID` and `Key_Secret` to accept payments from your customers and route them to the involved third parties using [Route](/payments/route).
