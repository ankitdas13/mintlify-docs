...
Know more about:
- Creation of [Account Code for linked accounts on the Dashboard](/payments/route/account-code/dashboard).
- Usage of [Account Code in Transfers API](/payments/route/account-code/api).

### Related Information

- [Route Product Documentation](/payments/route)
- [Route API Reference](/api/payments/route)
- [Route Dashboard Guide](/payments/route/batch-upload)
