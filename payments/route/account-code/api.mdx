...
description: "The `account_code` parameter must be passed only in Transfers API."
---
...
You can create and capture payments in the regular payments flow, using [Razorpay Checkout](/payments/payment-gateway/web-integration/standard) and [Payment APIs](/api/payments#capture-a-payment).
