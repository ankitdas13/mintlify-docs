...
description: "Businesses need to distribute payments across multiple recipients - marketplaces paying sellers, platforms sharing revenue with partners or companies managing vendor payments. Manual fund transfers and reconciliation create operational complexity."
---
...
### Features
        ...
        - [Process individual and bulk refunds](/payments/route/linked-account/initiate-refund).
        - [View reversals and settlements](/payments/route/linked-account/reversals-settlements).
        - [Manage profile and team members](/payments/route/linked-account/manage-profile).
...
- **Settlement Timing**: Linked Account settlements take 2 working days, regardless of your primary settlement schedule.
        ...
        Create Linked Accounts programmatically using the [Route APIs](/api/payments/route) for automated onboarding and bulk operations.
...
Know more about [penny testing](/payments/route/faqs#penny-testing).
...
- [Route Overview](/payments/route)
- [Processing Refunds](/payments/route/linked-account/initiate-refund)
- [Settlements and Reversals](/payments/route/linked-account/reversals-settlements)
- [Profile Management](/payments/route/linked-account/manage-profile)
- [Route APIs](/api/payments/route)
