...
description: "The Linked Account users can initiate a refund for individual transaction levels or in batches from the Linked Account Dashboard. They can also make full and partial refunds to the customers."
---
...
The Linked Account holders must send an offline request to you to use [Refund Credits](/payments/route/linked-account#enable-refund-credits). Upon gaining access, funds can be transferred to the Refund Credits pool through the account number that you share.
...
You can initiate the following types of refunds from the Linked Account: [Individual Refund](/payments/route/linked-account/initiate-refund#individual-refunds), [Full Refund](/payments/route/linked-account/initiate-refund#full-refund), [Partial Refund](/payments/route/linked-account/initiate-refund#partial-refund) and [Batch Refund](/payments/route/linked-account/initiate-refund#batch-refunds).
...
- [Manage Profile and Team](/payments/route/linked-account/manage-profile)
