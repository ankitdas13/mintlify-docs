...
description: "Generate and process Linked Accounts and Transfers in bulk (batches) by uploading a batch file in the Dashboard. This simplifies the process of creating these individually."
---
...
<Steps>
<Step title="Step 1">
Download the sample file from the Dashboard.
</Step>
<Step title="Step 2">
Update the file with the required information.
</Step>
<Step title="Step 3">
Upload the file back to the Dashboard.
</Step>
</Steps>
...
- [Create Linked Accounts](/payments/route/batch-upload#create-linked-accounts-via-batch-upload)
- [Create Transfers](/payments/route/batch-upload#create-transfers-via-batch-upload)
...
1. Update and save the file with the following details. Refer to the [Linked Accounts Batch Fields](/payments/route/batch-upload#linked-account-batch-fields) section for more information.
    - `account_name`
    - `account_email`
    - `dashboard_access`
    - `customer_refunds`
...
[Route FAQs](/payments/route/faqs)
