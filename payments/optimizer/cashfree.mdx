---
title: "Cashfree"
description: "Follow the steps below to onboard Cashfree as a payment provider."
---
...
Cashfree supports [Third-Party Validation (TPV)](/payments/optimizer/third-party-validation#supported-bank-gateways-payment-gateways-and-payment-methods).
...
You might be generating a unique Order ID or Receipt for every order which can be passed to Cashfree via [Orders API](/api/orders#orders-api). 
...
<Step title="Step 2">
Razorpay passes this value to Cashfree in `orderNote` parameter.
</Step>
<Step title="Step 3">
Write to your Cashfree Relationship Manager to show the parameter `orderNote` in the Dashboard and reports as per your use case.
</Step>
</Steps>
