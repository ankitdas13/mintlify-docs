...
Once your payment provider is added successfully, you can [view](/payments/optimizer/integration-audit#view-provider-details)  and [edit](/payments/optimizer/integration-audit#edit-provider-details) the provider details.
