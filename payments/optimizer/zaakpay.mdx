---
title: "ZaakPay"
description: "Follow the steps below to onboard ZaakPay as a payment provider."
---
...
ZaakPay supports [Third-Party Validation (TPV)](/payments/optimizer/third-party-validation#supported-bank-gateways-payment-gateways-and-payment-methods).
