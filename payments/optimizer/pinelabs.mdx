---
title: "PineLabs"
description: "Follow the steps below to onboard PineLabs as a payment provider."
---
...
You might be generating a unique Order ID or Receipt for every order which can be passed to PineLabs via [Orders API](/api/orders#orders-api).
...
<Step title="Step 2">
Razorpay passes this value to PineLabs in the `udf_data.udf_field_1` parameter.
</Step>
<Step title="Step 3">
Write to your PineLabs Relationship Manager to show the parameter `udf_data.udf_field_1` in the Dashboard and reports as per your use case.
</Step>
</Steps>
