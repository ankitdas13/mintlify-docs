---
title: "Paytm S2S"
description: "Follow the steps below to onboard Paytm Server-to-Server as a payment provider."
---
...
<Step title="Step 3">
Write to your Paytm support team to show the parameter `extendInfo.udf1` in the Dashboard and reports as per your use case.
</Step>
</Steps>
