---
title: "PayU"
description: "Follow the steps below to onboard PayU as a payment provider."
---
...
### Route EMI Transactions
            ...
            5. Click **Add Another Condition** and enter the following rule:
                ...
                - **Select Connection**: Select **Equal to**.
                - **Select Comparing Value**: Select **the EMI Duration** as per your requirement, and click **Next**. Know more about [EMI durations](/payments/optimizer/supported-gateways-aggregators#emi) for PayU EMI.
...
Given below is the list of card networks and payment gateways that support the CVV-less feature on Optimizer.
        ...
        8 | Emandate | Live
        ---
        9 | [Sodexo](/payments/payment-methods/sodexo) | Live
        ...
        S No. | Payment Methods | Availability
        ---
        1 | [Emandate](/payments/recurring-payments/emandate/integrate) | Live
        ---
        2 | [Cards](/payments/recurring-payments/cards/integrate) | Live
        ---
        3 | UPI Autopay | Live
...
PayU supports [Third-Party Validation (TPV)](/payments/optimizer/third-party-validation#supported-bank-gateways-payment-gateways-and-payment-methods).
...
You might be generating a unique Order ID or Receipt for every order which can be passed to PayU via [Orders API](/api/orders#orders-api). Follow the steps given below for your order id to be visible on the PayU Dashboard:
...
<Step title="Step 2">
Razorpay passes this value to PayU in the `udf1` parameter.
</Step>
<Step title="Step 3">
Write to your PayU Relationship Manager to show the parameter `udf1` in the Dashboard and reports as per your use case.
</Step>
</Steps>
