...
description: "You can set a specific fee for each payment gateway used for payments made through Optimizer. This allows you to charge an additional fee to your customers, helping you recover costs such as online payment gateway charges."
---
...
<Steps>
<Step title="Step 1">
The customer selects an item on your website/Payment Link/Payment Page and clicks the pay button.
</Step>
<Step title="Step 2">
The checkout pop-up page is displayed. The customer selects the payment method and the payment gateway through which they want to make the payment.

</Step>
<Step title="Step 3">
The **Fee Breakup** page containing the Convenience Fee appears, and the customer clicks **Continue and pay**.
</Step>
<Step title="Step 4">
The customer is redirected to the payment success screen.
</Step>
</Steps>
...
All Optimizer gateways support the Customer Fee Bearer feature. Know more about the [gateways supported by Optimizer](/payments/optimizer/supported-gateways-aggregators).
...
- [Collect Standard Convenience Fee](/payments/optimizer/convenience-fees)
