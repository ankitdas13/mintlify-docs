...
description: "You can create a set of custom rules for transactions using different parameters such as payment method, card type, and so on. Also, you can add gateways in priority order and split traffic between gateways."
---
...
Watch this short video of how you to route your transactions for [Turbo UPI](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi) using Optimizer.
...
Below is an example of how you can route your transactions for [Turbo UPI](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi) using Optimizer:
<Steps>
<Step title="Step 1">
