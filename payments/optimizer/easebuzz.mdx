---
title: "Easebuzz"
description: "Follow the steps below to onboard Easebuzz as a payment provider."
---
...
- Easebuzz supports [Third-Party Validation (TPV)](/payments/optimizer/third-party-validation#supported-bank-gateways-payment-gateways-and-payment-methods).
