...
description: "Go live with your PayU Payment Gateway account instantly using the **Instant** integration mode."
---
...
### Prerequisites
         ...
         - [Configure the required webhooks](/payments/optimizer/payu-instant#to-configure-a-webhook).
...
---
[Sodexo](/payments/payment-methods/sodexo) | Coming Soon

## Send Receipt/Order ID to External Gateway
You might be generating a unique Order ID or Receipt for every order which can be passed to PayU via[Orders API](/api/orders#orders-api). 
