...
### Configure PayLater (Simpl) as a payment method
         ...
         3. Look for **Simpl** and click **Request**. Know more about [how to request for a payment method](/payments/dashboard/account-settings/payment-methods#request-for-payment-methods).
