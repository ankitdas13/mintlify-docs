---
title: "Bank Gateways"
description: "You can add banks as payment providers on the Razorpay Dashboard. Check the banks supported by Optimizer and the steps to add them as payment providers."
---
