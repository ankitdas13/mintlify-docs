...
description: "It is not possible to create a static QR code that you can print to accept offline payments from your customers. You can create a one-time, non-reusable dynamic QR code to accept digital payments from your customers."
---
