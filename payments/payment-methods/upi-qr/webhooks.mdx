...
description: "You can be notified of the events related to virtual accounts and payments by subscribing to the Webhooks available on the Dashboard."
---
...
- [Validate Signature](/webhooks#validation)
