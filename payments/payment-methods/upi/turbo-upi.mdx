...
- [Onboarding Flow](/payments/payment-methods/upi/turbo-upi#onboarding-flow)
- [Transactional Flow](/payments/payment-methods/upi/turbo-upi#transactional-flow)
- [Non-Transactional Flow](/payments/payment-methods/upi/turbo-upi#non-transactional-flow)
...
<Steps>
<Step title="Step 1">
The customer navigates to your app's checkout screen and taps **+Link bank account**.
...
<Step title="Step 3">
The customer is shown a list of banks from which they can select one.

</Step>
<Step title="Step 4">
This adds the customer's bank account. After the onboarding is complete the customer can also set up their UPI PIN. 

</Step>
<Step title="Step 5">
The customer can complete the payment using the newly added Bank account.
</Step>
</Steps>
...
Perform the following steps to integrate Turbo UPI:
     ...
     - [Android Integration](/payments/payment-gateway/android-integration/standard/payment-methods/turbo-upi)
     - [iOS Integration](/payments/payment-gateway/ios-integration/standard/payment-methods/turbo-upi)
    
    
     - [Android Integration](/payments/payment-gateway/android-integration/custom/payment-methods/turbo-upi)
     - [iOS Integration](/payments/payment-gateway/ios-integration/custom/payment-methods/turbo-upi)
