...
description: "The National Payments Corporation of India (NPCI) is sunsetting the UPI Collect flow to align with the latest ecosystem compliance standards and enhance transaction security. By supporting only UPI Intent flows (automati"
---
...
### 3. Will this impact Standard, Custom and S2S Checkout?
     ...
     - [Standard Integration](/announcements/upi-collect-migration/standard-integration).
     - [Custom Integration](/announcements/upi-collect-migration/custom-integration)
     - [S2S Integration](/announcements/upi-collect-migration/s2s-integration)
...
### 8. My UPI payments stopped working after UPI Collect was disabled. What should I do?
     ...
     If UPI Collect was disabled on your account and you have not enabled UPI Intent or QR code, your checkout may break and prevent customers from completing UPI payments.
            ...
            - Refer to the [Standard Checkout migration guide](/announcements/upi-collect-migration/standard-integration) for more information.
