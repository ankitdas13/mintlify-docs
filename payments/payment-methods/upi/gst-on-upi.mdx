...
description: "As per the 2020 circular issued by the Central Board of Indirect Taxes & Customs (CBIC), businesses meeting the eligibility conditions described below must pass GST information for UPI transactions:"
---
...
<Steps>
<Step title="Step 1">
[Make changes in Orders API integration](#step-1-make-changes-in-orders-api-integration).
</Step>
<Step title="Step 2">
[Handle API errors](#step-2-handle-api-errors).
</Step>
<Step title="Step 3">
[Make changes in webhook integration](#step-3-make-changes-in-webhooks-integration).
</Step>
</Steps>

### Step 1: Make Changes in Orders API Integration

To comply with the change, you should use the [Orders API](/api/orders/create) in your integration flow, along with the following additional parameters request parameters:
