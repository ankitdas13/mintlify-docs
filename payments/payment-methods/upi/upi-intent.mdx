---
title: "UPI Intent"
description: "You can make UPI payments easier for your customers by enabling UPI Intent on your application Checkout."
---
...
## Integrate on Android, iOS and Mobile Web
        ...
        Refer to the [list of supported UPI intent apps for Android SDK](/payments/payment-methods/upi/supported-apps).
        ...
        - [Generate API Keys](/payments/dashboard/account-settings/api-keys#generate-api-keys) from the Dashboard.
        ...
        1. Ensure that the [latest version of the iOS Standard SDK](/payments/payment-gateway/ios-integration/standard#list-of-razorpay-ios-standard-sdk-versions-last) is integrated with your app.
...
By default, the top PSP apps appear on the customer's mobile irrespective of the installation status of the UPI apps.
        ...
        - [Generate API Keys](/payments/dashboard/account-settings/api-keys) from the Dashboard.
        - Integrate Razorpay Standard Checkout on your [Website](/payments/payment-gateway/web-integration/standard).

        #### Standard Checkout

        UPI Intent for mobile websites works automatically if the intent flow is enabled on your account. You can enable UPI Intent in WebView on your [Android app](/payments/payment-gateway/web-integration/standard/webview/upi-intent-android)or [iOS app](/payments/payment-gateway/web-integration/standard/webview/upi-intent-ios).
