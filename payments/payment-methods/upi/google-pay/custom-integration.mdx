...
description: "To enable Google Pay at your Custom Checkout:"
---
...
1. You should have already integrated one of the following:
    - [Razorpay Web Integration - Custom Checkout](/payments/payment-gateway/web-integration/custom).
    - [Razorpay Android Integration - Custom Checkout](/payments/payment-gateway/android-integration/custom).
...
On desktop browsers, the Collect request flow works the same way as [Razorpay's UPI](/payments/payment-gateway/web-integration/custom/payment-methods#upi).
...
1. Add Razorpay.js to your website
    ...
    Know more about [Custom Web Integration](/payments/payment-gateway/web-integration/custom).
...
Refer to the [Success/Error Callbacks](/payments/payment-gateway/web-integration/custom/build-integration#14-store-fields-in-your-server) section for more details.
...
This is the same as the existing [UPI Collect Integration](/payments/payment-gateway/android-integration/custom/payment-methods#collect-flow).
