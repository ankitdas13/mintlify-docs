...
description: "You can use your existing Razorpay custom integration to accept payments via your app on the Google Pay Spot platform."
---
...
The checkout parameters are listed [here](/payments/payment-methods/upi/google-pay/spot-platform-integration/checkout-parameters).

#### Apply Offers

During checkout, if there is a co-branded offer run by GooglePay, you should apply the discount, and pass on the offer details to Google. Use [these offers parameters](/payments/payment-methods/upi/google-pay/spot-platform-integration/checkout-parameters#offers-parameters) to pass the offer details.
...
Know more about how to [set up Webhooks.](/webhooks)
