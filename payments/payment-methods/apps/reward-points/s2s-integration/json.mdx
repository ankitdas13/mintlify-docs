...
description: "You can enable your customers to pay using a combination of reward points and a payment method such as cards, netbanking, wallets or UPI, on your S2S integration."
---
...
<Step title="[Create a payment using the S2S JSON Payments API](#step-3-create-a...">
[Create a payment using the S2S JSON Payments API](#step-3-create-a-payment-using-s2s-json).
</Step>
