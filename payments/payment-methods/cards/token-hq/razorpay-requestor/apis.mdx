...
<Steps>
<Step title="[Token APIs](#1-token-apis).">
[Token APIs](#1-token-apis).
...
`customer_id`
: `string` This is the Razorpay customer id. You can create token for a specific customer using their customer id. Use the [Customers API](/api/customers) to create customer id.
...
- [Server-to-Server JSON V2 Integration](/payments/payment-gateway/s2s-integration/json/v2)
