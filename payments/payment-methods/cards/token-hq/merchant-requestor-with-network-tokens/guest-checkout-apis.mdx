...
description: "As per the latest RBI guidelines for Payment Acquirers (PA) and Payment Gateways (PG), guest checkout payments need to use an Alternate Identifier, known as Alt ID."
---
