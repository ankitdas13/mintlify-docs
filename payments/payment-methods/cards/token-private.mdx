...
`customer_id`
: The unique customer ID. To create a customer, refer the [Customer API](/api/customers) section.
...
All server-side requests must be authenticated with Basic Auth using the **key-id** as username and **key-secret** as password. You can acces your keys on your Dashboard. Know more about [API authentication](/api#authentication) to get started with Razorpay APIs.
