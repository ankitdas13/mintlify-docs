...
description: "Use this feature to let your customers to make payments on your Android app using cards they saved on Google Pay."
---
...
- You should have already integrated [Razorpay Standard Checkout](/payments/payment-gateway/android-integration/standard) on your Android app.
...
<Step title="Step 2">
[Update the Razorpay Standard Integration SDK](#step-2-update-razorpay-standard-integration-sdk)
</Step>
<Step title="Step 3">
