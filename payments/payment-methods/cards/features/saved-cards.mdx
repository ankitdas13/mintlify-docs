...
description: "Save your customers' card details with Razorpay using tokens. The next time the customer makes any transaction, they only need to enter the CVV of the previously saved card. This saves the customer the hassle of entering the card details multiple times for each transaction."
---

Know [how to integrate saved cards at Standard Checkout.](/payments/payment-methods/cards/features/integrate-saved-cards)
...
<Steps>
<Step title="Step 1">
Opens Razorpay Checkout and selects **Card** as the payment method.
</Step>
<Step title="Step 2">
Provides the card details.
</Step>
<Step title="Step 3">
While making a card payment, the customer can choose to:
...
<Steps>
<Step title="Step 1">
The customers log in to the Razorpay Checkout.
</Step>
<Step title="Step 2">
They select **Card** as the payment method.
</Step>
<Step title="Step 3">
They enter the OTP sent to their phone or use their fingerprint if [Biometric Authentication](/payments/payment-gateway/features) biometric authentication is set up, then click **Verify**.
</Step>
<Step title="Step 4">
They select the saved card, enter the CVV and click **Pay**.
</Step>
<Step title="Step 5">
We recommend that customers log out of Checkout after they complete the transaction. To do this, they must:
...
<Steps>
<Step title="Step 1">
Log in to the [Portal](https://razorpay.com/flashcheckout/manage/) using their **Mobile Number** and enter your **Email**. Click **Send OTP**.
</Step>
<Step title="Step 2">
Enter the **OTP** sent to their mobile number for verification and click **Verify**.
</Step>
<Step title="Step 3">
They can choose to select a card and delete the website/app on that particular card, or they can also select a website/app and delete the card on that particular website/app.
</Step>
</Steps>
