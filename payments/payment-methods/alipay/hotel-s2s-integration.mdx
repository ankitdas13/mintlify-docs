...
### Response Parameters
     ...
     `currency`
     : `string` The currency in which the transaction should be made. View the [list of supported currencies](/payments/international-payments#supported-currencies). Length should be of 3 characters.
