...
description: "Bajaj Pay Wallet is a secure digital wallet that simplifies everyday payments for your customers. Customers can pay bills on the go or easily initiate fund transfers from their phones."
---
...
<Step title="Step 4">
Click **Request** beside **Bajaj Pay Wallet**. 

</Step>
<Step title="Step 5">
A request form appears. Select the payment instrument to be enabled on your Checkout. Click **Save & Next**.
</Step>
<Step title="Step 6">
Fill in the required details and click **Save & Next**.
</Step>
</Steps>
...
<Step title="Step 3">
Select **Bajaj Pay** and click **Continue**.

</Step>
<Step title="Step 4">
Enter the **OTP** sent to their mobile number. In case of insufficient balance, click **Add Funds**.

</Step>
<Step title="Step 5">
The payment is completed if they have sufficient balance in the wallet.
</Step>
</Steps>
