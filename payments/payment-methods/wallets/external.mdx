...
description: "You can list external wallets (wallets not supported by Razorpay) on our Checkout form. Razorpay does not process payments for external wallets but hands over the control to you along with any other customer data entered in the checkout form."
---
...
To list external wallet on your web application, you need to first integrate our [checkout form](/payments/payment-gateway/web-integration/standard/integration-steps#checkout-options). After you integrate, follow the steps given below:
...
To list external wallets on your Android app, you need to first integrate our [Android checkout SDK](/payments/payment-gateway/android-integration/standard). After you integrate our Android checkout, follow the steps given below:
...
To list external wallet on your iOS app, you need to first set up your framework. Know more about[Razorpay iOS Integration](/payments/payment-gateway/ios-integration/standard). Perform the following steps:
