...
description: "Amazon Pay is a wallet-based payment method that allows customers with an Amazon account to make payments using their Amazon Pay balance. After Amazon Pay is enabled and integrated, it is listed on your website/app Checkout page as an option under the wallet payment method. Know more about[Amazon Pay](https://www.amazonpay.in/)."
---
...
The iOS integration for Amazon Pay is similar to the [Razorpay iOS Custom UI SDK](/payments/payment-gateway/ios-integration/custom) integration.
