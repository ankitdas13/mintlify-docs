...
description: "ACH Direct Debits are processed through the Automated Clearing House (ACH) payments system, which is operated by the National Automated Clearing House Association (NACHA)."
---
...
<Steps>
<Step title="Step 1">
The customer enters their contact details and clicks **Continue**.
</Step>
<Step title="Step 2">
They select **Bank Transfer**, enter personal details and address, and click **Continue**.

</Step>
<Step title="Step 3">
The customer enters bank details, selects either **Business account** or **Personal account**, and clicks **Pay Now**.
