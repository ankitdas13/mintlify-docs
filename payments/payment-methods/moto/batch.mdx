...
description: "You can use the MOTO (Mail-Order-Telephone-Order) payment method to charge a customer's credit card without CVV or 2-factor authentication."
---
...
<Steps>
<Step title="Step 1">
[Download sample batch file](#step-1-download-sample-batch-file).
</Step>
<Step title="Step 2">
[Fill in card and payment details](#step-2-fill-in-card-and-payment).
</Step>
<Step title="Step 3">
[Upload the filled batch file](#step-3-upload-the-filled-batch-file).
</Step>
<Step title="Step 4">
[Preview and confirm uploaded file](#step-4-preview-and-confirm-uploaded-file).
</Step>
<Step title="Step 5">
[View and download Batch Payment Report](#step-5-download-batch-payment-report).
</Step>
</Steps>
...
MOTO payments can also be processed using Razorpay token id if you are using tokenisation or a [saved card](/payments/payment-methods/cards/features/saved-cards) feature.
This is an on-demand feature. Please raise a request with our [Support team](https://razorpay.com/support/#request) to get this feature activated on your Razorpay account.
...
You can select any one of the [supported currencies](/payments/international-payments).
