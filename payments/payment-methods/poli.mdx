...
description: "Accept international payments from Australian customers using POLi, a popular payment method that enables customers to make payments directly from their bank accounts."
---
...
<Step title="Step 2">
Your customer opens Razorpay checkout and selects POLi as the payment method.
</Step>
<Step title="Step 3">
Razorpay redirects the customer to a POLi-hosted payment page with a list of available banks in their country.
</Step>
<Step title="Step 4">
...
- [Custom Integration](/payments/payment-methods/poli/custom-integration)
- [S2S Integration](/payments/payment-methods/poli/s2s-integration)  
