---
title: "GoPay"
description: "GoPay is part of the GoJek super app ecosystem, which is widely-used e-wallet in Indonesia, enabling you to accept payments directly from customers. With GoPay, customers can make secure and seamless transactions using their mobile devices."
---
...
- You can refund customer payments made using GoPay by following the usual [refunds](/payments/refunds) process.  
 
- GoPay payments take T+22 days to get settled to your Razorpay account.

### Supported Integrations

Secure [S2S integration](/payments/payment-methods/gopay/s2s-integration) for seamless payment processing.
