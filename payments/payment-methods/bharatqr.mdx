...
We have discontinued onboarding new users for BharatQR. The service is now limited to existing users only. If you are a new user, we encourage you to check out our alternative offering of [UPI QR Codes](/api/qr-codes#create-a-qr-code).
