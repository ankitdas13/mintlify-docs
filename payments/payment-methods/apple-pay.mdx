...
- Shopify, Mobile SDKs (Flutter, Native iOS, React Native) and Razorpay no-code solutions, such as [Payment Links](/payments/payment-links), [Payment Pages](/payments/payment-pages), [Payment Handles (razorpay.me)](/payments/mobile-app/accept-payments/razorpay-me) and [Invoices](/payments/invoices).
...
### 8. I am not able to verify my URL via the self-serve dashboard. What should I do?
    ...
    Follow the [Apple Pay documentation](/payments/payment-methods/apple-pay) and ensure the file is publicly accessible.
...
- [Apple Pay S2S Integration](/payments/payment-methods/apple-pay/s2s-integration)
- [Apple Pay Custom Integration](/payments/payment-methods/apple-pay/custom-integration)
