---
title: "eCOD"
description: "Using eCOD your delivery executives can accept digital payments from your customers instead of cash."
---
...
<Steps>
<Step title="Step 1">
The delivery executive shows the wallet list to the customer on the phone (delivery executive's phone).
</Step>
<Step title="Step 2">
A customer selects a wallet and enters the phone number.
</Step>
<Step title="Step 3">
The customer receives an SMS (customer's phone) from the wallet provider.
</Step>
<Step title="Step 4">
The customer enters the OTP on the delivery executive’s phone.
</Step>
<Step title="Step 5">
...
<Steps>
<Step title="Step 1">
The delivery executive selects UPI on the phone (delivery executive's phone).
</Step>
<Step title="Step 2">
The customer provides their VPA (Virtual payment address).
</Step>
<Step title="Step 3">
The customer receives a collect request on the phone (customer's phone).
</Step>
<Step title="Step 4">
The customer approves the collect request using MPIN.
</Step>
<Step title="Step 5">
The aayment is complete!
</Step>
</Steps>
...
<Steps>
<Step title="Step 1">
The customers notify the delivery executive that they want to make a payment on their device.
</Step>
<Step title="Step 2">
The delivery executive selects **Link Payments** on the phone (delivery executive's device).
</Step>
<Step title="Step 3">
The customer receives an SMS with a link. This link is a short link and is also visible on the delivery executive’s device in text as well as a QR format.
</Step>
<Step title="Step 4">
The customer can open the link on a computer or mobile.
</Step>
<Step title="Step 5">
The standard Razorpay Checkout form opens up using which the customer can pay using Card, Netbanking, Wallets or UPI.
</Step>
<Step title="Step 6">
The delivery executive receives a payment notification after the payment is complete.
</Step>
</Steps>
