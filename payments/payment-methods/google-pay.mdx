---
title: "Google Pay™"
description: "Google Pay™ is a secure, digital wallet payment method that allows customers to pay using cards stored in their Google Account or tokenised cards on Android devices. Once Google Pay is enabled and integrated, it appears on your Checkout page as a payment option, providing a frictionless checkout experience for international customers. Know more about [Google Pay](https://pay.google.com/)."
---
...
<Step title="Step 2">
If eligible for Dynamic Currency Conversion (DCC), the customer sees a currency selection screen. Select preferred currency (for example, INR or USD) and click **Pay with Google Pay** to proceed.
</Step>
<Step title="Step 3">
Google Pay displays the payment sheet with all the card options available.
</Step>
<Step title="Step 4">
Customer selects a card and completes the payment instantly.
</Step>
<Step title="Step 5">
Payment processes and the customer is returned to the website with a confirmation.
</Step>
</Steps>
