...
description: "eCOD runs on top of Razorpay’s Invoices system. An eCOD payment is basically made against an invoice."
---
...
Step 4 described above involves creating an Invoice using Razorpay’s API. For creating an Invoice, you require the amount and the contact number of the customer. Know more about the [Invoice APIs](/api/payments/invoices).
