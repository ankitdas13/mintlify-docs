...
- [**Existing S2S Integration**](/payments/payment-gateway/s2s-integration/json/v2/build-integration/international-cards/e-commerce): Active Server-to-Server integration with Razorpay.
...
If the payment has failed, the callback will contain details of the error. Refer to [Errors](/errors) for details.
