...
description: "Apple Pay is supported inside WKWebView since iOS 11.3, but availability depends on the context in which the WebView is running."
---
...
### Requirements for WKWebView
       ...
       - **Domain verification**: The domain served in the WebView must be registered and verified. Refer to the [Apple Pay Web Component Integration](/payments/payment-methods/apple-pay/web-component-integration) guide.
...
[Apple Pay Web Component Integration](/payments/payment-methods/apple-pay/web-component-integration)
