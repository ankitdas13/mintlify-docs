---
title: "About Cardless EMI"
description: "Offer Cardless EMI as a payment method to convert their payment amount to EMIs without a debit or credit card. Customers enjoy the benefits of the EMI as the payments are made using credits approved by the supported Card"
---
...
Following is the list of supported Payment Partners for Cardless EMI and the minimum order amount stipulated by them:
        ...
        ---
        [axio](/payments/payment-methods/emi/cardless-emi/axio) | `walnut369` | ₹900 
        ---
...
Check the standard [interest rates charged by Banks/Partners](/payments/payment-methods/emi/faqs#1-what-are-the-standard-interest-rates-charged).
...
Check the standard [interest rates charged by Pay Later Providers](/payments/payment-methods/emi/faqs#2-what-are-the-standard-interest-rates-charged).
        ...
        Payment Partners | Provider Code | Minimum Order Amount 
        ---
        [ShopSe](/payments/payment-methods/emi/cardless-emi/shopse) | `shopse` | ₹3000
        ---
        [Snapmint](/payments/payment-methods/emi/cardless-emi/snapmint) | `snapmint` | None
...
See: [Cardless EMI FAQs](/payments/payment-methods/emi/faqs#cardless-emi).
