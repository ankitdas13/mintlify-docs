...
description: "Yes, you receive the full amount at once and the provider/bank converts it into EMI for the customer."
---
...
### 3. Can my customers avail Offers for EMI payments at Checkout?
         ...
         Yes, they can avail offer on debit and credit card EMIs. Know more about [creating EMI Offers](/payments/offers). 
...
### 4. What is the criteria to avail Debit Card EMI?
         ...
         To avail [Debit Card EMI](/payments/payment-methods/emi/debit-card-emi), your customers should pass the eligibility criteria set by their banks. The minimum order amount on the Checkout should be ₹5000 (for HDFC and IndusInd debit cards).
...
### 4. Can I enable No Cost EMIs at the Checkout?
         ...
         Yes. Razorpay enables you to display No Cost EMIs at the Checkout. Know more about [No Cost EMIs](/payments/offers/no-cost-emi).
...
### 6. How does the No Cost EMI settlement work?
         ...
         The order amount minus the entire interest subvented by you as a discount is settled in your bank account as per your [settlement cycle](/payments/settlements#settlement-cycle).
...
### 2. Who bears the cost for the discount given in Low Cost EMI?
         ...
         You can decide the cost to subvent for each tenure and the customer bears the remaining cost. The interest percentage will vary by the bank and the EMI tenure. Know more about the [EMI Calculation](/payments/offers/low-cost-emi#calculation-of-emi).
...
### 5. Can I enable Low Cost EMIs at the Checkout?
         ...
         Yes. Razorpay enables you to display Low Cost EMIs at the Checkout. Know more about [Low Cost EMIs](/payments/offers/low-cost-emi).
...
### 7. How does the Low Cost EMI settlement work?
         ...
         The order amount minus the discount subvented by you is settled in your bank account as per your [settlement cycle](/payments/settlements#settlement-cycle).
