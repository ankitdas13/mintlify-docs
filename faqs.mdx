...
description: "Razorpay is an RBI-approved payment aggregator that empowers businesses to accept online customer payments easily. It manages the settlement of these payments, ensuring that funds collected from customers are securely tr"
---
...
### 1. What is Razorpay?
       ...
       List of [Razorpay Products](/payments).
      

   
### 2. How can I start using Razorpay products?

       To start using any Razorpay products, you need to sign up with Razorpay. Know more about [setting up your Razorpay account](/payments/set-up).
      

   
### 3. If I have created an account for Razorpay Payment products, do I still need to create an account with RazorpayX?

       If you have an existing Razorpay account for Razorpay Payment products, you can use the same user id and password for RazorpayX. Know more about [getting started with RazorpayX](/x/set-up).
      

   
### 4. There are so many Razorpay products. How do I know which one is best for my business?

       Please read the section about [choosing the Razorpay products](/payments) as per your business needs. You can also raise a [support request](https://razorpay.com/support/#request/) for an expert opinion.
      

   
### 5. I have signed up now. What do I do next?

       You can log in to the Dashboard, fill out the activation form and submit the same. Know more about [account set up](/payments/set-up).
...
### 7. Does Razorpay support payments via bank transfers?
       ...
       Yes, you can accept payments via bank transfers using the [Bank Transfers](/payments/payment-methods/bank-transfer) payment method on Razorpay Checkout. If you do not have a website or app, you can use our product [Smart Collect](/payments/smart-collect).
...
### 9. I do not have a website. Can I still use Razorpay?
       ...
       Yes, you can use Razorpay to accept payments even if you do not have a website or mobile app. Check out our [range of products](/payments).
      

   
### 10. How do I sign up for a test or sandbox account?

       After logging in, you can sign up for an account on the Dashboard and use [test mode](/payments/dashboard/test-live-modes#test-mode-vs-live-mode) to try out the products.
      

   
### 11. Does Razorpay provide Invoices?

       Yes, you can use Razorpay Invoices to create and send invoices to customers and accept payments. Know more about [invoices](/payments/invoices).
      

   
### 12. How can I collect subscriptions from my customers?

       You can offer subscription plans to your customers with automated recurring transactions on various payment modes. Know more about [Subscriptions](/payments/subscriptions).
      

   
### 13. Can I know more about the split payments solution?

       Razorpay Route allows you to split payments between third parties, sellers or bank accounts. Using Route, you can easily manage settlements, refunds, reconciliations and make vendor payments. It is helpful for businesses that disburse payments in a one-to-many model. Know more about [Route](/payments/route).
      

   
### 14. How can I earn money from Razorpay?

       We are a payment solutions provider and help businesses to accept payments online. If you have a business venture and are looking to accept payments online, you can [sign up](https://razorpay.com/partners/) with us. Also, we offer a referral program wherein you can refer a business to Razorpay. Know more about [Partners](/partners).
...
### 1. What are the ecommerce plugins supported by Razorpay? How do we integrate it on our end?
       ...
       We support the following ecommerce platforms:
        ...
        ---
        - [Arastta Integration](/payments/payment-gateway/ecommerce-plugins/arastta)
- [BigCommerce](/payments/payment-gateway/ecommerce-plugins/bigcommerce)
- [CS-Cart Integration](/payments/payment-gateway/ecommerce-plugins/cs-cart)
- [Easy Digital Download Integration](/payments/payment-gateway/ecommerce-plugins/easy-digital-downloads)
- [Magento Integration](/payments/payment-gateway/ecommerce-plugins/magento)
- [OpenCart Integration](/payments/payment-gateway/ecommerce-plugins/open-cart)
- [PrestaShop Integration](/payments/payment-gateway/ecommerce-plugins/prestashop)
- [Shopify Integration](/payments/payment-gateway/ecommerce-plugins/shopify)
- [WHMCS Integration](/payments/payment-gateway/ecommerce-plugins/whmcs)
- [Wix Integration](/payments/payment-gateway/ecommerce-plugins/wix)
- [WooCommerce Integration](/payments/payment-gateway/ecommerce-plugins/woocommerce)
- [WordPress Integration](/payments/payment-gateway/ecommerce-plugins/wordpress)
 | [Razorpay Direct - Credit Card](/payments/ecommerce-plugins/razorpay-direct-credit-card)
...
### 2. How do I find my Razorpay credentials?
       ...
       The email/password is only used to log in to the Dashboard. To authenticate against the API, you will need to generate a KeyID, and KeySecret. Know how to generate [API Keys](/api/authentication#generate-api-keys).
...
### 5. How to create a Razorpay API instance?
       ...
       The instance creation method differs based on the platform. Refer to the relevant [SDK Integration](/payments/server-integration).
      

   
### 6. Where can I find the API references?

       Refer to the [API Reference guide](/api).
      

   
### 7. Can I accept customer payments using Paytm wallet?

       Yes, you can provide Paytm as a payment method for your customers via Razorpay. Know more about [Paytm Wallet](/payments/payment-methods/wallets/paytm) as a payment method.
      

   
### 8. What are the platforms supported by Razorpay?

       We support a range of web and mobile platforms. Refer to the [integration list](/payments/payment-gateway#integration-types).
...
### 10. The platform I am integrating with is not listed on your webpage. Can I still integrate?
       ...
       If the required platform/plugin is not listed, you can try integrating it on your own using this [method](/payments/payment-gateway/ecommerce-plugins/build-your-own).
...
### 4. How I do display different currencies (other than INR) on the Razorpay Checkout to my customers?
       ...
       - You must get the [international payments feature](/payments/international-payments#application-process) enabled on your Razorpay account to accept payments in currencies other than INR. 
       - The native currencies like USD and SGD, which are a part of the [list of currencies supported by Razorpay](/payments/international-payments#supported-currencies), can be updated as a part of the **currency** parameter on the payment request. 
