...
<Step title="Navigate to **Settlements**.">
Navigate to **Settlements**.
</Step>
<Step title="Click on the **details** of the settlement ID that you wish to refer.">
Click on the **details** of the settlement ID that you wish to refer.
</Step>
</Steps>
...
`Transfer`
: Transfers made if any, Transfers are payouts made to your [linked accounts](/payments/route/linked-account). 
...
<Step title="Click on the **details** of the settlement ID for which you want to...">
Click on the **details** of the settlement ID for which you want to view the timeline.
</Step>
<Step title="You will be able to see the settlement timeline for that particular...">
...
<Step title="Click **Resolve** on the notification as shown above..">
...
Detailed insights can be gained using reports and real-time data on the Dashboard. These reports can then be used for accounting and reconciliation purposes. Know more about [reports.](/pos/dashboard/reports)

### Related Information

- [About Settlements](/pos/settlements)
