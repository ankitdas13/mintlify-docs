...
description: "You can manage all your physical and online outlets with Billme’s **Store Management**. Each store can have its own branding, campaigns and analytics."
---
...
<Steps>
<Step title="**Company** - Business entity management">
**Company** - Business entity management
</Step>
<Step title="**Brands** - Brand portfolio management">
**Brands** - Brand portfolio management
</Step>
<Step title="**Retail Stores** - Physical store locations">
**Retail Stores** - Physical store locations
</Step>
<Step title="**E-Commerce Stores** - Online store management">
**E-Commerce Stores** - Online store management
</Step>
<Step title="**Store Groups** - Logical store groupings">
**Store Groups** - Logical store groupings
</Step>
<Step title="**Access Keys** - POS system access management">
**Access Keys** - POS system access management
</Step>
</Steps>
