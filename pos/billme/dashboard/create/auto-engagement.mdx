...
description: "The Auto Engagement feature, also known as Journey Builder, allows brands to build powerful, personalised post-purchase marketing journeys that enhance customer loyalty, drive repeat purchases and increase overall revenue."
---
...
<Steps>
<Step title='**Start with a Trigger**: Drag "Event Occurrence" to begin your jou...'>
**Start with a Trigger**: Drag "Event Occurrence" to begin your journey
</Step>
<Step title='**Add Customer Targeting**: Connect "All Customers" or specific seg...'>
**Add Customer Targeting**: Connect "All Customers" or specific segments
</Step>
<Step title="**Design Engagement Sequence**: Add engagement components in logica...">
**Design Engagement Sequence**: Add engagement components in logical order
</Step>
<Step title='**Insert Timing Controls**: Use "Wait For Some Time" to space out c...'>
**Insert Timing Controls**: Use "Wait For Some Time" to space out communications
</Step>
<Step title="**Configure Components**: Set up each component with appropriate co...">
