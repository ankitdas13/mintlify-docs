...
description: "Payouts are transfer of funds from your business account to a contact's fund account."
---
...
Know about the [Payouts Approval Payload](/api/x/payouts-approval#webhooks).
