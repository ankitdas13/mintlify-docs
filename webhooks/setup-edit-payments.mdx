...
description: "You can [set up](#set-up-webhooks), [edit](#edit-a-webhook), [enable/disable](#enabledisable-a-webhook) and [delete](#delete-a-webhook) webhooks from the Dashboard."
---
...
You should validate and test your webhooks before you go live. Know more about [validating and testing your webhooks](/webhooks/validate-test).
...
<Step title="In the list, select the webhook you want to edit.">
In the list, select the webhook you want to edit.
</Step>
<Step title="Change the status to **Enabled** or **Disabled** in the right panel...">
Change the status to **Enabled** or **Disabled** in the right panel as required.
</Step>
</Steps>
