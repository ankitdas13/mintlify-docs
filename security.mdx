...
description: "As a financial service provider, we take utmost care of your data. We are continuously working to keep our environment safe and secure for everyone to use."
---
...
- You can download a copy of our [TLS certificate](/security/whitelists#ssl-certificates).
...
Know more about [API authentication](/api/authentication).
...
Know more about [fraud protection for customers](/security/customers#fraud-and-risk).

## Firewall

If you want to limit or authenticate ingress/egress to Razorpay, we provide a list of IP addresses for APIs and Webhooks.

- Razorpay API requests are resolved to these [IP addresses](/security/whitelists#api-ips).
- Razorpay webhooks use these [IP addresses](/security/whitelists#webhook-ips).
...
- [Business Security Checklist](/security/checklist)
- [Shared Responsibility Model](/security/shared-responsibility-model)
- [Security For Customers](/security/customers)
