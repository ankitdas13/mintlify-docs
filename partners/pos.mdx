---
title: "POS Partnership"
description: "[Razorpay POS](https://razorpay.com/pos/) is a point-of-sale payments solution that allows business to accept payments using UPI, credit and debit cards, wallets, contactless, EMI and more with superfast processing and high transaction success rate."
---
...
<Step title="Click **+ Add POS Agent** under **Refer clients to Razorpay POS!**.">
Click **+ Add POS Agent** under **Refer clients to Razorpay POS!**.

</Step>
<Step title="Enter the email id of the agent and select the **Role** as **POS Pa...">
Enter the email id of the agent and select the **Role** as **POS Partner Agent**.
