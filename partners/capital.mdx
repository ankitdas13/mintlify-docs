...
description: "[Razorpay Capital](/x) is a lending platform enabling businesses to meet their cash flow challenges. With the Partnership program for Capital, you can refer businesses to Razorpay [Line of Credit](https://razorpay.com/x/line-of-credit/) and earn lucrative rewards when your leads use the product."
---
...
<Steps>
<Step title="Sign up or log in to your Dashboard.">
Sign up or log in to your Dashboard.
- [New to Razorpay](/partners/new-to-razorpay).
- [Existing Razorpay Merchant](/partners/existing-merchant#become-a-razorpay-partner).
</Step>
<Step title="Enable the Capital Dashboard.">
Enable the Capital Dashboard.
</Step>
<Step title="Refer leads for Line of Credit using [Referral links](#refer-busine...">
Refer leads for Line of Credit using [Referral links](#refer-businesses-via-referral-link) or [Dashboard bulk upload](#refer-businesses-via-dashboard-upload).
</Step>
</Steps>
...
1. Open the link and [sign up for the Partner Program](/partners#next-steps).
...
- [Line of Credit](/x/capital/line-of-credit)
