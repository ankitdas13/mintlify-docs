...
description: "To access the necessary information from your sub-merchant's account, you must integrate with OAuth. Follow the steps below for the integration."
---
...
<Step title="[Get Authorisation from Sub-merchant](#2-get-authorisation-from-sub...">
[Get Authorisation from Sub-merchant](#2-get-authorisation-from-sub-merchant)
</Step>
<Step title="[Access Resources](#3-access-resources-using-access-token)">
[Access Resources](#3-access-resources-using-access-token)
</Step>
<Step title="[Process Payments](#4-process-payments)">
...
After completion, the sub-merchant's browser is redirected to URI specified in the `redirect_uri` parameter. Once the [sub-merchant authorises](/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps/sub-merchants), you can proceed with the steps ahead.
...
### Response Parameters
     ...
     Once the sub-merchant authorises, the following tokens become available to both you and the sub-merchant. You can use these tokens later to create API requests on behalf of the sub-merchant. Know more [about tokens](/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps/sub-merchants#about-tokens).
...
### Error Response Parameters
             ...
             Refer to our [errors](/partners/technology-partners/onboard-businesses/integrate-oauth/errors#revoke-token-api) page for the list of errors and solutions.
...
### For RazorpayX
     ...
     [Subscribing to webhooks](/partners/technology-partners/onboard-businesses/integrate-oauth/subscribe-to-webhooks) is a mandatory step if you want to access the user's RazorpayX data. Once you [generate the `access_token`](#22-get-access-token), the user's RazorpayX `account_id` will be sent to the webhook URL specified while creating your application.
...
### 1. Access Customer APIs using OAuth
     ...
     You can process payments on behalf of your sub-merchants using [Razorpay APIs](/api). Use the tokens generated during [OAuth integration](/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps/partners-import-flow).

     Use the `access_token` generated in the [build integration](/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps/partners-import-flow#22-get-access-token) step to authenticate using `Bearer Auth`.
     ...
     Below is a sample code to create a customer in server.
      ...
      The parameter descriptions and errors are present in the [Create a Customer API](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/build-integration#11-create-a-customer-in-server).
...
### 2. Access Order APIs using OAuth
     ...
     Below is a sample code to create an Order and process payments.
      ...
      The parameter descriptions and errors are present in the [Create an Order API](/payments/international-payments/accept-international-payments-from-indian-customers/standard-integration/build-integration#12-create-an-order-in-server).
...
Follow these steps to [subscribe to webhooks](/partners/technology-partners/onboard-businesses/integrate-oauth/subscribe-to-webhooks).
...
[2. Test Integration](/partners/technology-partners/onboard-businesses/integrate-oauth/test-integration)

### Related Information

- [Revoke Access to Application](/partners/technology-partners/onboard-businesses/integrate-oauth/revoke-access)
- [Standard Web Integration](/payments/payment-gateway/web-integration/standard)
- [Errors](/partners/technology-partners/onboard-businesses/integrate-oauth/errors)
