---
title: "Add Submerchants from Dashboard"
description: "You can invite submerchants for different apps from the Partner Dashboard."
---
...
<Step title="Select the **Payments** or **RazorpayX** tab depending on the produ...">
Select the **Payments** or **RazorpayX** tab depending on the product you want to refer a client to.
</Step>
<Step title="Click **+ Add New Clients**.">
Click **+ Add New Clients**.

</Step>
<Step title="Select the app for which you want to add a client.">
Select the app for which you want to add a client.
</Step>
<Step title="Under the **Using Email** tab, enter your contact's details. Click...">
Under the **Using Email** tab, enter your contact's details. Click **Send Invite**.
...
<Step title="Shift to the **Bulk Upload** tab.">
Shift to the **Bulk Upload** tab.
</Step>
<Step title="Upload the file. You can drag and drop or **click to upload**.">
Upload the file. You can drag and drop or **click to upload**.

</Step>
<Step title="The file is validated for any associated errors and uploaded to the...">
The file is validated for any associated errors and uploaded to the Razorpay server. Click **Next**.
...
<Step title="In the **Partner** section, navigate to **Affiliate Accounts**.">
In the **Partner** section, navigate to **Affiliate Accounts**.
</Step>
<Step title="Select the **Payments** or **RazorpayX** tab depending on the produ...">
Select the **Payments** or **RazorpayX** tab depending on the product you want to refer a client to.
</Step>
...
<Step title="Switch to the **Public Link** tab.">
Switch to the **Public Link** tab.

</Step>
<Step title="You can share the link using:">
You can share the link using:
...
Your contact will receive an invite via email and SMS to create a Razorpay account. To get started, the contacts invited for `Payment` products, must proceed to create a Razorpay account and complete account activation and [KYC Verification](/payments/set-up#2-submit-kyc-details). 
...
You can use the `Switch` option to access the sub-merchant's account. Once you are on the sub-merchant's Dashboard, you can perform all the actions that the sub-merchant can perform. Know more about [switching to sub-merchant Dashboard](/partners/technology-partners/onboard-businesses/add-on-features/switch-dashboard).
...
- [Perform Sub-merchant KYC](/partners/technology-partners/onboard-businesses/add-on-features/perform-submerchant-kyc)
- [Switch to Sub-merchant Dashboard](/partners/technology-partners/onboard-businesses/add-on-features/switch-dashboard)
