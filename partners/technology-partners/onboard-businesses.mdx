...
description: "Co-branded onboarding is a pre-built UI for Razorpay Partners that assists in building a native business onboarding flow. It enables Partners to onboard clients to Razorpay right from their platform."
---
...
- [Sign up as Partner](https://razorpay.com/partners/) and complete KYC to activate your account. Request for a partner type [switch to Technology Partner](/partners/technology-partners/become-technology-partner).
...
- [Register your application](/partners/technology-partners/onboard-businesses/integrate-oauth/integration-steps#1-create-an-application) on Razorpay.
...
<Steps>
<Step title="As a Partner, you create an application on your Dashboard and downl...">
As a Partner, you create an application on your Dashboard and download your client credentials.
</Step>
<Step title="The client visits the section of your platform with the embedded Ra...">
The client visits the section of your platform with the embedded Razorpay Payments setup.
</Step>
<Step title="They click **Connect with Razorpay** and visit the Razorpay authori...">
They click **Connect with Razorpay** and visit the Razorpay authorisation URL you initiated with the client credentials downloaded in Step 1.
</Step>
<Step title="The user can log in or sign up.">
...
<Step title="On successful authorisation, Razorpay redirects the user back to th...">
On successful authorisation, Razorpay redirects the user back to the URL configured by you in your application settings. Razorpay shares an authentication code while redirecting. You need to use this Auth code in the token API request to generate an Auth token.
</Step>
</Steps>
...
1. [Integrate with Razorpay OAuth](/partners/technology-partners/onboard-businesses/integrate-oauth)
2. [Customise client Onboarding](/partners/technology-partners/onboard-businesses/settings)
...
[Integrate with Custom Onboarding SDK](/partners/technology-partners/onboard-businesses/onboarding-sdk) to create a customer account using APIs and pre-fill KYC details.
