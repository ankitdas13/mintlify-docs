...
<Steps>
<Step title="Get the `platforms_marketplaces` tag enabled on your Partner accoun...">
Get the `platforms_marketplaces` tag enabled on your Partner account through your sales point of contact.
</Step>
<Step title="If you are charging a Platform fee, create a Linked Account for you...">
If you are charging a Platform fee, create a Linked Account for your merchant account and add your bank account details.
</Step>
<Step title="Create a Linked Account for your third-party service providers, if...">
...
1. [Set up Platform and Third-Party Accounts](/partners/technology-partners/control-of-funds/set-up-accounts)
2. [Process Platform and Third-Party Fees](/partners/technology-partners/control-of-funds/process-fees)

You can also create [refunds and reversals](/partners/technology-partners/control-of-funds/refunds-and-reversals) for transactions.
