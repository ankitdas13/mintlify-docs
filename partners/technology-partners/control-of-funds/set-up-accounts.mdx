---
title: "Set up Platform and Third-Party Accounts"
description: "To transfer funds to various third parties, sub-merchants, bank accounts or vendors, you need to add them as Linked Accounts."
---

You can create Linked Accounts using [Dashboard](/payments/route/linked-account#add-and-manage-linked-accounts) and [APIs](/api/payments/route).
