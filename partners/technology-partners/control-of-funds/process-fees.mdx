...
The parameter descriptions and errors are present in the [Create Transfers from Orders](/api/payments/route) documentation.

## Set Up Webhooks

To receive notifications on when a transfer is processed, set up the [`transfer.processed` webhook event](/webhooks/setup-edit-payments). Check the [sample payload for Transfer Processed](/webhooks/route#transfer-processed).
...
- [Refunds and Reversals](/partners/technology-partners/control-of-funds/refunds-and-reversals)
