...
description: "Razorpay Aggregator Partners are businesses that:"
---
...
After onboarding as a Razorpay Partner, you need to request a Partner type switch to [become an Aggregator](/partners/aggregators/become-aggregator).

## Add Sub-merchants

You can add your affiliate partners/sub-merchants directly using the Dashboard. Know more about [adding sub-merchants](/partners/aggregators/add-submerchants).
...
<Step title="Click on **Switch Merchant** on the top right.">
Click on **Switch Merchant** on the top right.
</Step>
<Step title="Search the sub-merchant using:">
...
Know more about [user roles](/payments/dashboard/account-settings/manage-team#standard-user-roles).
...
Know more about [using the Partner credentials](/partners/aggregators/partner-auth).
...
You can also set up webhooks for specific events on the sub-merchant account. Know more about [webhooks](/webhooks).

<Steps>
<Step title="Log in to your Dashboard.">
Log in to your Dashboard.
</Step>
<Step title="Click **Partner** on the Dashboard.">
Click **Partner** on the Dashboard.

</Step>
<Step title="Under the **Affiliated Accounts** tab, click **Settings**.">
Under the **Affiliated Accounts** tab, click **Settings**.

</Step>
<Step title="In the Webhooks section, you can set up webhooks from your Dashboar...">
In the Webhooks section, you can set up webhooks from your Dashboard for live mode and test mode.
</Step>
...
<Step title="Enter **Secret**. This field is optional.">
Enter **Secret**. This field is optional.
</Step>
<Step title="Select appropriate events from the list of **Active Events** you wo...">
Select appropriate events from the list of **Active Events** you would like to activate.

</Step>
<Step title="Click **Save** to enable the webhook.">
...
- [Aggregators - Add Sub-merchants](/partners/aggregators/add-submerchants)
- [Partners](/partners)
