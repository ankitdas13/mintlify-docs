---
title: "Perform Client KYC"
description: "Offer a smooth onboarding experience by assisting your client with their KYC."
---
...
<Steps>
<Step title="The client receives an email to approve or reject the KYC request.">
The client receives an email to approve or reject the KYC request.

</Step>
<Step title="If the client approves the request, you can fill in the KYC details...">
If the client approves the request, you can fill in the KYC details from the Partner Dashboard by clicking on **Perform KYC**. You can check the [KYC access request status](#check-kyc-access-request-status) on the Partner Dashboard.

</Step>
<Step title="You can view the activation statuses as shown here:">
You can view the activation statuses as shown here:
...
- [Add clients](/partners/service-partners/add-submerchants)
