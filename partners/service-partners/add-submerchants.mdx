---
title: "Add Sub-merchants"
description: "As a Service Partner, you can invite your affiliates to use Razorpay Payments products and RazorpayX powered Current Account. You get a partnership commission when the Sub-merchants perform any transaction using Razorpay products. Know more about [partnership commission](/partners/commissions)."
---
...
We recommended you to perform KYC for your Sub-merchants as it decreases onboarding time by 50% and acts as a value added service. Know how to [perform KYC for your Sub-merchants](/partners/service-partners/perform-kyc). During onboarding, your client will see a consent screen to allow you access to perform KYC. They need to approve it for you to submit the KYC form on their behalf.
...
Once the file is successfully processed, you will receive the account creation status via email. The email attachment will include both success and/or failure details for each account, including the error code and exact reason for the failure.
        ...
        - To get started, the Sub-merchants must proceed to complete the [Account Set Up](/payments/set-up) and [KYC Verification](/payments/set-up#2-submit-kyc-details) processes by using their Razorpay account credentials.
...
## Actions After Inviting
        ...
        Your contact will receive an invite via email and SMS to create a Razorpay account. To get started, the contacts invited for `Payment` products, must proceed to create a Razorpay account and complete account activation and [KYC Verification](/payments/set-up#2-submit-kyc-details). Sub-merchants invited for `Payments` can be seen under **Payments**.
...
- [Partners](/partners)
- [About Service Partners](/partners/service-partners)
- [Partner Commissions](/partners/commissions)
