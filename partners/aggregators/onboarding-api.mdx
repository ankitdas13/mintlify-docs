---
title: "Sub-Merchant Onboarding APIs"
description: "As a Partner, you can use the Sub-Merchant Onboarding APIs to onboard merchants from your platform. The sub-merchants can complete the KYC process in the Partner's platform itself and need not log in to Razorpay's platform."
---
...
- To complete the onboarding process for the sub-merchant, check the [KYC document requirements](/partners/aggregators/onboarding-api/appendix#kyc-requirements).
...
OAuth uses `Bearer Auth`. Know more about [OAuth](/partners/technology-partners/onboard-businesses/integrate-oauth).

To use OAuth for Partners APIs:
<Steps>
<Step title="[Enable cobranded_onboarding](#1-enable-cobranded-onboarding)">
[Enable cobranded_onboarding](#1-enable-cobranded-onboarding)
</Step>
<Step title="[Generate Access Token](#2-generate-access-token)">
[Generate Access Token](#2-generate-access-token)
</Step>
<Step title="[Use Access Token to Authenticate](#3-use-access-token-to-authentic...">
[Use Access Token to Authenticate](#3-use-access-token-to-authenticate)
</Step>
</Steps>
...
- Access to [sub-merchant account status webhooks](/partners/technology-partners/onboard-businesses/status).
- [Onboarding UI configurator](/partners/technology-partners/onboard-businesses/settings) on Partner Dashboard.
...
Given below is a sample code for the [Fetch an Account API](/api/partners/account-onboarding/fetch).
...
API | Description
---
[Account APIs](/api/partners/account-onboarding) | Create, view, update and delete sub-merchant accounts.
---
[Stakeholders APIs](/api/partners/stakeholder) | Create, view and update stakeholders.
---
[Product Configuration APIs](/api/partners/product-configuration) | Request, view and update a product configuration.
---
[Documents APIs](/api/partners/upload-document) | Upload and view account and stakeholder documents.
---
[Webhooks APIs](/api/partners/webhooks) | Create, view, update and delete webhook events.
---
[Terms and Conditions APIs](/api/partners/terms-conditions) | View and accept terms and conditions.
...
- [Update Settlement Account Details](/api/partners/product-configuration/update-settlement-account-details)
- [Update a Stakeholder](/api/partners/stakeholder/update)

- [Upload Documents](/api/partners/upload-document)

Activation Status | Update Permitted
---
`requested` | You can update the details for all the fields.
---
`needs_clarification` | The fields you can update depend on the reason_code mentioned in the requirements object in the [Request a Product Activation API](/api/partners/product-configuration/request): - **document_missing** or **field_missing**: You can update all the fields.
...
<Steps>
<Step title="As a partner, it is your responsibility to show respective terms an...">
As a partner, it is your responsibility to show respective terms and conditions to the sub-merchants before you start onboarding to a product. The APIs used for it will be [Fetch Terms and Conditions for a Sub-Merchant](/api/partners/terms-conditions/fetch).
</Step>
<Step title="You should display these web pages to your sub-merchants on your in...">
You should display these web pages to your sub-merchants on your interface.
</Step>
<Step title="Record the acceptance of terms and transmit that to Razorpay using...">
Record the acceptance of terms and transmit that to Razorpay using either [Request a Product Configuration API](/api/partners/product-configuration/request) or [Update a Product Configuration API](/api/partners/product-configuration/update-settlement-account-details).
</Step>
</Steps>

### Related Information

- [Sub-Merchant Onboarding APIs Workflow](/partners/aggregators/onboarding-api/workflow)
- [Subscribe to Webhooks](/partners/aggregators/onboarding-api/webhooks)
- [Appendix](/partners/aggregators/onboarding-api/appendix)
