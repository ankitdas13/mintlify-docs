...
description: "Subscribe to webhook events relevant to partners to receive notifications (in the form of a webhook payload) when these events occur."
---
...
<Step title="Navigate to **Partner's Dashboard** → **Settings** → **Webhooks** t...">
Navigate to **Partner's Dashboard** → **Settings** → **Webhooks** to subscribe to any of the events mentioned in the following section.
</Step>
<Step title="Click on **Manage** settings.">
Click on **Manage** settings.
</Step>
<Step title="In the **Webhook Setup** pop-up page:">
...
Know more about [Aggregators Webhooks](/webhooks/partners).
...
Check the [sample payloads](/webhooks) for the above-mentioned webhook events. 
...
You can check the events and sample payloads of [Sub-Merchant Onboarding Events](/webhooks/partners). Know more about [Webhook APIs](/api/partners/webhooks). 
