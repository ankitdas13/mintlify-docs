...
description: "With our Bulk Submerchant Upload feature, sub-merchants can be created with all details by uploading a CSV file. It is essential to provide the sub-merchant data in the correct format to upload the CSV file successfully."
---
