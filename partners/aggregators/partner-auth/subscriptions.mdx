---
title: "Subscriptions"
description: "You can use Razorpay Subscriptions to set up and manage recurring payments. These recurring payments are payments that:"
---
...
You should [create a plan](/api/payments/subscriptions/create-plan) before creating a subscription.
...
- [Subscriptions API documentation](/api/payments/subscriptions).
