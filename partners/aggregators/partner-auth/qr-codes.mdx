---
title: "QR Codes"
description: "Use Razorpay QR Codes to receive UPI payments from your customers. Create QR Codes from the Dashboard or using our APIs and share them with your customers. Customers can scan these codes and make payments."
---
...
Consider these [prerequisites](/payments/qr-codes#prerequisites) before getting started with QR Codes.

## Create a QR Code API

Given below is the sample code for Create a QR Code API. Pass the `account_id` of the sub-merchant using `X-Razorpay-Account` in the header. Refer to the [QR Codes API documentation](/api/qr-codes).
...
: `string` The type of QR code. Possible values:
  ...
  - `bharat_qr`: Create a QR code that accepts UPI and card payments. This is an on-demand feature. Know more about [Bharat QR](/payments/payment-methods/bharatqr).
...
: `string` Unique identifier of the customer the QR code is linked with. Know more about the [Customers API](/api/customers).
...
Descriptions for the response parameters are present in the [QR Codes Entity](/api/qr-codes#qr-code-entity) parameters table.

### Error Response Parameters

Error codes and descriptions are present in the [Error Response Parameters](/api/qr-codes#error-response-parameters) table.
...
Error codes and descriptions are present in the [Error Response Parameters](/api/qr-codes#error-response-parameters-2) table.

### Related Information

- [QR Codes API documentation](/api/qr-codes)
