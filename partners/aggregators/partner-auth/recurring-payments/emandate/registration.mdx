...
description: "Emandate registration is a process of creating a payment checkout form for customers to make the authorisation transaction and register their Emandate. A token will be generated once a customer makes this transaction."
---
...
You can register a customer's mandate and charge them the first recurring payment as part of the same transaction. Know more about how to [charge first payment automatically after emandate registration](/api/payments/recurring-payments/emandate/auto-debit).
