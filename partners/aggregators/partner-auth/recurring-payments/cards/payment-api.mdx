...
- Individual [Orders](/payments/payment-gateway/s2s-integration/recurring-payments/cards/authorization-transaction#112-create-an-order) and [Payments](/payments/payment-gateway/s2s-integration/recurring-payments/cards/authorization-transaction#113-create-an-authorization-payment) APIs
...
`notes` _optional_
: `json object` Key-value object used for passing tracking info. Refer to [Notes](/api/understand#notes) for more details.
