...
description: "Registration Link is an alternate way of creating an authorisation transaction. You can create a registration link using the API or [Dashboard](/payments/recurring-payments/crea..."
---
