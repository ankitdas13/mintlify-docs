---
title: "Payment Links"
description: "Use Payment Links to receive online payments from your customers. Create Payment Links from the Dashboard or using the APIs and share them with your customers. Customers open the links, select the payment method and make the payment."
---

## Create a Payment Link API

Given below is the sample code for Create a Payment Link API. You should send the `account_id` of the sub-merchant using `X-Razorpay-Account` in the header. Refer to the [Payment Links API documentation](/api/payments/payment-links).
...
- [Payment Links API documentation](/api/payments/payment-links).
