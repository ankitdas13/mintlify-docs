...
description: "As a Razorpay Partner you can create or manage transactions on behalf of your sub-merchant in two modes: **Test** and **Live**."
---
...
- [Checkout and API Integration](/partners/aggregators/partner-auth)
