...
description: "Below are the top error codes associated with card payments, along with their reasons, descriptions and subsequent steps for resolution."
---
...
### Bank Downtime
                 ...
                 In the case of Custom/S2S checkout, if you have not done so already, integrate the [Downtime API](/api/payments/downtime) into your checkout system. This will allow you to showcase downtime information directly on your checkout interface.
...
### authentication_failed
        ...
        - **Next Steps**: Please ensure customers correctly enter the OTP during transactions and avoid closing the browser during authentication. If the card supports [Native OTP](/payments/optimizer/native-otp), encourage its use to prevent errors.
...
### incorrect_cvv
        ...
        - **Next Steps**: Additionally, you can promote the convenience of saving their card details at checkout, which can enable a [CVV-less flow](/payments/payment-methods/cards/features/cvv-less-flow) and simplify the payment process for future transactions.
