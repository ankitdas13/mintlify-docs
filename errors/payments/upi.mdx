...
description: "Below are the top error codes associated with UPI payments, along with their reasons, descriptions, and subsequent steps for resolution."
---
...
### bank_technical_error
         ...
         In the case of Custom/S2S Checkout, we recommend integrating the [Downtime API](/api/payments/downtime) into your checkout system. This will allow you to showcase downtime information directly on your checkout interface.
