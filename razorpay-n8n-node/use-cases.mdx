...
description: "Discover how businesses use the Razorpay n8n Community Node to automate payment operations across different scenarios."
---
...
- [Get Started with Installation](/razorpay-n8n-node/installation)
- [Explore Available Operations](/razorpay-n8n-node/operations-reference)
