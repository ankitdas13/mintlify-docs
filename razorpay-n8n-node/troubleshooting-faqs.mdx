...
description: "The Razorpay n8n Community Node connects Razorpay APIs with the n8n workflow automation platform. It enables you to automate payment operations, build no-code workflows and conn..."
---
...
### 1. What is the Razorpay n8n Community Node?
      ...
      View [Getting Started Guide](/razorpay-n8n-node).
...
### 3. What operations are available in the node?
      ...
      View [Complete Operations Reference](/razorpay-n8n-node/operations-reference) to know about the available operations.
...
### 3. I get a "Bad Request" error when creating a Payment Link. What is wrong?
      ...
      **Fix**: 
      ...
      3. Check [Operations Reference](/razorpay-n8n-node/operations-reference) for required fields.
...
- [Install the Node](/razorpay-n8n-node/installation)
- [Explore Use Cases](/razorpay-n8n-node/use-cases)
- [View Operations](/razorpay-n8n-node/operations-reference)
