---
title: "Leave Setup"
description: "Time management in Payroll can be done via the Leave and Attendance module after you enable and set it up."
---
...
Know more about calculating [salary based on Loss of Pay](/payroll/run-payroll#calculations). 

## Leave Encashment 

When an employee leaves your organisation, you can pay them for the leaves they have not availed from their balance. Know more about [Leave Encashment during exit](/payroll/run-payroll#full-and-final-settlement).
