...
description: "The Salary Component Library in RazorpayX Payroll is a structured repository that standardises salary components. It categorises additions and deductions so you can easily define and manage salary components. It also ensures compliance with tax and statutory regulations."
---
...
<Steps>
<Step title="Navigate to **Pay Employees → Run Payroll.**">
Navigate to **Pay Employees → Run Payroll.**

</Step>
<Step title="**Select** the employee whose salary you want to update.">
**Select** the employee whose salary you want to update.
</Step>
<Step title="Click the **Edit** button next to the employee's salary details.">
Click the **Edit** button next to the employee's salary details.
</Step>
<Step title="In the edit screen, go to the **Deduction** section.">
In the edit screen, go to the **Deduction** section.

</Step>
<Step title="Choose the predefined component from the dropdown.">
Choose the predefined component from the dropdown.
</Step>
<Step title="Enter the amount for the selected component.">
Enter the amount for the selected component.
