...
description: "When you log in to the [Payroll Dashboard](https://payroll.razorpay.com/dashboard) as an approver, you can access your pending requests in three ways:"
---
