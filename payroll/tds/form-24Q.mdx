---
title: "Form 24Q for Employers"
description: "Form 24Q is a quarterly statement that employers must file to report Tax Deducted at Source (TDS) on salaries. It contains details of salaries paid and TDS deducted for each employee. Filing this form is mandatory, as it enables the generation of Form 16, which employees need for tax returns."
---
