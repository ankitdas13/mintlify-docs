...
description: "- **Manage Tax Proofs Verifications**: Explore tax proofs verifications guidelines."
---
...
### How do I setup a Custom Salary Structure?
         ...
         You can setup two types of custom salary structures:
            ...
            Know more about [Custom Salary Structure](/payroll/salary#custom-salary-structure).
        

    
### Are there any best practices to note before I execute payroll?

         You can refer to the [Execute Payroll checklist](/payroll/execute-payroll).
        

    
### How can I make one-time payments?

         Refer to the steps on how to create [one-time payments](/payroll/one-time-payments#make-one-time-payments).
        

    
### Can I revise salaries in bulk?

         Yes, you can [bulk revise salaries](/payroll/run-payroll#revise-salary) on the Payroll Dashboard.
        

    
### How do I upload additions, deductions and Loss of Pay in bulk?

         You can use the [bulk upload](/payroll/run-payroll#bulk-upload) feature to pay and deduct additions, deductions and loss of pay.
        

    
### When will Payroll pay my ESIC/PT/PF/TDS dues?

         You can refer to the [Compliance payments due dates](/payroll/statutory-compliance#payment-due-dates).
...
### 1. Why was my Payroll account deactivated?
         ...
         Your account may be deactivated due to inactivity for an extended period. We hibernate your account if you have not used Payroll to [finalise and execute payroll](/payroll/run-payroll) for an extended period of time.
        

    
### 2. Can I reactivate my Payroll account?

         Yes, you can reactivate your Payroll account. [Contact support](/payroll/plans#contact-support) with the reason for your inactivity and the plan for future Payroll usage to reactivate.
        

        
### 3. Is it mandatory to use the core payroll module in Payroll?

         Yes, it is mandatory. You can use other payroll modules such as Leave and Attendance, Resignation, Bonus and more in addition to the core payroll module. Core payroll includes finalising and executing payroll. Know more about [Executing Payroll](/payroll/run-payroll).
...
### 5. How do I provide additional permissions to my HR/Operations/Finance team members?
         ...
         Know how to [create, edit and manage user roles](/payroll/user-roles-workflows). Navigate to **Settings** → **User Roles** on the Dashboard.
        

    
### 6. How can I create approval workflows for one-time payments and reimbursements?

         Currently, you cannot create approval workflows for one-time payments and reimbursements. You can check the [available approval workflows](/payroll/approval-workflow#available-workflows).
         
         You can instead [create user roles](/payroll/user-roles-workflows) and assign it to your team members.
...
### 1. We processed the salaries and the payments are still In Progress. What do we do now?
         ...
         Please wait for confirmation from the bank. You can also check the status in the **Ledger** on the Payroll Dashboard. Know more about the [payment status](/payroll/payroll-payouts#check-payment-status) and the [Payout modes and TAT](/x/payouts#payout-modes-and-tat). 
...
### 2. We processed the salaries. The payment status is successful but is yet to be credited to my employees. What to do now?
         ...
         You can retry the payment from **Reports** → **Ledger** on the Payroll Dashboard after 3 days. Know more about [Payment Statuses](/payroll/payroll-payouts#no-credit-after-payment-success). 
        

    
### 3. How long does Payroll take to process payments? By when should we prepare the monthly payroll for execution?

         Refer to the [fund credit timelines](/payroll/payroll-payouts#fund-credit-timelines) to understand how long Payroll takes to process salary payments. You can also check the [Payment Statuses](/payroll/payroll-payouts#no-credit-after-payment-success). 

         Payroll automates the monthly payroll calculations, so you need not manually prepare the monthly payroll. However, we recommend you execute payroll before the [Payroll due dates](/payroll/execute-payroll#5-check-due-dates). 
        

    
### 4. Can we reverse salary payments after execution?

         No, it is not possible to reverse salary payments after you execute payroll. Know why we restrict [payroll modification](/payroll/exceptional-cases#modify-salary-after-payroll-is-executed) after execution.

         You can instead add arrears or create deductions in the upcoming payroll activity. Know more about [payroll additions and deductions](/payroll/run-payroll#additions-and-deductions).

         Ensure you follow the [Execute Payroll checklist](/payroll/execute-payroll) before executing payroll for employees.
        

    
### 5. How long does it take for employees to receive their salary post execution?

         It takes up to 8 hours for salaries to reflect in the employees' bank accounts. Know more about [fund credit timelines](/payroll/payroll-payouts#fund-credit-timelines). 
...
Transferring funds to your Payroll account updates your Payroll balance. Know more about [fund transfer and payroll payouts](/payroll/payroll-payouts#transfer-funds) in Payroll.
...
### 2. How do I know if my fund transfer transaction is unsuccessful? Why was it unsuccessful and how do I resolve it?
         ...
         Know more about [fund transfer failure](/payroll/payroll-payouts#funds-not-updated). 
...
### 4. Can we process salary on non-working days or banking holidays?
         ...
         Know more about [payroll payout modes](/payroll/payroll-payouts#modify-default-payout-mode).
...
You can transfer funds to Payroll only via Netbanking.
            ...
            1. Enter the account number and IFSC available on the **Money Transfer** page to add funds. You can transfer the funds to your Axis account between 1:30 am-9:30 pm. Know more about [fund transfer](/payroll/payroll-payouts#transfer-funds).
...
### 2. Where can I modify the compliance payments settings for my organisation?
         ...
         To modify compliance payments settings:
            ...
            Ensure you make the compliance payments externally with the respective departments [on time](/payroll/statutory-compliance#payment-due-dates) to avoid government notices and penalties.
...
### 4. Why do compliance payments deductions appear in my employees' payslips even after I have disabled them on the Dashboard?
         ...
         The compliances continue to appear on your employees' payslips as the payments are mandatory for employees. After disabling compliance settings, it is your responsibility to make the compliance payments [on time](/payroll/statutory-compliance#payment-due-dates).
...
### 3. Will Payroll continue to make TDS and ESIC payments?
         ...
         Yes, TDS and ESIC payments are unaffected. Know more about the [compliance payments due dates](/payroll/statutory-compliance#payment-due-dates). 
...
### 7. By when must I make the Professional Tax payments?
         ...
         Ensure you make the pending PT payments to the Karnataka government by 20th of the month. Know more about the [compliance payments due dates](/payroll/statutory-compliance#payment-due-dates).
        

    
### 8. How can I make the PT payments for my employees based in Karnataka?

         You must [manually make PT payments for Karnataka-based employees](/payroll/professional-tax#pt-payment-for-karnataka-employees).
...
### 2. How is the payroll amount calculated for PF since the 2FA rule change is in effect?
         ...
         - You must remit the ₹100 to the EPFO (due to Payroll temporarily pausing automated PF payments). Follow the steps to [make PF Payments via EPFO](/payroll/provident-fund#make-pf-payments-on-epfo).
...
### 4. How do I make PF payments for my employees?
         ...
         Know how to [make Provident Fund payments via EPFO](/payroll/provident-fund#register-employees).
...
### 6. Where can I download the PF ECR file?
         ...
         You can download the PF ECR file from the [Payroll Dashboard](https://payroll.razorpay.com/run-payroll). Know more about making [PF payments on the EPFO portal](/payroll/provident-fund#1-download-pf-ecr-txt-file).
...
### 4. I am unable to view my TDS challans on the Dashboard. How do I resolve this?
         ...
         To rectify, [update your Income Tax portal credentials](/payroll/quickstart#enable-compliances) on the Payroll Dashboard. 
...
### 1. What is the TDS impact on the Razorpay charges we paid?
         ...
         Know more about [TDS Charges](/payroll/tds#tds-for-razorpay-charges ).
        

    
### 2. Will my TDS deduction increase if I pay bonus to my employees?

         Yes, your TDS increases as providing a bonus is an addition to the employee's salary. Know how bonus on top of salary affects TDS and how [treats such additions](/payroll/tds#tds-on-bonus).
...
### 1. When will my employees get the Form 16?
         ...
         Employees receive their Form 16 after the end of the financial year, around June. Know more about [Form 16](/payroll/tds#form-16-16a). 
...
### 3. Do we get the Contractors Form 16A through Payroll?
         ...
         However, you can request Form 16A only if you have used Payroll to pay your contractors and file 26Q returns. Know more about [Form 16A](/payroll/tds#tds-for-contractors).
...
### 1. How can I pay bonuses to my employees?
         ...
         - Use the [Bonus module](/payroll/bonus). 
         - Make [One-time payments](/payroll/one-time-payments#make-one-time-payments) for bonus payouts.
         - Add bonus as an [addition](/payroll/run-payroll#additions) to the monthly salary.
        

    
### 2. How can I pay an instant bonus to employees?

         You can [make one-time payments](/payroll/one-time-payments#make-one-time-payments) to pay an instant bonus to your employees. 
...
### 3. The Bonus Type drop-down menu is empty. How to resolve this?
         ...
         Ensure you [set up the bonus types](/payroll/bonus#setup-bonus-types) on the Payroll Dashboard before you create a bonus for an employee.
...
### 4. Can I make bonus payments in bulk?
         ...
         - If the bonus does not have a [clawback rule](/payroll/bonus#2-add-clawback-rule), you can use the [bulk additions template](/payroll/run-payroll#bulk-upload).
...
### 5. If I pay a bonus to my employees, will it affect PF, ESI, PT or TDS calculations?
         ...
         Yes, paying a bonus can impact ESI, PT and TDS calculations, depending on how it is processed. However, PF deductions remain unaffected.
            ...
            **TDS**
            ...
            - TDS is [deducted on bonuses](/payroll/faqs#2-will-my-tds-deduction-increase-if-i) as per tax slabs, and it can increase the employee’s overall tax liability. 
...
### 1. Our leaves are carried forward to the next financial year even if we did not configure that. Why?
         ...
         To modify or remove carrying unused leaves forward to the next year, refer to the [Leave Setup Steps](/payroll/leaves#configure-leave-setup) and configure it to 0/none. 
...
### 6. What about TCS (Tax Collected at Source) - does it affect payroll?
         ...
         TCS under Section 394 primarily applies to sellers collecting tax on sale of goods such as alcohol, minerals, scrap, luxury items, and overseas remittances. While TCS does not directly impact salary payroll processing, it may affect businesses making such transactions. Refer to the [complete TCS section codes](/payroll/tax-verifications/tax-codes) for details.
        

    
### 7. Where can I find the complete list of new section codes?

         You can find the complete searchable list of all 64 new TDS/TCS section codes on the [New TDS/TCS Section Codes](/payroll/tax-verifications/tax-codes) page. The table includes the serial number, nature of payment, new section reference, and the section code.
...
### 1. Payroll's Loss of Pay calculation is not matching with our calculation. Why?
         ...
         If LOP days do not match your calculations, it may be because LOP is calculated using total working days in the month instead of the total number of days in the month. Know more about [LOP Calculations](/payroll/run-payroll#calculations). 
...
### 3. What are the supported payment modes to process an employee's FNF?
            ...
            We support NEFT and IMPS to process the employee's full and final settlement. However, we recommend using NEFT as the default payment mode. Know more about [payroll payouts](/payroll/payroll-payouts#make-payroll-payouts).
        

    
### 4. Is it possible to revise salary in bulk?

         Yes, you can revise salary in bulk. Know more about [bulk salary revision](/payroll/run-payroll#bulk-revision).
