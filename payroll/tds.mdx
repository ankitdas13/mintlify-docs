---
title: "About Tax Deducted at Source (TDS)"
description: "Tax Deducted at Source (TDS) is an indirect tax that salaried employees and other eligible entities pay to the Income Tax department of India, as per the Section 192 of the Income Tax Act, 1961."
---
...
### 1. TRACES Registration
       ...
       [TRACES](https://www.tdscpc.gov.in/app/login.xhtml) registration is required by Payroll to download your employees' and contractors' Form 16/16A data.
         ...
         If your organisation is currently not registered on TRACES, [contact support](/x/support#razorpayx-payroll) after Payroll has completed filing TDS returns for any quarter.
...
### Change Employee's Regime
       ...
       In some cases, you can allow employees to change their tax regime after the initial selection. 
         ...
         This successfully reverses the tax regime for the employee. You can select the regime or allow the employee select the regime from [Tax Deductions](/payroll/employees/declarations) on their dashboard.
...
### Employee's Form 16
       ...
       Once the Form 16s are available to us, we upload all employees' **unsigned Form 16s** on the Payroll Dashboard in **My Pay Slips**. Know more about [Payslips and Form 16](/payroll/employees/payslips-form16).
       ...
       - [Contact support](/payroll/plans#contact-support) to upload the signed Form 16s on the Payroll Dashboard for your employees to access them.
...
### TDS on Razorpay Charges
       ...
       To check this:
         ...
         View your current settings. 
               ...
               You must pay the TDS separately and share the TDS certificate (Form 16A) with the [support team](/payroll/plans#contact-support). Payroll verifies this TDS amount and credits it to your Payroll account.
...
### TDS on One-time Payments
       ...
       Know more about [TDS on One-time payments](/payroll/one-time-payments#tds-on-one-time-payments). 
...
### TDS on Custom Salary Structure Components
       ...
       Know more about [Custom Salary Structure](/payroll/run-payroll#setup-salary-structures). 
      

   
### TDS on Bonus

       When you pay a bonus (as a one-time payment or as a Payroll cycle [addition](/payroll/run-payroll#additions-and-deductions)), specifically in the middle of the financial year, the employee's TDS liability increases. 
...
<Info>
New TDS/TCS section codes are now in effect. Refer to the [new TDS/TCS section codes](/payroll/tax-verifications/tax-codes) for the complete reference.
</Info>
...
- [Salary Exceptional Cases](/payroll/exceptional-cases)
