---
title: "Bulk Dismiss Employees"
description: "On the Payroll Dashboard, you can dismiss multiple employees at once using the bulk dismissal and settlement feature. With this feature, you can also:"
---

- Process [full and final settlements (FnF)](https://razorpay.com/payroll/learn/full-and-final-settlement-fnf/). 
- [Hold Salary and Pay Compliance](/payroll/run-payroll/fnf). 
Know more about [employee dismissal](/payroll/run-payroll#terminate-and-run-last-payroll).
...
### How to fill the template correctly?
                 ...
                 - Ensure the employees for whom you are initiating FnF in bulk are not the orgnaisation's [administrators](/payroll/user-roles-workflows#view-collaborators).
                 - You can start [holding salary](/payroll/run-payroll/fnf) from a month where the payroll is not yet finalised. 
...
### 1. I want to hold the salary of a single employee. Is it possible?
            ...
            Yes, you can withhold the salary of an individual employee. Refer to [Hold Salary, Pay Compliance](/payroll/run-payroll/fnf).
...
- [About Employee Dismissal](/payroll/run-payroll#terminate-and-run-last-payroll)
- [About Salary Additions/Deductions](/payroll/run-payroll#attendance-based-salary-calcuation)
