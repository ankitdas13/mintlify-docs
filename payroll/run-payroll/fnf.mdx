---
title: "FnF Hold Salary Pay Compliance"
description: "You can terminate employees on the Dashboard and process their [full and final settlement (FnF)](https://razorpay.com/payroll/learn/full-and-final-settlement-fnf/). This enables you to offboard employees from your organisation and Payroll. Know more about [employee dismissal](/payroll/resignation#process-full-final-settlement)."
---
...
In some cases, you may need to withhold the employee's salary for the duration of their notice period to recover any losses incurred by the employee during their tenure of employment. However, you must continue to make the [compliance payments](/payroll/statutory-compliance).
...
1. Select the **Last working date** (LWD) from the calendar and provide a reason for dismissal. If you have enabled the [resignation module](/payroll/employees/resignation), we automatically add the LWD.
...
1. In the **Salary during resignation months** section, select **Hold net pay till the last working month**. You can then select the start month for withholding salary from the **Hold net pay starting from** drop-down menu. 
    ...
    You can select **Release Salary** to process the final settlement as per the regular [employee dismissal](/payroll/resignation#process-full-final-settlement) process. 
...
1. This opens the **Full and final settlement** page for the employee. Enter the adjustments as per the usual [employee dismissal](/payroll/resignation#process-full-final-settlement) process. 
...
### 1. I am unable to view the dismissal or net pay information of some of my dismissed employees. Why?
            ...
            [Finalise Payroll](/payroll/run-payroll#execute-payroll) in **Run Payroll** for the dismissed employee's net pay information to reflect on the RazorpayX Dashboard. 
...
### 2. Does Payroll immediately transfer the net pay after I choose 'Release Salary' when initiating FNF?
         ...
         No, choosing **Release Salary** does not immediately release the employee's net pay. Instead, Payroll processes the employee's [Full and final settlement](/payroll/resignation#process-full-final-settlement) as part of the monthly payroll activity. 
...
### 4. What are the supported payment modes to process employee's FNF?
            ...
            We support both NEFT and IMPS payment modes to process employee's full and final settlement. However, we recommend you choose NEFT as your default payment mode. Know more about [payroll payouts](/payroll/payroll-payouts#make-payroll-payouts).
...
- [Terminate Employee and Run Last Payroll](/payroll/resignation#process-full-final-settlement)
