...
description: "Employee loans are beneficial for both the employer and the employee."
---
...
### What is the difference between Advance Salary and Employee Loans?
         ...
         In an [Advance Salary](/payroll/advance-salary), the organisation pays a portion of the employee's salary as an advance. The advance paid is recovered in installments from the employee and is usually interest-free.
...
1. Click **DISBURSE LOAN ()**. This creates the loan payout to your employees. 
    ...
    [Add funds to your Payroll account](/payroll/payroll-payouts#transfer-funds) in case the **DISBURSE LOAN ()** option is not available.
...
In the [employees' profile](/payroll/employees#set-up-profile) view, you can either set a limit on the total perquisite amount allowed (only in [custom salary structure](/payroll/salary#setup-salary-structure)) or let Payroll calculate the amount allowed automatically. This is beneficial in cases of employee's [salary revision](/payroll/run-payroll#revise-salary).
...
- Employees can view their loan infomation from their [profile](/payroll/employees#set-up-profile). 

### Related Information

- [About Salary](/payroll/salary)
