---
title: "Automate Karnataka Professional Tax Payments"
description: "Due to the introduction of [2FA on the PT portal](/payroll/faqs#professional-tax) by Karnataka government, Payroll enables you to automate PT payments (for Karnataka employees) via the Dashboard. Previously, we had paused PT payments via the Dashboard."
---
...
### Initiate PT Payments
        ...
        1. [Finalise Payroll](/payroll/run-payroll#execute-payroll) for the month and execute it.
