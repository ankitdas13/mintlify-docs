...
description: "You can provide salary advances to your employees on the Payroll Dashboard."
---
...
### How is Advance Salary different from Employee Loans?
         ...
         [Employee loans](/payroll/loans) are a loan facility employers provide to their employees at a lower interest rate than the market rate. The EMIs are deducted from the employee's salary and on Payroll, you can modify the employee's EMI or skip the EMI when necessary.
