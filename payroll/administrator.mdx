...
description: "People in an organization, primarily the employees and the contractors, are the company's most valuable asset. It is important to honour their needs and requirements."
---
...
When you someone to your organisation's payroll as an employee or a contractor, Payroll sends them a [welcome email](/payroll/employees#employee-onboarding). This allows the employees to access the Employee Dashboard on Payroll. 

### Two-Factor Authentication

On the Payroll Dashboard, 2FA is enabled by default for all [user roles](/payroll/user-roles-workflows) except employees. You can enable two-factor authentication (2FA) for your employees and enhance access security. 
...
### Mail not Received
         ...
         If your employees report [not receiving any email](/payroll/employees#unable-to-find-email) from Payroll, the following could be the reasons: 
...
### OTP Not Received
         ...
         This resends the onboarding email to the employee post which they can log in to the Payroll Dashboard. [Contact Support](/x/support#razorpayx-payroll) if you face further issues. 
...
- [Payroll Payouts](/payroll/payroll-payouts)
