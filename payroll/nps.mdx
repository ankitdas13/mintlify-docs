---
title: "Enable NPS Declarations"
description: "Organisations contribute up to 10% of employees' Basic Pay + Dearness Allowance as employer's contribution to the National Pension Scheme (NPS). This contribution is tax exempt upto ₹7.5 lakhs for organisations and is offered as an added benefit for employees."
---
...
1. Enter the employee's 12-digit PRAN in the text box. We pre-fill employee's PRAN if the employee provided their PRAN during [onboarding](/payroll/employees#set-up-profile).
1. Click **CONTINUE**. 
...
On Payroll, your eligible employees can choose their NPS contribution percentage. However, you must enable this setting separately. When disabled, we contribute the percentage reserved for NPS as specified in the [salary structure](/payroll/salary#setup-salary-structure). 
...
- Ensure the declaration window is open during [onboarding](/payroll/employees#employee-onboarding) and [salary revision](/payroll/run-payroll#revise-salary) process.
...
- [Employee NPS Declaration](/payroll/employees/declarations/nps)
