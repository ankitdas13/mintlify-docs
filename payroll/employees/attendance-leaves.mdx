...
description: "Leaves and attendance form a critical part of every employee's payslip and personal management. On the Payroll Dashboard, you can:"
---
...
Watch the video on to how to [mark attendance](/payroll/video-tutorials#mark-and-modify-attendance) and [apply for leaves](/payroll/video-tutorials#apply-for-leaves).

<Info>
**Handy Tips**
</Info>

- If your organisation has integrated [Payroll with Slack](/payroll/integrations/slack), you can update your leaves and attendance from within the Slack App. Refer to the [leave commands](/payroll/integrations/slack#how-it-works).
...
- [Slack Integration](/payroll/integrations/slack)
