...
### Opt for Verification
         ...
         - **Let Organisation Verify** to carry out the [verification by yourself](/payroll/tax-verifications).
...
Employees can declare their provisional investments and upload investment proofs via the [IT Declarations](/payroll/employees/declarations) page. We communicate the window availability to your employees via email. 

### Related Information

- [About Statutory Compliance](/payroll/statutory-compliance)
