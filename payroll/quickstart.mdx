...
description: "After you sign up with [Payroll](https://payroll.razorpay.com/login), you can begin to set up your account and Dashboard."
---
...
### Add All Employees
           ...
           To add employees:
            ...
            You have successfully added employees/contractors to the Dashboard. Your employees can complete their [onboarding and profile set up](/payroll/employees#employee-onboarding) using the welcome mail they receive at their registered email id. 
...
Sometimes your employees may not be added to your system due to operational discrepancies like [not receiving the welcome mail](/payroll/administrator#welcome-mail). Re-trigger a welcome mail or invite them to your company and payroll system.
...
### Enable Compliances
         ...
         Update your organisation's compliance details as applicable. We support and automate many monthly [statutory compliance](/payroll/statutory-compliance) payments. 
        ...
        You have successfully enabled the applicable compliances. Know more about [compliance payments and automation](/payroll/statutory-compliance). 
...
### Setup Default Salary Structure
         ...
         See [default salary structure](/payroll/salary#setup-salary-structure) set up.
        

    
### Check for Missing Information

         Before you [execute payroll](/payroll/execute-payroll), ensure you your employees' data is available and up-to-date.
...
### Employee Tax Declarations
         ...
         You must ask your employees to update their tax deductions and declarations on the [Employee Dashboard](/payroll/employees/declarations). 
...
- [Execute Payroll](/payroll/execute-payroll)
- [Statutory Compliance](/payroll/statutory-compliance)
- [Administrative Role](/payroll/administrator)
