---
title: "Multi Location Esi"
description: "Employees State Insurance (ESI) is a government mandated health insurance for employees. It is mandatory for organisations with more than 20 employees, whose monthly salary is l..."
---
---
---
...
<Steps>
<Step title="The system calculates ESIC contributions as usual.">
The system calculates ESIC contributions as usual.
</Step>
<Step title="Employees are segregated based on their office location.">
Employees are segregated based on their office location.
</Step>
<Step title="Separate contribution files with their contribution details are gen...">
Separate contribution files with their contribution details are generated for each sub-code/office location.
</Step>
<Step title="Files are formatted according to government specifications for dire...">
...
<Steps>
<Step title="System identifies that multi-location is enabled.">
System identifies that multi-location is enabled.
</Step>
<Step title="Processes payments one sub-code/office location at a time:">
...
<Step title="Repeats the process for all configured sub-codes/office locations.">
Repeats the process for all configured sub-codes/office locations.
</Step>
<Step title="Updates the dashboard with payment status for each location.">
