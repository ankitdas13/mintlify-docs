...
<Step title="Go to **Settings** → **Payments & Compliance Setup**. Click **EDIT**.">
Go to **Settings** → **Payments & Compliance Setup**. Click **EDIT**.
</Step>
<Step title="In the **Compliance Payments Settings** section, select the applica...">
In the **Compliance Payments Settings** section, select the applicable option under **PF Settings.**
...
<Step title="Click the **Save** button at the bottom of the section to apply you...">
Click the **Save** button at the bottom of the section to apply your changes.
</Step>
</Steps>
