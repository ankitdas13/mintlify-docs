---
title: "Integrate with Jibble"
description: "Integrate your RazorpayX Payroll account with Jibble and enhance time and attendance management for your employees. Jibble syncs your employees' leaves and shifts data with Payroll and automatically calculates [Loss of Pay](/payroll/leaves#loss-of-pay-for-unpaid-excessive-leave-work) when executing payroll."
---
...
You have successfully integrated Payroll with Jibble. Set up your organisation's [leave and attendance](/payroll/leaves) policy on Jibble. Know how Payroll [retrieves the Loss of Pay data](#verify-lop-in-payroll) to calculate the monthly payroll.
...
Once your employees mark their attendance on Jibble, you can sync the loss of pay details from Jibble before you [execute payroll](/payroll/run-payroll). To verify the loss of pay data:
...
You can edit the loss of pay days and deductions until you execute payroll. Know more about the [execute payroll checklist](/payroll/execute-payroll).

### Related Information 

- [About Integrations](/payroll/integrations) 
- [Leaves and Attendance](/payroll/leaves)
- [Whatsapp Integration](/payroll/integrations/whatsapp)
