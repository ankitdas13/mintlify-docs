---
title: "Integrate with HRMS Software"
description: "On the [Payroll Dashboard](https://payroll.razorpay.com/dashboard), you can integrate your Human Resource Management Systems (HRMS) tool with Payroll. You need not manually import data or switch from your current HRMS."
---
...
- Map your employee types as `employees` or `contractors`. Know more about [employee types](/payroll/administrator#employee-and-contractor) in Payroll.
...
- Sync dismissal dates from HRMS to calculate [Full and Final Settlement](/payroll/run-payroll#full-and-final-settlement/) in Payroll.
...
1. Follow the on-screen instructions to authenticate the tool and map your employees on Payroll. 
    ...
    1. Map your employees as employee or contractor [employee types](/payroll/administrator#employee-and-contractor) on Payroll. 
...
- Change employee information such as bank account data, contractor to full-time employee or vice-versa, personal details of the employee, and so on using the **Modify Configuration** option.
    ...
    Suppose you must sync the bank account data from the HRMS after the integration, or a full-time employee is now a [contractor](/payroll/administrator#differences-between-employee-and-contractor). You can change that information here. 
...
- [About Integrations](/payroll/integrations) 
- [Contact Support](/payroll/plans#contact-support)
