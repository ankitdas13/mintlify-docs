---
title: "Integrate with Plum"
description: "Payroll covers insurance for all your employees."
---
...
- [Contractors](/payroll/administrator#differences-between-employee-and-contractor) are not covered in the insurance plans.

</Warning>
## Prerequisites

1. Your organisation must be using RazorpayX Payroll for all the salary transfers and applicable [compliances](/payroll/statutory-compliance).
...
- [Income Tax Declaration](/payroll/employees#income-tax-declaration) 
