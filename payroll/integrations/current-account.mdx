---
title: "Integrate with Current Account"
description: "You can integrate your RazorpayX powered Current Account with Payroll integration to make transactions and reconciliation easier."
---
...
- You must have a [RazorpayX - Current Account](/x/account-types/current-account).
...
- There should be no balance in your Payroll account before integration. 
    - If there is any balance, add the Current Account as a [Contractor](/payroll/administrator#differences-between-employee-and-contractor) and [transfer funds](/payroll/payroll-payouts#transfer-funds) to this account. 
...
- If you have [approval workflows (maker-checker)](/x/manage-teams/approval-workflow) enabled on your RazorpayX account, the same is applicable to all transactions originating from Payroll by default.
...
- [RazorpayX - Current Account](/x/account-types/current-account)
