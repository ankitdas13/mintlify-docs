...
description: "Professional Tax (PT) is a state-level, mandatory tax levied u/s 16 of the Income Tax Act, 1961. It varies between states and applies to all earning individuals regardless of their profession, trade or employment in India."
---
...
Payroll only handles Professional Tax (PT) payments and filings, not the initial registration. Know more about the people and resources available for [initial registration](/payroll/statutory-compliance#initial-registration).
...
- Know more about [enabling compliances](/payroll/quickstart#enable-compliances).
