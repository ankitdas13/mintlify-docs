---
title: "Fund Transfer & Payroll Payouts"
description: "After you log in to your [Payroll Dashboard](https://payroll.razorpay.com/dashboard) as an admin, add balance to your account to start making payroll payouts. You can also create and assign [user roles](/payroll/user-roles-workflows) and [create Approval Workflows](/payroll/approval-workflow) to permit or restrict access."
---
...
<Steps>
<Step title="Click **UPDATE BALANCE** in the right pane.">
Click **UPDATE BALANCE** in the right pane.
</Step>
<Step title="On the **Money Transfer** page, follow the instructions to wire mon...">
On the **Money Transfer** page, follow the instructions to wire money to the details listed on-screen.
...
<Step title="Once you initiate the transfer, your Payroll balance gets updated w...">
Once you initiate the transfer, your Payroll balance gets updated within 24 hours. You also receive an email confirmation once we receive the funds.
</Step>
</Steps>
...
Explore the RazorpayX - Current Account [integration with Payroll](/payroll/integrations/current-account) to simplify money transfer and fund management.
...
### Fund Transfer Best Practices
         ...
         - You are transferring funds from a **whitelisted account**. 
            ...
            [Contact support](/payroll/plans#contact-support) to initiate SAV for your organisation.
         - You transfer funds via IMPS. 

            IMPS is a reliable payment mode that is available 24/7 on all non-working days and bank holidays. Know more about the [default payment mode](/payroll/payroll-payouts#modify-default-payout-mode).
...
### Fund Credit Not Updated
         ...
         Balance updates can be delayed if: 
            ...
            If you have transferred funds to Payroll and your balance does not reflect the amount, raise a [support ticket](/payroll/plans). Include the funds transfer's receipt that shows the following details:
...
If you have any queries, raise a [support request](/x/support#razorpayx-payroll).

## Make Payroll Payouts 

Payroll payouts happen after you [execute payroll](/payroll/run-payroll#execute-payroll). Following are some options and best practices available to you when making payroll payouts. 
...
### Modify Default Payout Mode
         ...
         Payroll by default uses IMPS for any payout. IMPS is available 24/7 and works on all days, irrespective of whether it is a bank holiday or a weekend. 
            ...
            - If your employee has chosen NEFT transfers under their [Payments Information](/payroll/employees) setup.
...
### Modify Payment Narration
         ...
         When initiating the payout, we pass your company's name in the narration and cannot control what is else displayed on the beneficiary's account statement.
            ...
            You can also sign up for a [Current Account](/x/account-types/current-account) powered by RazorpayX and [integrate it with Payroll](/payroll/integrations/current-account). When you transfer money using your Current Account, the salary and contractor payments are routed through an existing account under your company's name.
...
- There are bank server issues.
            ...
            Whenever a [payment fails](#payment-failure-reasons), Payroll automatically sends an email to all the administrators of that organisation and the affected [employee/contractor](/payroll/administrator#differences-between-employee-and-contractor) with the required information. 
...
When you pay [contractors](/payroll/administrator#differences-between-employee-and-contractor/) on the Payroll Dashboard, charges for the payments are not immediately deducted. You instead receive a consolidated monthly invoice for all the payments. 
...
- [Account Setup Guide](/payroll/quickstart)
